...
class PasswordUpdateRequestBody(BaseModel):
    """
    The request body for updating user
    """ # noqa: E501
    old_password: Optional[StrictStr] = Field(default=None, description="The old password", alias="oldPassword")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasswordUpdateRequestBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasswordUpdateRequestBody from a dict"""
        if obj is None:
            return None
