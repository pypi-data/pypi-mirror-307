...
class PostProcessingApi:
    ...
    def result_table(
        ...
        last_target_timestamp = max([m.last_target_timestamp for m in forecasting.model.model_zoo.models])
        production_ts = list(result_table[result_table['timestamp'] > str(last_target_timestamp)]['timestamp'])
