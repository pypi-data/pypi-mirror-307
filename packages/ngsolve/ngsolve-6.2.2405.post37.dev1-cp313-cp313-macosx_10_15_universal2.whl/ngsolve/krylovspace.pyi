...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('residuals', 'sol', 'iterations', 'fig', 'ress', 'display', 'mat', 'ax', 'clear_output', 'printrates', '_final_residual', 'callback', 'plotrates', 'pre', 'callback_sol', 'maxiter', 'its', 'atol', 'plt', 'tol')
