...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_cls', 'time', '_lin_solver_args', 'c', 'gfu_old', 'bfmstar')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', 'gfa_old', '_lin_solver_cls', 'time', '_lin_solver_args', 'c', 'gfv_old', 'gfu_old', 'bfmstar')
