...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('iterations', 'callback', 'plt', 'residuals', 'pre', 'its', 'sol', 'display', 'fig', 'mat', 'printrates', '_final_residual', 'ress', 'ax', 'plotrates', 'maxiter', 'tol', 'atol', 'clear_output', 'callback_sol')
