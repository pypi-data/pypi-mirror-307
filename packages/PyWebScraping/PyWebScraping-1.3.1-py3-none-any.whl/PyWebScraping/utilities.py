...
class WindowRect:
	...
	def __init__(
		...
		Args:
			x (int): The x-coordinate. Defaults to None.
			y (int): The y-coordinate. Defaults to None.
			width (int): The width. Defaults to None.
			height (int): The height. Defaults to None.
