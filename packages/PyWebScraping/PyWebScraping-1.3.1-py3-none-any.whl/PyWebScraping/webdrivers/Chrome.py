...
class ChromeStartArgs(BrowserStartArgs):
	...
	def __init__(
		...
		Args:
			...
			debugging_port (int): Port for remote debugging.
			headless_mode (bool): Run Chrome in headless mode.
			mute_audio (bool): Mute audio in Chrome.
...
class ChromeWebDriver(BrowserWebDriver):
	...
	def __init__(
		...
		Args:
			...
			webdriver_start_args (ChromeStartArgs): Startup arguments for Chrome.
			...
			window_rect (WindowRect): Window rectangle object for setting window position and size.
