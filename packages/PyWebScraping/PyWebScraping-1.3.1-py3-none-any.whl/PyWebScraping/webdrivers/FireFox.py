...
class FirefoxStartArgs(BrowserStartArgs):
	...
	def __init__(
        ...
        Args:
            webdriver_dir (str): Directory of the webdriver executable (profile directory).
            debugging_port (int): Port for remote debugging.
            headless_mode (bool): Run Firefox in headless mode.
            mute_audio (bool): Intended to mute audio, but likely has no effect in Firefox.
