...
from PyWindowsCMD.netstat import get_localhost_beasy_ports, get_localhost_minimum_free_port, get_localhost_processes_with_pids
#
#
#
#
class EmptyWebDriver:
	...
	def switch_to_window(self, window: str | int = None):
		...
		Args:
			window (str | int): The name, index, or handle of the window to switch to.
	...
	def close_window(self, window: str | int = None):
		...
		Args:
			window (str | int): The name, index, or handle of the window to close.
	...
	def update_times(
		...
		Args:
			temp_implicitly_wait (int): Temporary implicit wait time. Defaults to None.
			temp_page_load_timeout (int): Temporary page load timeout. Defaults to None.
		"""
...
class BrowserOptionsManager:
	...
	Attributes:
		...
		user_agent (list[str]): The user agent string as a list of parts. Defaults to None.
		proxy (str | list[str]): The proxy server address or a list of addresses. Defaults to None.
	...
	def __init__(
		...
		Args:
			...
			proxy_command (str): Command-line argument for setting the proxy.
			debugging_port (int): The debugging port number. Defaults to None.
			user_agent (list[str]): The user agent string as a list. Defaults to None.
			proxy (str | list[str]): The proxy server address or a list of addresses. Defaults to None.
		"""
	...
	def set_user_agent(self, user_agent: list[str] = None):
		...
		Args:
			user_agent (list[str]): The user agent string as a list.
				If None, a default user agent is used. Defaults to None.
		"""
	...
	def set_proxy(self, proxy: str | list[str] = None):
		...
		Args:
			proxy (str | list[str]): The proxy server address, or a list of addresses.
				If a list is provided, a random proxy is chosen. Defaults to None.
		"""
		self.proxy = proxy
	...
	def set_debugger_address(self, debugging_port: int):
		...
		Args:
			debugging_port (int): The debugging port number.
		"""
...
class BrowserWebDriver(EmptyWebDriver):
	...
	Attributes:
		...
		headless_mode (bool): Whether to run in headless mode. Defaults to False.
		mute_audio (bool): Whether to mute audio. Defaults to False.
		user_agent (list[str]): The user agent. Defaults to None.
		proxy (str | list[str]) : The proxy server(s). Defaults to None.
		...
		webdriver_service (Service): The webdriver service. Defaults to None.
		webdriver_options (Options): The webdriver options. Defaults to None.
	...
	def __init__(
		...
		Args:
			...
			bom_proxy_command (str): BrowserOptionsManager command for proxy.
			webdriver_path (str): Path to the webdriver executable.
			webdriver_start_args (BrowserStartArgs): Manages browser start-up arguments. Defaults to None.
			webdriver_options_manager (BrowserOptionsManager): Manages browser options. Defaults to None.
	...
	def start_webdriver(
		...
		Args:
			debugging_port (int):  The debugging port. Defaults to None.
			webdriver_dir (str): The webdriver directory. Defaults to None.
			headless_mode (bool):  Whether to run in headless mode. Defaults to None.
			mute_audio (bool): Whether to mute audio. Defaults to None.
			proxy (str | list[str]): The proxy server(s). Defaults to None.
			user_agent (list[str]):  The user agent. Defaults to None.
			window_rect (WindowRect):  The browser window size and position. Defaults to None.
		"""
	...
	def restart_webdriver(
		...
		Args:
			debugging_port (int): The debugging port. Defaults to None.
			webdriver_dir (str): The webdriver directory. Defaults to None.
			headless_mode (bool): Run in headless mode. Defaults to None.
			mute_audio (bool):  Whether to mute audio. Defaults to None.
			proxy (str | list[str]):  The proxy server. Defaults to None.
			user_agent (list[str]): The user agent. Defaults to None.
			window_rect (WindowRect):: The desired window size and position. Defaults to None.
		"""
