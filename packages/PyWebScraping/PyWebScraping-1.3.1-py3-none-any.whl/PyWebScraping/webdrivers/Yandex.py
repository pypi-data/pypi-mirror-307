...
class YandexOptionsManager(BrowserOptionsManager):
	...
	def hide_automation(self):
        ...
        These options may not be fully effective in preventing detection.
...
class YandexStartArgs(BrowserStartArgs):
	...
	def __init__(
        ...
        Args:
            ...
            debugging_port (int): Port for remote debugging.
            headless_mode (bool): Run Yandex in headless mode.
            mute_audio (bool): Mute audio in Yandex.
...
class YandexWebDriver(BrowserWebDriver):
	...
	def __init__(
        ...
        Args:
            ...
            webdriver_start_args (YandexStartArgs): Startup arguments for Yandex.
            webdriver_options_manager (YandexOptionsManager): Options manager for Yandex.
...
class YandexRemoteWebDriver(EmptyWebDriver):
    ...
    Attributes:
        ...
        driver (webdriver.Remote): The remote webdriver instance.
	...
	def __init__(
        ...
        Args:
            ...
            webdriver_options_manager (YandexOptionsManager): Options manager for Yandex (using Chrome options).
            implicitly_wait (int): Implicit wait time in seconds.
            page_load_timeout (int): Page load timeout in seconds.
