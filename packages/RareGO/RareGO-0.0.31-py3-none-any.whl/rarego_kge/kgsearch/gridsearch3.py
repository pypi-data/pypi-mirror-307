# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 11:14:43 2024
...
custom_dataset
def grid_search3(n_trials=30,search_space=None, dataset=custom_dataset, model_name='quate'):
...
# Example usage
best_hyperparameters3 = grid_search3()
torch.save(best_hyperparameters3, 'quate_hyperparam')
print(best_hyperparameters3)