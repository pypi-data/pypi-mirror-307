...
def summarize(
    ...
    chain = model.create_chain(prompt=summarize_prompt)
...
def summarize_with_sources(
    ...
    chain = model.create_chain(prompt=summarize_with_sources_prompt)
...
def summarize_sid(
    ...
    chain = model.create_chain(prompt=summarize_sid_prompt)
