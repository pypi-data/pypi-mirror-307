...
class NetworkResult(_message.Message):
    __slots__ = ("timestamp", "id_sender", "id_target", "payload_description", "latency_ms", "payload_size_mb", "timestamp_sender_init", "timestamp_sender_response", "timestamp_trget", "clock_offset", "clock_offset_ping_adjusted", "json_string")
    ...
    TIMESTAMP_TRGET_FIELD_NUMBER: _ClassVar[int]
