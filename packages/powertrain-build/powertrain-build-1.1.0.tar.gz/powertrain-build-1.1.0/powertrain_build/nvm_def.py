...
class ZCNVMDef(NVMDef):
    ...
    def generate_nvm_rte_files(self):
        ...
        old_nvm_memory_areas = self._nvm_memory_areas
        prefix = self._project_config.get_scheduler_prefix()
        self._nvm_memory_areas = tuple(area.replace(f"{prefix}", "") for area in self.valid_nvm_definitions.keys())
        ...
        self._nvm_memory_areas = old_nvm_memory_areas
