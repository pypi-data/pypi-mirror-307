...
class Url:
    ...
    def __init__(self, **kwargs):
        ...
        self._kwargs = self.get_url_default_kwargs() | kwargs
    ...
    def replace(self, **kwargs):
        return self.__class__(**{**self._kwargs, **kwargs})
    ...
    def sort_query(self):
        ...
        self._kwargs['query'] = OrderedDict((k, query[k]) for k in sorted(query))
        return self

    def sort_params(self):
        params = self._kwargs['params']
        self._kwargs['params'] = OrderedDict((k, params[k]) for k in sorted(params))
        return self
