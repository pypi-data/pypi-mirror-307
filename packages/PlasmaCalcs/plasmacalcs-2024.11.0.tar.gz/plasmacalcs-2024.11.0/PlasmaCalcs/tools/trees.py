...
class Tree():
    ...
    def html(self, show_depth=None, max_depth=None, *, shorthand=None):
        ...
        show_depth: None or int
            ...
            None --> use DEFAULTS.TREE_SHOW_DEPTH
        max_depth: None or int
            ...
            None --> use DEFAULTS.TREE_MAX_DEPTH
        shorthand: None or bool
            ...
            None --> use DEFAULTS.TREE_SHORTHAND
        '''
        if show_depth is None:
            show_depth = DEFAULTS.TREE_SHOW_DEPTH
        if max_depth is None:
            max_depth = DEFAULTS.TREE_MAX_DEPTH
        if shorthand is None:
            shorthand = DEFAULTS.TREE_SHORTHAND
