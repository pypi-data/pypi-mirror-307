...
class MoviepyVideoEffect(VideoEffect):
    ...
    """
    @classmethod
    def apply(cls, video: Union[str, VideoFileClip, VideoClip, CompositeVideoClip, ImageClip, ColorClip], resize: MoviepyResize, set_position: MoviepySetPosition, rotate: MoviepyRotate, *args, **kwargs):
        """
        ...
        """
        return cls.apply_over_video(video, BasePositionMoviepyEffect.get_black_background_clip(video.duration), resize, set_position, rotate, *args, **kwargs)
    ...
    @classmethod
    def apply_over_video(cls, video: Union[str, VideoFileClip, VideoClip, CompositeVideoClip, ImageClip, ColorClip], background_video: Union[str, VideoClip, VideoFileClip, CompositeVideoClip, ImageClip, ColorClip], resize: MoviepyResize, set_position: MoviepySetPosition, rotate: MoviepyRotate):
        ...
        if set_position:
            ...
            effected_video = effected_video.set_position(lambda t: MoviepySetPosition.t_function(t, duration, get_moviepy_position(video, background_video, set_position.initial_position), get_moviepy_position(video, background_video, set_position.final_position), set_position.rate_func))
