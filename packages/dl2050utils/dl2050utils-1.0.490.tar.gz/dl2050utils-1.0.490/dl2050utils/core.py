...
def base64_decode(encoded_data, return_as_text=False):
    """
    Base64 decode the base64-encoded encoded_data back to its original form.
    If return_as_text is True, decode as a UTF-8 string. Otherwise, return as bytes.
    """
    # Decode the base64 string back to bytes
    decoded_data = base64.b64decode(encoded_data)
    # If return_as_text is True, convert bytes back to string
    if return_as_text: return decoded_data.decode('utf-8')
    # Return nytes
    return decoded_data
