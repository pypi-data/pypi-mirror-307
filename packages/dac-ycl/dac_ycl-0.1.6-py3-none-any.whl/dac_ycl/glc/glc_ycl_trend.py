...
from dac_ycl.glc.utils.ycl_abandon_abnormal import abandon_abnormal_ycl, get_time_str, get_time
...
ALIAS = "YCLJS"  # 界面上以及表格里期望的别名
VALUE_ALIAS = "YCLJS.VALUE"
...
def do_new(data, global_result: dict):
    ...
    global_result[VALUE_ALIAS] = round(np.mean(value_series[-5:]), 3)
