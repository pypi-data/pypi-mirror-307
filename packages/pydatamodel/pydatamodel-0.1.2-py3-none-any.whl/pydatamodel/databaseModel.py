...
def ddl_impala_t(mapping_xlsx='D:/xuguanming/oldFiles/数据库建模/generating_engine/mapping/3.source_mapping_粤财信托全链路.xlsx',
                code_model_path=r'D:/xuguanming/oldFiles/数据库建模/generating_engine/models/hive/itl/ddl',
                target_schema='itl',
                etl_dt='etl_dt',
                etl_timestamp='etl_timestamp',
                start_dt='start_dt',
                ...
                collate='utf8mb4_unicode_ci',
                creater='AutoCreater',
                output_path='D:/xuguanming/oldFiles/数据库建模/generating_engine/code/hive/itl/ddl'):
    #基于Mapping文件，自动生成T层DDL代码
    #layer #t:T层，o：O层
    #许冠明
    #20221113
