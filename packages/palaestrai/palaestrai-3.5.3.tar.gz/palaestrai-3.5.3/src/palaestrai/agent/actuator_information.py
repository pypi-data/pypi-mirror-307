...
class ActuatorInformation:
    ...
    def __init__(
        ...
        ActuatorInformation._assert_value_in_space(self._space, self._value)
    ...
    def value(self, value):
        ActuatorInformation._assert_value_in_space(self._space, value)
        self._value = value
    ...
    def __setstate__(self, state):
        ...
        self._value = (
            ...
            or isinstance(state["value"], float)
            else state["value"]
        )
    ...
    def space(self, space: Space):
        ...
        ActuatorInformation._assert_value_in_space(space, self._value)
        self._space = space
    ...
    @staticmethod
    def _assert_value_in_space(space: Space, value: Any):
        assert_value_in_space(
            space,
            value,
