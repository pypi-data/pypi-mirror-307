...
T = TypeVar("T", bound="PatchedGenresRequest")


@_attrs_define
class PatchedGenresRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_genres_request = cls(
            name=name,
            description=description,
            cover_image=cover_image,
        )

        patched_genres_request.additional_properties = d
        return patched_genres_request
