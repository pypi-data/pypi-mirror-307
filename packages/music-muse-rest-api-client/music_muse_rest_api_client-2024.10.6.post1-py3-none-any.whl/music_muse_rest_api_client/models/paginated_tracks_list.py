...
T = TypeVar("T", bound="PaginatedTracksList")


@_attrs_define
class PaginatedTracksList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Tracks.from_dict(results_item_data)
        ...
        paginated_tracks_list.additional_properties = d
        return paginated_tracks_list
