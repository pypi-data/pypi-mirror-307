...
T = TypeVar("T", bound="PaginatedAlbumsList")


@_attrs_define
class PaginatedAlbumsList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Albums.from_dict(results_item_data)
        ...
        paginated_albums_list.additional_properties = d
        return paginated_albums_list
