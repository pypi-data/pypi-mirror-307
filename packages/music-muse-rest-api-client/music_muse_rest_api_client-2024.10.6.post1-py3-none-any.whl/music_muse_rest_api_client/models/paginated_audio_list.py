...
T = TypeVar("T", bound="PaginatedAudioList")


@_attrs_define
class PaginatedAudioList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Audio.from_dict(results_item_data)
        ...
        paginated_audio_list.additional_properties = d
        return paginated_audio_list
