...
T = TypeVar("T", bound="PaginatedArtistsList")


@_attrs_define
class PaginatedArtistsList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Artists.from_dict(results_item_data)
        ...
        paginated_artists_list.additional_properties = d
        return paginated_artists_list
