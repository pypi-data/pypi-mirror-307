...
T = TypeVar("T", bound="PatchedLabelsRequest")


@_attrs_define
class PatchedLabelsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_labels_request = cls(
            name=name,
            description=description,
            cover_image=cover_image,
        )

        patched_labels_request.additional_properties = d
        return patched_labels_request
