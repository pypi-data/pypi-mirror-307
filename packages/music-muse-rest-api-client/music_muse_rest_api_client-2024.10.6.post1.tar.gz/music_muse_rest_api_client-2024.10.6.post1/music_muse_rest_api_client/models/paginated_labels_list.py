...
T = TypeVar("T", bound="PaginatedLabelsList")


@_attrs_define
class PaginatedLabelsList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Labels.from_dict(results_item_data)
        ...
        paginated_labels_list.additional_properties = d
        return paginated_labels_list
