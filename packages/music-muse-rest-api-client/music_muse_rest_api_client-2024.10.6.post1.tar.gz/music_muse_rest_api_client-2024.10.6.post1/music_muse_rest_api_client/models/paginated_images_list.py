...
T = TypeVar("T", bound="PaginatedImagesList")


@_attrs_define
class PaginatedImagesList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Images.from_dict(results_item_data)
        ...
        paginated_images_list.additional_properties = d
        return paginated_images_list
