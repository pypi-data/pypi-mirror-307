...
T = TypeVar("T", bound="PaginatedGenresList")


@_attrs_define
class PaginatedGenresList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Genres.from_dict(results_item_data)
        ...
        paginated_genres_list.additional_properties = d
        return paginated_genres_list
