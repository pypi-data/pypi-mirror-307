...
class JobTW(Job):
    def __init__(self, length, availST=None, availET=None):
        if (te <= ts):
            raise OutOfRangeError("ERROR: End time should be later than start time.")
        self.length = length
        self.availST = availST
        self.availET = availET
