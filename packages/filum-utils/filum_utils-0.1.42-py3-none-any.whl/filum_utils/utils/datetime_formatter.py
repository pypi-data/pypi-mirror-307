...
class DateTimeFormatter:
    ...
    def str_to_datetime(cls, datetime_str: str) -> Optional[datetime.datetime]:
        ...
        datetime_str_with_timezone = cls._add_vietnam_timezone(normalized_datetime_str)
    ...
    @classmethod
    def _add_vietnam_timezone(cls, datetime_str: str) -> str:
