...
class BrunataOnlineApiClient:
    ...
    def __init__(self, username: str, password: str) -> None:
        self._session = httpx.AsyncClient(timeout=httpx.Timeout(TIMEOUT), headers=HEADERS)
    ...
    async def api_wrapper(self, **args) -> httpx.Response:
