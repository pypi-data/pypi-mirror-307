...
class ManagementRulesTC(WebCWTC):
...
class HelperFunctionsTC(WebCWTC):
...
class FormatSupportedPredicateTC(WebCWTC):
...
class ArchiveTransferDiagnoseTabTC(WebCWTC):
...
class ArchiveTransferExportTC(WebCWTC):
...
class SimplifiedFormsTC(WebCWTC):
...
class ArchiveUnitVocabularyTC(WebCWTC):
...
class SEDANavigationTC(WebCWTC):
    def test_breadcrumbs(self):
        ...
        with self.admin_access.web_request() as req:
            ...
            expected_breadcrumbs = [
                ("https://testing.cubicweb/sedalib", "SEDAArchiveUnit_plural"),
                unit2,
            ]
            self.assertEqual(breadcrumbs, expected_breadcrumbs)
