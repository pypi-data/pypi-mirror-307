...
class PathTargetValuesTC(WebCWTC):
...
class SEDA2RNGExportTC(RelaxNGTestMixin, WebCWTC):
...
class SEDA22RNGExportTC(RelaxNGTestMixin, WebCWTC):
    """Mixin extending XmlTestMixin with implementation of some assert methods for RelaxNG."""
...
class SEDARNGExportFuncTC(SEDAExportFuncTCMixIn, RelaxNGTestMixin, WebCWTC):
...
class OldSEDAXSDExportTC(XMLSchemaTestMixin, OldSEDAExportMixin, WebCWTC):
...
class OldSEDARNGExportTC(RelaxNGTestMixin, OldSEDAExportMixin, WebCWTC):
    def test_seda_1_0(self):
...
class OldSEDAExportTC(RelaxNGTestMixin, WebCWTC):
