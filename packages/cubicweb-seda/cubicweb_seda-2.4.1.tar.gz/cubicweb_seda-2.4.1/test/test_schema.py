...
class SchemaConceptConstraintsTC(WebCWTC):
...
class SchemaTC(WebCWTC):
    ...
    def test_rdef_container_permissions(self):
        ...
        for action in ("add", "delete"):
            # Parent is container
            rdef = self.schema["seda_comment"].relation_definition(
            ...
            rdef = self.schema["seda_tag"].relation_definition(
    ...
    def test_container_relation(self):
        ...
        for rdef in container_rtype.relation_definitions.values():
...
class SchemaIteratorTC(WebCWTC):
