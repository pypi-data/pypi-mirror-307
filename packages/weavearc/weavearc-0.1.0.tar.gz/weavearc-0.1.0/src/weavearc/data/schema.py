...
class BaseModel(msgspec.structs.Struct):
    """
    ...
    def from_dict(
        ...
        try:
            ...
            logger.debug(
                "Failed to decode dictionary: {dictionary}", dictionary=dictionary
            )
            raise e
    ...
    def as_dict(
        ...
        decoder = decoder or msgspec.json.Decoder()

        # Encoding objects of type numpy.float64 is unsupported
        _dict: dict = decoder.decode(encoder.encode(self))
        return _dict
