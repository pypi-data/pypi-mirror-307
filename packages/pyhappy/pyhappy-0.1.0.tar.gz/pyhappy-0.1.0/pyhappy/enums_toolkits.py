...
from packages.core.pyhappy.exceptions import EnumTypeError, EnumValidationError
from packages.core.pyhappy.toolkits import is_iterable, is_iterator, is_generator
from packages.core.pyhappy.types import JsonType
...
class DynamicEnum:
    ...
    def from_enum(cls, enum_class: type[Enum]) -> 'DynamicEnum':
        """Create a DynamicEnum from an existing Enum class."""
