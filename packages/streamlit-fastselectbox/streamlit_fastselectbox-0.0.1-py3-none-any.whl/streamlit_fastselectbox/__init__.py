...
def st_fastselectbox(options, max_results=30, key=None, on_change=None, args=None, kwargs=None):
    """
    ...
    component_value = _component_func(
        options=options, maxResults=max_results, key=None, on_change=on_change_callback)
