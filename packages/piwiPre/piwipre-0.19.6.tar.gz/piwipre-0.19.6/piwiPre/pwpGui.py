...
class GuiDirChooser(PwpGui):
    ...
    def create_and_select(self, path):
    ...
    def check_and_select(self, path):
        if not os.path.isdir(path):
    ...
    def select(self, path: str):
        ...
        elif path[0] == "/" or path[0] == r"\\" or (path[1] == ":" and len(path) == 2):
            full_path = path
        else:
