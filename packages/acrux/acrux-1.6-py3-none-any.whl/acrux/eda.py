...
from .utils import exclude_columns
...
class ExploratoryDataAnalysis:
    def __init__(self,
                 ...
                 exclude_cols: tp.Optional[tp.List[str]] = None,
                 color: str = "darkred",
                 max_n_cols: int = 4,
                 font_size: int = 7,
                 n_top: int = 10,
        ...
        if exclude_cols is not None:
            self._cats_columns = exclude_columns(self._cats_columns, exclude_cols)
            self._nums_columns = exclude_columns(self._nums_columns, exclude_cols)
