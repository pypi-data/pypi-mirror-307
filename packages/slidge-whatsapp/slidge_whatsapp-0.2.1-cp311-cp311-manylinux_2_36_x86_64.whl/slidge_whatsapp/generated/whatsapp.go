...
import (
	...
	whatsapp "git.sr.ht/~nicoco/slidge-whatsapp/slidge_whatsapp/slidge_whatsapp"
...
// Converters for pointer handles for type: *types.GroupParticipantAddRequest
func ptrFromHandle_Ptr_types_GroupParticipantAddRequest(h CGoHandle) *types.GroupParticipantAddRequest {
	p := gopyh.VarFromHandle((gopyh.CGoHandle)(h), "*types.GroupParticipantAddRequest")
	if p == nil {
		return nil
	}
	return gopyh.Embed(p, reflect.TypeOf(types.GroupParticipantAddRequest{})).(*types.GroupParticipantAddRequest)
}
func handleFromPtr_Ptr_types_GroupParticipantAddRequest(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("*types.GroupParticipantAddRequest", p))
}
...
// Converters for non-pointer handles for type: types.GroupParticipant
func ptrFromHandle_types_GroupParticipant(h CGoHandle) *types.GroupParticipant {
	p := gopyh.VarFromHandle((gopyh.CGoHandle)(h), "types.GroupParticipant")
	if p == nil {
		return nil
	}
	return gopyh.Embed(p, reflect.TypeOf(types.GroupParticipant{})).(*types.GroupParticipant)
}
func handleFromPtr_types_GroupParticipant(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("types.GroupParticipant", p))
}

// Converters for non-pointer handles for type: types.GroupParticipantAddRequest
func ptrFromHandle_types_GroupParticipantAddRequest(h CGoHandle) *types.GroupParticipantAddRequest {
	p := gopyh.VarFromHandle((gopyh.CGoHandle)(h), "types.GroupParticipantAddRequest")
	if p == nil {
		return nil
	}
...
func handleFromPtr_types_GroupParticipantAddRequest(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("types.GroupParticipantAddRequest", p))
}
...
// Converters for implicit pointer handles for type: []types.GroupParticipant
func ptrFromHandle_Slice_types_GroupParticipant(h CGoHandle) *[]types.GroupParticipant {
	p := gopyh.VarFromHandle((gopyh.CGoHandle)(h), "[]types.GroupParticipant")
	if p == nil {
		return nil
	}
	return p.(*[]types.GroupParticipant)
}
func deptrFromHandle_Slice_types_GroupParticipant(h CGoHandle) []types.GroupParticipant {
	p := ptrFromHandle_Slice_types_GroupParticipant(h)
	if p == nil {
		return nil
	}
	return *p
}
func handleFromPtr_Slice_types_GroupParticipant(p interface{}) CGoHandle {
	return CGoHandle(gopyh.Register("[]types.GroupParticipant", p))
}

// --- wrapping slice: []types.GroupParticipant ---
//
//export Slice_types_GroupParticipant_CTor
func Slice_types_GroupParticipant_CTor() CGoHandle {
	return CGoHandle(handleFromPtr_Slice_types_GroupParticipant(&[]types.GroupParticipant{}))
}

//export Slice_types_GroupParticipant_len
func Slice_types_GroupParticipant_len(handle CGoHandle) int {
	return len(deptrFromHandle_Slice_types_GroupParticipant(handle))
}

//export Slice_types_GroupParticipant_elem
func Slice_types_GroupParticipant_elem(handle CGoHandle, _idx int) CGoHandle {
	s := deptrFromHandle_Slice_types_GroupParticipant(handle)
	return handleFromPtr_types_GroupParticipant(&(s[_idx]))
}

//export Slice_types_GroupParticipant_subslice
func Slice_types_GroupParticipant_subslice(handle CGoHandle, _st, _ed int) CGoHandle {
	s := deptrFromHandle_Slice_types_GroupParticipant(handle)
	ss := s[_st:_ed]
	return CGoHandle(handleFromPtr_Slice_types_GroupParticipant(&ss))
}

//export Slice_types_GroupParticipant_set
func Slice_types_GroupParticipant_set(handle CGoHandle, _idx int, _vl CGoHandle) {
	s := deptrFromHandle_Slice_types_GroupParticipant(handle)
	s[_idx] = *ptrFromHandle_types_GroupParticipant(_vl)
}

//export Slice_types_GroupParticipant_append
func Slice_types_GroupParticipant_append(handle CGoHandle, _vl CGoHandle) {
	s := ptrFromHandle_Slice_types_GroupParticipant(handle)
	*s = append(*s, *ptrFromHandle_types_GroupParticipant(_vl))
}
...
//export whatsapp_Session_SetAffiliation
func whatsapp_Session_SetAffiliation(_handle CGoHandle, groupID *C.char, participantID *C.char, change *C.char) CGoHandle {
	_saved_thread := C.PyEval_SaveThread()
	vifc, __err := gopyh.VarFromHandleTry((gopyh.CGoHandle)(_handle), "*whatsapp.Session")
	if __err != nil {
		return handleFromPtr_Slice_types_GroupParticipant(nil)
	}
	cret, __err := gopyh.Embed(vifc, reflect.TypeOf(whatsapp.Session{})).(*whatsapp.Session).SetAffiliation(C.GoString(groupID), C.GoString(participantID), whatsmeow.ParticipantChange(C.GoString(change)))
	...
	return handleFromPtr_Slice_types_GroupParticipant(&cret)
}
