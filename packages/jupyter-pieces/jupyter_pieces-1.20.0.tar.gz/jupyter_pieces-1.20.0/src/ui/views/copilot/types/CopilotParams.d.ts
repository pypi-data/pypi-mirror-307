...
import { Application, ClassificationSpecificEnum } from 'core_openapi';
...
export type CopilotParams = {
	 ...
	 * @returns
	 */
	track: (event: CopilotAnalytics) => void;
	/**
	 ...
	 * your `query` parameter must also contain a `replaceable` property {@link CopilotUnidirectionalMessageData['performQuery']}
	 *
