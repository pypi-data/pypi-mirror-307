...
function le(n) {
  ...
  return {
    ...
    m(u, h) {
      M(u, e, h), d(e, o), c || (s = A(e, "click", _), c = !0);
    },
    p(u, h) {
      n = u, h & /*page, max_page*/
      10 && t !== (t = /*pageNumber*/
      n[19] + "") && Y(o, t), h & /*page, paginationRange, max_page*/
      10 && H(
        e,
        "selected",
        /*page*/
...
function se(n) {
  let e, t, o, c, s, _, u, h, g, j, q, v, y, S, C, w, J, R, a = T(X(
    /*page*/
    n[1],
    /*max_page*/
    n[3]
  ...
  return {
    c() {
      e = m("div"), t = m("span"), o = I("Total "), c = I(
        /*total*/
        n[0]
      ), s = I(" Items"), _ = V(), u = m("button"), h = m("div"), j = V();
      for (let i = 0; i < r.length; i += 1)
        r[i].c();
      q = V(), v = m("button"), y = m("div"), C = V(), w = m("select");
      for (let i = 0; i < f.length; i += 1)
        f[i].c();
      k(t, "class", "total svelte-1bca5rq"), k(h, "class", "arrow-prev svelte-1bca5rq"), k(u, "class", "nav-button svelte-1bca5rq"), u.disabled = g = /*page*/
      n[1] === 1, k(y, "class", "arrow-next svelte-1bca5rq"), k(v, "class", "nav-button svelte-1bca5rq"), v.disabled = S = /*page*/
      n[1] === /*max_page*/
      n[3] || /*max_page*/
      n[3] <= 0, k(w, "class", "page-size-selector svelte-1bca5rq"), k(e, "class", "pagination svelte-1bca5rq");
    },
    m(i, p) {
      M(i, e, p), d(e, t), d(t, o), d(t, c), d(t, s), d(e, _), d(e, u), d(u, h), d(e, j);
      for (let l = 0; l < r.length; l += 1)
        r[l] && r[l].m(e, null);
      d(e, q), d(e, v), d(v, y), d(e, C), d(e, w);
    ...
    p(i, [p]) {
      ...
      42) {
        ...
        for (l = 0; l < a.length; l += 1) {
          const z = Q(i, a, l);
          r[l] ? r[l].p(z, p) : (r[l] = U(z), r[l].c(), r[l].m(e, q));
        }
        for (; l < r.length; l += 1)
          r[l].d(1);
        r.length = a.length;
      ...
      20) {
        ...
        for (l = 0; l < b.length; l += 1) {
          const z = L(i, b, l);
          f[l] ? f[l].p(z, p) : (f[l] = W(z), f[l].c(), f[l].m(w, null));
        }
        for (; l < f.length; l += 1)
          f[l].d(1);
        f.length = b.length;
...
function oe(n, e, t) {
  var o = this && this.__awaiter || function(a, r, b, f) {
    function i(p) {
  ...
  let q;
  function v(a) {
    a !== h && (t(1, h = a), t(8, s = JSON.stringify({ total: u, page: h, page_size: g })));
  }
  function y(a) {
    const r = h + a;
    r >= 1 && r <= q && (t(1, h = r), t(8, s = JSON.stringify({ total: u, page: h, page_size: g })));
  }
  function S(a) {
    return o(this, void 0, void 0, function* () {
      const r = parseInt(a.target.value);
      r !== g && (t(2, g = r), t(1, h = 1), yield K(), t(8, s = JSON.stringify({ total: u, page: h, page_size: g })));
    });
  }
  function C() {
    return o(this, void 0, void 0, function* () {
      const a = _(s);
      t(0, u = a.total), t(1, h = a.page), t(2, g = a.page_size), t(3, q = Math.ceil(u / g)), yield K(), c.dispatch("change");
    });
  }
  const w = () => y(-1), J = (a) => v(Number(a)), R = () => y(1);
  return n.$$set = (a) => {
