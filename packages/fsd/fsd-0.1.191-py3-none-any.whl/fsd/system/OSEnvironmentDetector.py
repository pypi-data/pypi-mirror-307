...
class OSEnvironmentDetector:
    def __init__(self):
        ...
        self.os_data = self._gather_os_info()  # Cache the OS info during initialization
    ...
    def get_os_info(self):
        ...
        """
        return self.os_data  # Return cached data instead of gathering again

    def get_all_info(self):
        """
        A function to return all necessary OS information in one call.
        """
        return self.os_data  # Return cached data
