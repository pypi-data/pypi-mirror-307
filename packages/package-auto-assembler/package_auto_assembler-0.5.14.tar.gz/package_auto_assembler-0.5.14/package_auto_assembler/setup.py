...
setup(
    ...
    install_requires=['uvicorn', 'nbformat', 'nbconvert==7.16.4', 'pip_audit==2.7.3', 'mkdocs-material==9.5.30', 'packaging', 'fastapi', 'pyyaml', 'mkdocs==1.6.0', 'numpy==1.26.0', 'streamlit>=1.39.0', 'requests', 'click==8.1.7', 'attrs>=22.2.0', 'stdlib-list'],
