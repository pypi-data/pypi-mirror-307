...
assert OPENAI_API_KEY or AZURE_API_KEY or AZURE_OPENAI_API_KEY, "OPENAI_API_KEY is required."
if not COHERE_API_KEY:
    print("Warning: COHERE_API_KEY is not set, reranking will be disabled.")
