...
urlpatterns = [
    ...
    path('configuration_item/add', views.ICCreateView.as_view(), name='configurationitem_add'),
    path('configuration_item/<int:pk>/', include(get_model_urls(app_name, 'configurationitem'))),
    path('configuration_item/<int:pk>/edit/', views.ICCreateView.as_view(), name='configurationitem_edit'),
    path('configuration_item/<int:pk>/delete/', views.ICDeleteView.as_view(), name='configurationitem_delete'),
