from football_manager_scouting.categories import STATS, ATTRIBUTES
from football_manager_scouting.score import Score
from football_manager_scouting.request_data import Request
import csv
from typing import Dict


def create_index(data, header, file) -> None:
    """
...
def index(db_login: Dict[str, str],
          category: str = 'all',
          position: str = None,
          mins: str = 0,
