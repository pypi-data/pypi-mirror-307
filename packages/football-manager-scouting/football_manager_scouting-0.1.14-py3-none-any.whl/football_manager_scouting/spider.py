...
from football_manager_scouting.categories import STATS
from football_manager_scouting.request_data import Request
from collections import defaultdict
from football_manager_scouting.errors import MultiplePlayersFoundError
from football_manager_scouting.player import Players
...
def spider(db_login: Dict[str, str],
           name: str,
