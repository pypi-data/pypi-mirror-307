...
from .utils import get_or_create_tag, save_cache_csv, col_is_null_or_empty
...
class SWSGoldIcebergSparkHelper:
    ...
    def apply_uom_mapping(
        ...
        logging.info("df with `official_sws_uom` and `official_sws_multiplier`")
        df.show()
        ...
        logging.info("generic_df_uom_mapping")
        generic_df_uom_mapping.show()

        specific_df_uom_mapping = self.df_mapping_sdmx_uom.filter(
            ~col_is_null_or_empty("sws_multiplier")
            & ~col_is_null_or_empty("sdmx_multiplier")
        )
        logging.info("specific_df_uom_mapping")
        specific_df_uom_mapping.show()
        ...
        logging.info("df with generic mappings applied")
        df.show()
        ...
        logging.info("df with specific mappings applied")
        df.show()
        ...
        logging.info("df with correct unit_of_measure, unit_of_measure_multiplier and value")
        df.show()
