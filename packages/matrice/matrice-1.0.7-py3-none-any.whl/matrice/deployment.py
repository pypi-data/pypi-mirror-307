...
class Deployment:
    ...
    def _get_deployment_by_id(self):
        ...
        >>>     pprint(details)
        """
        path = f"/v1/deployment/{self.deployment_id}?projectId={self.project_id}"
    ...
    def _get_deployment_by_name(self):
        ...
        if self.deployment_name == "":
            ...
            sys.exit(0)
        path = f"/v1/deployment/get_deployment_by_name?deploymentName={self.deployment_name}?projectId={self.project_id}"
        resp = self.rpc.get(path=path)
