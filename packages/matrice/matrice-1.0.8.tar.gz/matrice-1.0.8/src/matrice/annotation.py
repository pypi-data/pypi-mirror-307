...
class Annotation:
    ...
    def _get_details(self):
        ...
        >>> 
        >>> # Sample Output :
        >>> {'_id': '6703f06f6444572947735f85', 'title': 'Cat Annotation', 'datasetName': 'Cat Classification', '_idDataset': '6703b42a4dde2c5b596b267e',.....}
    ...
    def rename(self, annotation_title):
        ...
        >>>
        >>> Sample  Output :
        >>> {'MatchedCount': 1, 'ModifiedCount': 1, 'UpsertedCount': 0, 'UpsertedID': None}
        """
        if self.annotation_id is None:
            print(
    ...
    def get_annotation_files(self, page_size=10, page_number=0):
        ...
        >>>
        >>> # Sample Output :
        >>> {'pageSize': 10, 'page': 0, 'total': 1133, 'items': [{'_id': '6703f074634457294773620a', '_idAnnotation': '6703f06f6344572947735f85', '_idDatasetItem': '6703b7f84ddeac5b596b2999', ...} 
        """
    ...
    def get_item_history(self, annotation_item_id):
        ...
        >>> 
        >>> Sample Output : 
        >>> [{'_id': '6703f07863445729477363fa', '_idAnnotation': '6703f06f6344572947735f85', '_idAnnotationItem': '6703f074634457294773620a', 'updatedAnnotation': [{'segmentation': ...}
        """
    ...
    def get_categories(self):
        ...
        >>>
        >>> Sample Output : 
        >>> [{'_id': '6728d45e63445729477427ea', '_idAnnotation': '6728d45d63445729477427da', 'name': 'minivan'}, {'_id': '6728d45e63445729477427eb', '_idAnnotation': '6728d45d63445729477427da', 'name': 'submarine'} ...}
        """
    ...
    def delete_item(self, annotation_item_id):
        ...
        >>>     pprint(delete_resp)
                >>>
        >>> Sample Output :
        >>> Annotation Item Successfully Deleted
        """
        if self.annotation_id is None:
            print(
                "Annotation id not set for this dataset. Cannot perform the deletion for annotation without annotation id"
