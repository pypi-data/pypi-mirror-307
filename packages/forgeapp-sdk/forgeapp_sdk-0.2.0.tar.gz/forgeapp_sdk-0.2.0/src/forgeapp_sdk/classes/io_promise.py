...
from forgeapp_sdk.types import BaseModel
        ...
        if default_value is not None:
            ...
            if len(potential_default_value) > 0:
                try:
                    ...
                    print(
                        f"[Forge] Invalid default value found for multiple IO call with label {self._component.instance.label}: {default_value}. This default value will be ignored.",
                        file=sys.stderr,
                    )
