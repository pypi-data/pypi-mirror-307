...
class IO:
    ...
    class Display:
        ...
        def chart(
            ...
            label: str,
            *,
            type: Literal["area", "bar", "line", "pie", "radar", "radial"],
            data: List[KeyValueObject],
            data_keys: List[str],
            data_label_key: str,
        ...
        ) -> DisplayIOPromise[Literal["DISPLAY_CHART"], None]:
            c = Component(
                method_name="DISPLAY_CHART",
                label=label,
                initial_props=DisplayChartProps(
                    type=type,
                    data=data,
                    data_keys=data_keys,
                    data_label_key=data_label_key,
