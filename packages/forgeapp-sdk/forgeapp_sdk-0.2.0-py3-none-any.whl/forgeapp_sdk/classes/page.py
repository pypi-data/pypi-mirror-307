...
from ..handlers import ForgeActionHandler, ForgePageHandler
...
class Page:
    ...
    handler: Optional[ForgePageHandler] = None
    ...
    def handle(self, handler: ForgePageHandler):
    ...
    def action(
        ...
        *,
        ...
        unlisted: bool = False,
        access: Optional[AccessControlDefinition] = None,
    ) -> Callable[[ForgeActionHandler], None]:
    ...
    def page(
        ...
        unlisted: bool = False,
        access: Optional[AccessControlDefinition] = None,
    ) -> Callable[[ForgePageHandler], None]:
