...
# source: hq/request/PushunsubscribeRequest.proto
...
PushunsubscribeRequest = _reflection.GeneratedProtocolMessageType('PushunsubscribeRequest', (_message.Message,), {
  ...
  '__module__' : 'hq.request.PushunsubscribeRequest_pb2'
