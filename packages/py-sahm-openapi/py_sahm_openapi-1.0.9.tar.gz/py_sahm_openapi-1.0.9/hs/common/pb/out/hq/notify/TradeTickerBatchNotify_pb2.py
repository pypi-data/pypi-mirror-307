...
# source: hq/notify/TradeTickerBatchNotify.proto
...
TradeTickerBatchNotify = _reflection.GeneratedProtocolMessageType('TradeTickerBatchNotify', (_message.Message,), {
  ...
  '__module__' : 'hq.notify.TradeTickerBatchNotify_pb2'
