...
logging.basicConfig(filename=f'{LOG_DIR}/__system__.log', encoding='utf-8', level=logging.DEBUG, format='%(asctime)s | %(name)s | %(levelname)s | %(thread)d | %(message)s')
logging.handlers.RotatingFileHandler(f"{LOG_DIR}/__system__.log", maxBytes=10*MEGA_BYTE, backupCount=50)
