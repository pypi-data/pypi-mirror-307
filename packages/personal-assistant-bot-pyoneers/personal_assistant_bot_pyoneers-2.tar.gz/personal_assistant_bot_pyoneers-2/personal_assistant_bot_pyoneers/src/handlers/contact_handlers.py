from personal_assistant_bot_pyoneers.src.decorators import with_input_error_handler, with_empty_check
from personal_assistant_bot_pyoneers.src.classes import Record, AddressBook, OperationForbiddenError
from personal_assistant_bot_pyoneers.src.types import CmdArgs
from personal_assistant_bot_pyoneers.src.output.pretty_output import print_success_message
from .helpers import (
    get_contact_address,
    print_contacts_list,
    print_single_item,
