"""Test CopyNumberAlterationAnnotator class with MYCN Amplification."""
...
class CopyNumberAlterationAnnotatorMycnAmplificationTestCase(unittest.TestCase):
    """Test CopyNumberAlterationAnnotator class with MYCN Amplification."""
    ...
    def test_query_entrez_gene_id(self):
        self.assertTrue(isinstance(self.indicator_query_resp, IndicatorQueryResp))
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(self.indicator_query_resp.query.entrez_gene_id, 4613)
    ...
    def test_query_hugo_symbol(self):
        self.assertTrue(isinstance(self.indicator_query_resp, IndicatorQueryResp))
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(self.indicator_query_resp.query.hugo_symbol, "MYCN")
