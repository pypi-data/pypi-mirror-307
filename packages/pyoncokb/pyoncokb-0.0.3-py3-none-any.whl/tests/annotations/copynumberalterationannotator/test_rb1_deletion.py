"""Test CopyNumberAlterationAnnotator class with RB1 deletion."""
...
class CopyNumberAlterationAnnotatorRb1DeletionTestCase(unittest.TestCase):
    """Test CopyNumberAlterationAnnotator class with RB1 deletion."""
    ...
    def test_query_alteration(self):
        self.assertTrue(isinstance(self.indicator_query_resp, IndicatorQueryResp))
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(self.indicator_query_resp.query.alteration, "Deletion")
