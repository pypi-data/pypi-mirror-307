"""Test StructuralVariantAnnotator class with ROS1."""
...
class StructuralVariantAnnotatorRos1TestCase(unittest.TestCase):
    """Test StructuralVariantAnnotator class with ROS1."""
    ...
    def test_query_alteration(self):
        self.assertTrue(isinstance(self.indicator_query_resp, IndicatorQueryResp))
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(self.indicator_query_resp.query.alteration, "Fusions")
    ...
    def test_query_entrez_gene_id(self):
        self.assertTrue(isinstance(self.indicator_query_resp, IndicatorQueryResp))
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(self.indicator_query_resp.query.entrez_gene_id, 6098)
    ...
    def test_query_hugo_symbol(self):
        self.assertTrue(isinstance(self.indicator_query_resp, IndicatorQueryResp))
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(self.indicator_query_resp.query.hugo_symbol, "ROS1")
    ...
    def test_summarize_treatments_of_level_1(self):
        ...
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            ...
            self.assertGreaterEqual(len(treatments_level_1), 3)
    ...
    def test_summarize_treatments_of_level_2(self):
        ...
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            ...
            self.assertGreaterEqual(len(treatments_level_2), 2)
