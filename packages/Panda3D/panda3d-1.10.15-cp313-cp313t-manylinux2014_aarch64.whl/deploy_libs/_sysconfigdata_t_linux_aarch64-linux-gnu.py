...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/_internal/cpython-3.13.0-nogil/bin',
    'BINLIBDEST': '/opt/_internal/cpython-3.13.0-nogil/lib/python3.13t',
    ...
    'CONFIG_ARGS': "'CFLAGS_NODIST=-g -O2 -Wall -fdebug-prefix-map=/=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 ' 'LDFLAGS_NODIST=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now' '--prefix=/opt/_internal/cpython-3.13.0-nogil' '--disable-shared' '--with-ensurepip=no' '--disable-gil' '--with-openssl=/opt/_internal/openssl-3.0' '--with-openssl-rpath=auto' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' 'TCLTK_LIBS=-ltk8.6 -ltcl8.6'",
    'CONFINCLUDEDIR': '/opt/_internal/cpython-3.13.0-nogil/include',
    'CONFINCLUDEPY': '/opt/_internal/cpython-3.13.0-nogil/include/python3.13t',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Python-3.13.0/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Python-3.13.0/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/_internal/cpython-3.13.0-nogil /opt/_internal/cpython-3.13.0-nogil/lib /opt/_internal/cpython-3.13.0-nogil/lib/python3.13t /opt/_internal/cpython-3.13.0-nogil/lib/python3.13t/lib-dynload',
    'DESTLIB': '/opt/_internal/cpython-3.13.0-nogil/lib/python3.13t',
    'DESTPATH': '',
    'DESTSHARED': '/opt/_internal/cpython-3.13.0-nogil/lib/python3.13t/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/_internal/cpython-3.13.0-nogil/bin/python3.13t',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.13.0-nogil/include /opt/_internal/cpython-3.13.0-nogil/include /opt/_internal/cpython-3.13.0-nogil/include/python3.13t /opt/_internal/cpython-3.13.0-nogil/include/python3.13t',
    'INCLUDEDIR': '/opt/_internal/cpython-3.13.0-nogil/include',
    'INCLUDEPY': '/opt/_internal/cpython-3.13.0-nogil/include/python3.13t',
    ...
    'LDVERSION': '3.13t',
    'LIBC': '',
    'LIBDEST': '/opt/_internal/cpython-3.13.0-nogil/lib/python3.13t',
    'LIBDIR': '/opt/_internal/cpython-3.13.0-nogil/lib',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -g -O2 -Wall -fdebug-prefix-map=/=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2  -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/_internal/cpython-3.13.0-nogil/lib/pkgconfig',
    'LIBPL': '/opt/_internal/cpython-3.13.0-nogil/lib/python3.13t/config-3.13t-aarch64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/_internal/cpython-3.13.0-nogil/lib/python3.13t',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/_internal/cpython-3.13.0-nogil/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/opt/_internal/cpython-3.13.0-nogil/lib',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/_internal/cpython-3.13.0-nogil',
    'WASM_STDLIB': './opt/_internal/cpython-3.13.0-nogil/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'abs_builddir': '/Python-3.13.0',
    'abs_srcdir': '/Python-3.13.0',
    'datarootdir': '/opt/_internal/cpython-3.13.0-nogil/share',
    'exec_prefix': '/opt/_internal/cpython-3.13.0-nogil',
    'prefix': '/opt/_internal/cpython-3.13.0-nogil',
    'srcdir': '.',
}
