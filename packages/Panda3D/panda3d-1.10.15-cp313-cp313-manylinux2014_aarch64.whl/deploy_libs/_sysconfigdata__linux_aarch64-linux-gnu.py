...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/_internal/cpython-3.13.0/bin',
    'BINLIBDEST': '/opt/_internal/cpython-3.13.0/lib/python3.13',
    ...
    'CONFIG_ARGS': "'CFLAGS_NODIST=-g -O2 -Wall -fdebug-prefix-map=/=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 ' 'LDFLAGS_NODIST=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now' '--prefix=/opt/_internal/cpython-3.13.0' '--disable-shared' '--with-ensurepip=no' '--with-openssl=/opt/_internal/openssl-3.0' '--with-openssl-rpath=auto' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' 'TCLTK_LIBS=-ltk8.6 -ltcl8.6'",
    'CONFINCLUDEDIR': '/opt/_internal/cpython-3.13.0/include',
    'CONFINCLUDEPY': '/opt/_internal/cpython-3.13.0/include/python3.13',
    'COREPYTHONPATH': '',
    ...
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/_internal/cpython-3.13.0 /opt/_internal/cpython-3.13.0/lib /opt/_internal/cpython-3.13.0/lib/python3.13 /opt/_internal/cpython-3.13.0/lib/python3.13/lib-dynload',
    'DESTLIB': '/opt/_internal/cpython-3.13.0/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/opt/_internal/cpython-3.13.0/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/_internal/cpython-3.13.0/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.13.0/include /opt/_internal/cpython-3.13.0/include /opt/_internal/cpython-3.13.0/include/python3.13 /opt/_internal/cpython-3.13.0/include/python3.13',
    'INCLUDEDIR': '/opt/_internal/cpython-3.13.0/include',
    'INCLUDEPY': '/opt/_internal/cpython-3.13.0/include/python3.13',
    ...
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/opt/_internal/cpython-3.13.0/lib/python3.13',
    'LIBDIR': '/opt/_internal/cpython-3.13.0/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/_internal/cpython-3.13.0/lib/pkgconfig',
    'LIBPL': '/opt/_internal/cpython-3.13.0/lib/python3.13/config-3.13-aarch64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/_internal/cpython-3.13.0/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/_internal/cpython-3.13.0/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/opt/_internal/cpython-3.13.0/lib',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/_internal/cpython-3.13.0',
    'WASM_STDLIB': './opt/_internal/cpython-3.13.0/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'datarootdir': '/opt/_internal/cpython-3.13.0/share',
    'exec_prefix': '/opt/_internal/cpython-3.13.0',
    'prefix': '/opt/_internal/cpython-3.13.0',
    'srcdir': '.',
}
