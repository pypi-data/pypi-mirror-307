...
from lionfuncs import LN_UNDEFINED, alcall, to_json, validate_mapping
...
from lion_core.protocols.operatives import (
    ActionRequestModel,
    ActionResponseModel,
    Operative,
    Step,
...
from lion_core.types import ID, BaseModel, FieldModel, NewModelParams
...
class Branch(Node):
    ...
    def _validate_data(cls, data: dict) -> dict:
        ...
        mailbox = data.pop("mailbox", Exchange())
