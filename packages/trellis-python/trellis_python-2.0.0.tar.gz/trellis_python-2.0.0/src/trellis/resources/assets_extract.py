...
class AssetsExtractResource(SyncAPIResource):
    ...
    def extract(
        ...
        *,
        ...
        callback_url: The Callback URL to which the response will be sent after the
        files are processed. auth_key: The Authorization key to be used for the callback
        URL. log_level: Logs for the file upload. Can be "verbose" or "concise". The
        default is "concise".
