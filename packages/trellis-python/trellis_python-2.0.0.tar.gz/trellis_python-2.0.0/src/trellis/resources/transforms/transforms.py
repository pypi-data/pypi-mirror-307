...
class TransformsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        validation_params: Iterable[transform_create_params.ValidationParam] | NotGiven = NOT_GIVEN,
        ...
        Args:
          auth_key: The auth_key parameter is an optional parameter that will be an `Authorization`
          ...
          callback_url: The callback_url parameter is an optional parameter that specifies a URL to
          ...
          include_reference: The include_reference parameter is an optional parameter that specifies whether
    ...
    def update(
        ...
        transform_id: str,
        *,
        _job_id: str | NotGiven = NOT_GIVEN,
        auth_key: str | NotGiven = NOT_GIVEN,
        callback_url: str | NotGiven = NOT_GIVEN,
        include_reference: bool | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
