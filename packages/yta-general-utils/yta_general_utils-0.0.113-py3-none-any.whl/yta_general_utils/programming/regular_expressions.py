...
class RegularExpression(Enum):
    ...
    """
    YOUTUBE_VIDEO_URL = r'^(https?://)?(www\.)?(youtube\.com/watch\?v=|youtu\.be/)([a-zA-Z0-9_-]{11})'
    """
    ...
    def check(self, string: str):
        ...
        # I was doing 're.match(regexp, youtube_video_url) is not None'
        # in another part of the code. Is this below working (?)
