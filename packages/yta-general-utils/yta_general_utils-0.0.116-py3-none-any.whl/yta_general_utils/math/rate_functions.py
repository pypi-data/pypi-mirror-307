...
class RateFunction:
    ...
    @staticmethod
    def running_start(n: float, pull_factor: float = -0.5) -> typing.Iterable: # what is func return type?
    ...
    @staticmethod
    def squish_rate_func(func: typing.Callable[[float], float], a: float = 0.4, b: float = 0.6) -> typing.Callable[[float], float]:
        def result(n: float):
            if a == b:
                return a
