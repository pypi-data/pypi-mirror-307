...
IDES_CONFIG = SubConfigSrc(
    ...
    ConfigOptionSrc(
        'editor_font_family', str, default="Ubuntu mono",
    ...
    ConfigOptionSrc(
        ...
        docs = """
            ...
            thèmes disponibles][ace-themes]: utiliser le noms des fichiers `./js`).{{pmt_note(
            "Ce réglage est écrasé par l'ancienne façon de modifier le thème, en définissant
            `extra.ace_style.slate` dans le fichier mkdocs.yml."
            )}}
        """,
    ...
    ConfigOptionSrc(
        ...
        docs = """
            Thème de couleur utilisé pour les éditeurs des IDEs en mode clair ([liste des
            thèmes disponibles][ace-themes]: utiliser le noms des fichiers `./js`).{{pmt_note(
            "Ce réglage est écrasé par l'ancienne façon de modifier le thème, en définissant
            `extra.ace_style.default` dans le fichier mkdocs.yml."
            )}}
