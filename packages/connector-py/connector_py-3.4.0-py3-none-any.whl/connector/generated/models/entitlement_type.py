...
class EntitlementType(BaseModel):
    ...
    max: Optional[StrictInt] = Field(default=None, description="How many of this type of entitlement can be assigned? If 1: an account can only have Otherwise, accounts can have many (up to the specified max, if there is one)")
