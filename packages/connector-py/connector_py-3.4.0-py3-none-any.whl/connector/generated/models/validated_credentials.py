...
class ValidatedCredentials(BaseModel):
    ...
    """ # noqa: E501
    valid: StrictBool
    unique_tenant_id: StrictStr = Field(description="This is the unique ID, in the Application's side, of the user's organization. Some examples are: * AWS account ID * Pagerduty unique domain * Github organization name")
