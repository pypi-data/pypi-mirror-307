...
class BBCropInterface:
    ...
    @staticmethod
    def crop(image_path: str | Image.Image, bb_dict: dict[str, float | int], bb_schema: Schema, image_height: int = 0, image_width: int = 0, x_max_offset: float = 0.0, y_max_offset: float = 0.0, y_scale_range: tuple[float, float] = (1.0, 1.0), x_scale_range: tuple[float, float] = (1.0, 1.0)) -> Image.Image:
        ...
        :param x_max_offset: Maximum random offset of the crop in x direction (both left and right).
        :param y_max_offset: Maximum random offset of the crop in y direction (both up and down).
        :param y_scale_range: Range of random scaling of the crop in y direction. The first value is the minimum
            scaling factor, the second value is the maximum scaling factor.
        :param x_scale_range: Range of random scaling of the crop in x direction. The first value is the minimum
            scaling factor, the second value is the maximum scaling factor.
