...
class MutableObject(Object):
    ...
    def is_stale(self, timestamp: datetime.datetime | str | None, epsilon: float = 0.0) -> bool:
        ...
        The function parses the timestamps and computes the difference in seconds. If this difference exceeds the
        provided epsilon value, the object is considered stale.
