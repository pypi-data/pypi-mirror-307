...
class FunctionalTestCase(unittest.TestCase):
    ...
    def test_first_must_provide_first_element_of_iterator(self):
        ...
        # Expect
        self.assertEqual(the_first, 1)

    def test_first_must_provide_first_element_of_iterable(self):
        # Given...
        test_data = [1,2,3,4,5]
    ...
    def test_first_must_provide_None_on_empty_iterator(self):
        # Given...
        test_data = []
        iterator = iter(test_data)
        ...
        # Expect
        self.assertIsNone(the_first)

    def test_first_must_provide_None_on_empty_iterable(self):
        # Given...
        test_data = []
