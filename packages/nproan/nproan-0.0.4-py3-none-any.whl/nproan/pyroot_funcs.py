...
# maybe we want to create a ROOT file from the data somteime
_logger = logger.Logger(__name__, "info").get_logger()


def get_tree_branch_as_np(
    tree_name: str, root_file: str, branch_names: str, filter_string: str = None
) -> dict[str, np.ndarray]:
    """
...
def get_count_map_from_pixel_index(inp_dict: dict[str, np.ndarray]) -> np.ndarray:
    """
