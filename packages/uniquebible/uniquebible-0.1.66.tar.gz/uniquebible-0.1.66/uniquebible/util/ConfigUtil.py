...
class ConfigUtil:
    ...
    def setup(noQt=None, cli=None, enableCli=None, enableApiServer=None, enableHttpServer=None, runMode=None):
        ...
        # Groq Cloud API Keys""",
        [])
        setConfig("groqApi_systemMessage", """
        # Groq Chat System Message""",
        "I would like you to communicate with me in the manner of a distinguished University professor specializing in biblical studies. Please engage with me accordingly.")
