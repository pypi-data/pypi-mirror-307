...
""".format(self.getBookTitle(), self.getChapterTitle(), self.getVerseTitle())
    ...
    def qnaContent(self):
        content = "<h2>{0}</h2>".format(config.thisTranslation["askAI"])
        ...
        content += "<p><button id='bibleQuestionButton1' type='button' onclick='answerGeneral();' class='ubaButton'>{0}</button></p>".format(config.thisTranslation["send"])
        ...
        content += "<p><button id='bibleQuestionButton2' type='button' onclick='answerYouth();' class='ubaButton'>{0}</button></p>".format(config.thisTranslation["send"])
        ...
        content += "<p><button id='bibleQuestionButton3' type='button' onclick='answerKid();' class='ubaButton'>{0}</button></p>".format(config.thisTranslation["send"])

        content += """
<script>
function answerGeneral() {0}
    var searchString = document.getElementById("bibleQuestion1").value;
    document.title = "ANSWER:::"+searchString;
{1}
var input = document.getElementById('bibleQuestion1');
input.addEventListener('keyup', function(event) {0}
  ...
  {1}
{1});
function answerYouth() {0}
    var searchString = document.getElementById("bibleQuestion2").value;
    document.title = "ANSWERYOUTH:::"+searchString;
{1}
var input = document.getElementById('bibleQuestion2');
input.addEventListener('keyup', function(event) {0}
  if (event.keyCode === 13) {0}
   event.preventDefault();
  ...
  {1}
{1});
function answerKid() {0}
    var searchString = document.getElementById("bibleQuestion3").value;
    document.title = "ANSWERKID:::"+searchString;
{1}
var input = document.getElementById('bibleQuestion3');
input.addEventListener('keyup', function(event) {0}
  if (event.keyCode === 13) {0}
   event.preventDefault();
