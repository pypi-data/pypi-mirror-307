...
The WHERE condition is described as: {query}"""
    ...
    def textAnswerGeneral(self, command, source):
        return self.textAnswer(self, command, source, config.groqApi_systemMessage_general)

    def textAnswerYouth(self, command, source):
        return self.textAnswer(self, command, source, config.groqApi_systemMessage_youth)

    def textAnswerKid(self, command, source):
        return self.textAnswer(self, command, source, config.groqApi_systemMessage_kid)
    ...
    def textAnswer(self, command, source, systemMessage):
        if not config.groqApi_key:
            ...
            try:
                ...
                textOutput = "Failed to connect AI model!"
