...
import asn1tool
from asn1tool.codecs import utc_time_to_datetime as ut2dt
from asn1tool.compat import timezone
from asn1tool.compat import timedelta
...
class asn1toolBerTest(asn1toolBaseTest):

    maxDiff = None

    def test_boolean(self):
        foo = asn1tool.compile_string(
    ...
    def test_boolean_explicit_tags(self):
        ...
        foo = asn1tool.compile_string(spec)
        self.assert_encode_decode(foo, 'Foo', True, b'\xa2\x03\x01\x01\xff')

        # Bad explicit tag.
        with self.assertRaises(asn1tool.DecodeError) as cm:
    ...
    def test_enumerated(self):
        foo = asn1tool.compile_dict(deepcopy(ENUMERATED))
    ...
    def test_sequence(self):
        ...
        # Missing member.
        with self.assertRaises(asn1tool.EncodeError) as cm:
            foo.encode('C', {})
    ...
    def test_foo(self):
        foo = asn1tool.compile_files(['tests/files/foo.asn'])
    ...
    def test_complex(self):
        cmplx = asn1tool.compile_files('tests/files/complex.asn')
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.compile_dict(deepcopy(RRC_8_6_0))
    ...
    def test_rfc1157(self):
        rfc1157 = asn1tool.compile_files([
    ...
    def test_rfc4511(self):
        rfc4511 = asn1tool.compile_dict(deepcopy(RFC4511))
    ...
    def test_rfc5280(self):
        rfc5280 = asn1tool.compile_dict(deepcopy(RFC5280))
    ...
    def test_all_types(self):
        all_types = asn1tool.compile_files('tests/files/all_types.asn')
    ...
    def test_all_types_automatic_tags(self):
        all_types = asn1tool.compile_files(
    ...
    def test_module_tags_explicit(self):
        all_types = asn1tool.compile_files('tests/files/module_tags_explicit.asn')
    ...
    def test_module_tags_implicit(self):
        all_types = asn1tool.compile_files('tests/files/module_tags_implicit.asn')
    ...
    def test_module_tags_automatic(self):
        all_types = asn1tool.compile_files('tests/files/module_tags_automatic.asn')
    ...
    def test_nested_explicit_tags(self):
        ...
        testcase = asn1tool.compile_string(spec)
    ...
    def test_zforce(self):
        ...
        zforce = asn1tool.compile_dict(deepcopy(ZFORCE))
    ...
    def test_bar(self):
        ...
        bar = asn1tool.compile_files('tests/files/bar.asn')
    ...
    def test_versions(self):
        foo = asn1tool.compile_files('tests/files/versions.asn')
