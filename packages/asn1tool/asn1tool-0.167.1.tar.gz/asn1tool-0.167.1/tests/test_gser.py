...
class asn1toolGserTest(asn1toolBaseTest):
    ...
    def test_foo(self):
        foo = asn1tool.compile_files(['tests/files/foo.asn'], 'gser')
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.compile_dict(deepcopy(RRC_8_6_0), 'gser')
    ...
    def test_rfc4511(self):
        rfc4511 = asn1tool.compile_dict(deepcopy(RFC4511), 'gser')
