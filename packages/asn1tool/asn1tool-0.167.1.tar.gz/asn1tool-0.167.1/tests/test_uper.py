...
import string
from asn1tool.codecs import restricted_utc_time_to_datetime as ut2dt
from asn1tool.codecs import restricted_generalized_time_to_datetime as gt2dt
import datetime
...
class asn1toolUPerTest(asn1toolBaseTest):
    ...
    def test_foo(self):
        foo = asn1tool.compile_files('tests/files/foo.asn', 'uper')
    ...
    def test_versions(self):
        foo = asn1tool.compile_files('tests/files/versions.asn', 'uper')
    ...
    def test_x691_a1(self):
        a1 = asn1tool.compile_files('tests/files/x691_a1.asn', 'uper')
    ...
    def test_x691_a2(self):
        a2 = asn1tool.compile_files('tests/files/x691_a2.asn', 'uper')
    ...
    def test_x691_a3(self):
        a3 = asn1tool.compile_files('tests/files/x691_a3.asn', 'uper')
    ...
    def test_x691_a4(self):
        a4 = asn1tool.compile_dict(deepcopy(X691_A4), 'uper')
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.compile_dict(deepcopy(RRC_8_6_0), 'uper')
    ...
    def test_lpp_14_3_0(self):
        lpp = asn1tool.compile_dict(deepcopy(LPP_14_3_0), 'uper')
    ...
    def test_etsi_cam_pdu_descriptions_1_3_2(self):
        ...
        cam = asn1tool.compile_files(files, 'uper')
    ...
    def test_etsi_its_container_1_2_1(self):
        its = asn1tool.compile_files('tests/files/etsi/its_container_1_2_1.asn',
                                      'uper')
    ...
    def test_etsi_mapem_2_1_1(self):
        ...
        dsrc = asn1tool.compile_files(files, 'uper')
    ...
    def test_error_out_of_data(self):
        ...
        for type_name, encoded, message in datas:
            with self.assertRaises(asn1tool.codecs.per.OutOfDataError) as cm:
                foo.decode(type_name, encoded)

            self.assertEqual(str(cm.exception), message)

    def test_oma_ulp(self):
        ulp = asn1tool.compile_dict(deepcopy(OMA_ULP), 'uper')
