...
class asn1toolXerTest(asn1toolBaseTest):
    ...
    def test_foo(self):
        foo = asn1tool.compile_files(['tests/files/foo.asn'], 'xer')
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.compile_dict(deepcopy(RRC_8_6_0), 'xer')
    ...
    def test_all_types(self):
        foo = asn1tool.compile_files('tests/files/all_types.asn', 'xer')
