...
class asn1toolDerTest(asn1toolBaseTest):
    ...
    def test_all_types(self):
        all_types = asn1tool.compile_files('tests/files/all_types.asn', 'der')
    ...
    def test_decode_length(self):
        foo = asn1tool.compile_files('tests/files/foo.asn', 'der')
    ...
    def test_rfc5280(self):
        rfc5280 = asn1tool.compile_dict(deepcopy(RFC5280), 'der')
