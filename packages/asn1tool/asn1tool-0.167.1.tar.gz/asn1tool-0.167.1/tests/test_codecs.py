...
import asn1tool
from asn1tool.codecs import utc_time_to_datetime
from asn1tool.codecs import utc_time_from_datetime
from asn1tool.codecs import generalized_time_to_datetime
from asn1tool.codecs import generalized_time_from_datetime
from asn1tool.codecs import restricted_utc_time_to_datetime
from asn1tool.codecs import restricted_utc_time_from_datetime
from asn1tool.codecs import restricted_generalized_time_to_datetime
from asn1tool.codecs import restricted_generalized_time_from_datetime
...
class asn1toolUtilsTest(unittest.TestCase):
    ...
    def test_utc_time_to_datetime_errors(self):
        ...
        for utc_time in datas:
            with self.assertRaises(asn1tool.Error) as cm:
