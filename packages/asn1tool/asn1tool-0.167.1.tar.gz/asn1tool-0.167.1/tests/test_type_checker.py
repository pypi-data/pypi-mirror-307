...
import unittest
import datetime
import asn1tool.codecs.type_checker
...
class asn1toolEncodeTypeCheckerTest(unittest.TestCase):
    ...
    def assert_good_bad(self,
        ...
        foo = asn1tool.parse_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= "
            "BEGIN "
            "A ::= " + type_spec + " "
            "END")

        foo = asn1tool.codecs.type_checker.compile_dict(foo)
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.codecs.type_checker.compile_dict(deepcopy(RRC_8_6_0))
    ...
    def test_information_object(self):
        ...
        information_object = asn1tool.codecs.type_checker.compile_dict(
