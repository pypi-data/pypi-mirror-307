try:
    ...
    try:import pyparsing
        ...
        try:
            os.system(f"pip install pyparsing -q")
        except:pass

    """
    try:import bitstruct
    except:
        try:
            os.system(f"pip install bitstruct -q")
        except:pass
    """
    ...
    def _do_shell(_args):
        ...
        history = FileHistory(os.path.join(user_home, '.asn1tool-history.txt'))
