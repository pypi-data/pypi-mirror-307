...
try:import asn1tools
except:
    try:os.system(f"pip install asn1tools -q")
    except:pass
...
def create_grammar():
    ...
    # Parse actions converting tokens to asn1tool representation.
...
def parse_string(string):
    ...
    ...     foo = asn1tool.parse_string(fin.read())
...
def parse_files(filenames, encoding='utf-8'):
    ...
    >>> foo = asn1tool.parse_files('foo.asn')
