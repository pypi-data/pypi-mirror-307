...
class asn1toolPerTest(asn1toolBaseTest):
    ...
    def test_versions(self):
        foo = asn1tool.compile_files('tests/files/versions.asn', 'per')
    ...
    def test_x691_a1(self):
        a1 = asn1tool.compile_files('tests/files/x691_a1.asn', 'per')
    ...
    def test_x691_a2(self):
        a2 = asn1tool.compile_files('tests/files/x691_a2.asn', 'per')
    ...
    def test_x691_a3(self):
        a3 = asn1tool.compile_files('tests/files/x691_a3.asn', 'per')
    ...
    def test_x691_a4(self):
        a4 = asn1tool.compile_dict(deepcopy(X691_A4), 'per')
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.compile_dict(deepcopy(RRC_8_6_0), 'per')
    ...
    def test_bar(self):
        ...
        bar = asn1tool.compile_files('tests/files/bar.asn', 'per')
    ...
    def test_s1ap_14_4_0(self):
        ...
        with self.assertRaises(asn1tool.CompileError):
            s1ap = asn1tool.compile_dict(deepcopy(S1AP_14_4_0), 'per')
    ...
    def test_information_object(self):
        ...
        information_object = asn1tool.compile_files(
    ...
    def test_oma_ulp(self):
        ulp = asn1tool.compile_dict(deepcopy(OMA_ULP), 'per')
