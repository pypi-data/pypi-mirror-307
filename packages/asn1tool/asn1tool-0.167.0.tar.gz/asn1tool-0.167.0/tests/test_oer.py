...
class asn1toolOerTest(asn1toolBaseTest):
    ...
    def test_overview_of_oer(self):
        foo = asn1tool.compile_files('tests/files/overview_of_oer.asn',
                                      'oer')
    ...
    def test_x691_a1(self):
        a1 = asn1tool.compile_files('tests/files/x691_a1.asn', 'oer')
    ...
    def test_ieee1609_2(self):
        foo = asn1tool.compile_dict(deepcopy(IEEE1609_2), 'oer')
    ...
    def test_c_source(self):
        ...
        foo = asn1tool.compile_files(files, 'oer')

        # Type L - decode error bad length.
        with self.assertRaises(asn1tool.codecs.OutOfDataError):
