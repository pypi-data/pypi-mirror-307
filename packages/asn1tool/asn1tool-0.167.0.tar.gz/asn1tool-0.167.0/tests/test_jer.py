...
from asn1tool.codecs import generalized_time_to_datetime as gt2dt
...
class asn1toolJerTest(unittest.TestCase):
    ...
    def test_foo(self):
        foo = asn1tool.compile_files(['tests/files/foo.asn'], 'jer')
    ...
    def test_rrc_8_6_0(self):
        rrc = asn1tool.compile_dict(deepcopy(RRC_8_6_0), 'jer')
    ...
    def test_all_types(self):
        foo = asn1tool.compile_files('tests/files/all_types.asn', 'jer')
    ...
    def test_repr_all_types(self):
        foo = asn1tool.compile_files('tests/files/all_types.asn',
                                      'jer')
