...
.. code-block:: python
   ...
   >>> import asn1tool
   >>> foo = asn1tool.compile_files('tests/files/foo.asn', 'per')
   >>> encoded = foo.encode('Question', {'id': 1, 'question': 'Is 1+1=3?'})
   >>> encoded
...
.. code-block:: text
   ...
   > asn1tool convert tests/files/foo.asn Question 300e0201011609497320312b313d333f
   question Question ::= {
       id 1,
       question "Is 1+1=3?"
   }
...
.. code-block:: text
   ...
   > asn1tool convert -i uper -o xer tests/files/foo.asn Question 01010993cd03156c5eb37e
   <Question>
       <id>1</id>
       <question>Is 1+1=3?</question>
   </Question>
...
.. code-block:: text
   ...
   > asn1tool convert -i uper -o jer tests/files/foo.asn Question 01010993cd03156c5eb37e
   {
       "id": 1,
       "question": "Is 1+1=3?"
   }
...
.. code-block:: text
   ...
   > cat encoded.txt | asn1tool convert tests/files/foo.asn Question -
   2018-02-24 11:22:09
   question Question ::= {
       id 1,
       question "Is 1+1=3?"
...
.. code-block:: text
   ...
   > time asn1tool convert --cache-dir my_cache -i uper tests/files/3gpp/rrc_8_6_0.asn PCCH-Message 28
...
.. code-block:: text
   ...
   > asn1tool parse tests/files/foo.asn foo.py
   > asn1tool convert foo.py Question 300e0201011609497320312b313d333f
   question Question ::= {
       id 1,
       question "Is 1+1=3?"
   }
...
.. code-block:: text
   ...
   > asn1tool generate_c_source --namespace oer tests/files/c_source/c_source.asn
...
.. code-block:: text
   ...
   > asn1tool generate_c_source --codec uper --namespace uper tests/files/c_source/c_source.asn
...
.. code-block:: text
   ...
   > asn1tool generate_c_source --namespace oer --generate-fuzzer tests/files/c_source/c_source.asn
   Successfully generated oer.h and oer.c.
