...
class TestPowerConsumptionResponseInvoiced(unittest.TestCase):
    """PowerConsumptionResponseInvoiced unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerConsumptionResponseInvoiced:
        """Test PowerConsumptionResponseInvoiced
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerConsumptionResponseInvoiced`
        """
        model = PowerConsumptionResponseInvoiced()
        if include_optional:
            return PowerConsumptionResponseInvoiced(
    ...
    def testPowerConsumptionResponseInvoiced(self):
        """Test PowerConsumptionResponseInvoiced"""
