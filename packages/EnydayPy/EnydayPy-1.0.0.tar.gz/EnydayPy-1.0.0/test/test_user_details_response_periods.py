...
class TestUserDetailsResponsePeriods(unittest.TestCase):
    """UserDetailsResponsePeriods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserDetailsResponsePeriods:
        """Test UserDetailsResponsePeriods
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserDetailsResponsePeriods`
        """
        model = UserDetailsResponsePeriods()
        if include_optional:
            return UserDetailsResponsePeriods(
    ...
    def testUserDetailsResponsePeriods(self):
        """Test UserDetailsResponsePeriods"""
