...
from .product_platform_schema import ProductPlatformResponse, ProductPlatformShortenedWithPlatformResponse
...
class ProductShortenedResponse(ProductResponse):
    product_platforms = list[ProductPlatformShortenedWithPlatformResponse]
