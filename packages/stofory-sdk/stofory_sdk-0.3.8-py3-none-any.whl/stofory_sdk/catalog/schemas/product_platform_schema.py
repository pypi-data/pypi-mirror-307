...
from .platform_schema import PlatformResponse, PlatformShortenedResponse
...
class ProductPlatformShortenedWithPlatformResponse(Struct):
    id: int
    platform: PlatformShortenedResponse
