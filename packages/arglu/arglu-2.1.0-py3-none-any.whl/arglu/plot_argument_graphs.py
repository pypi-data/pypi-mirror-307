...
#       xzklcmzcx
    ...
    def draw_graph(self, the_base_size=2, gl_arg=""):
        ...
        nx.draw_networkx_edge_labels(G,edge_labels = nx.get_edge_attributes(my_graph,'label'), self.positions)# edge_labels=edge_labels, font_size=font_size, font_color='red')
