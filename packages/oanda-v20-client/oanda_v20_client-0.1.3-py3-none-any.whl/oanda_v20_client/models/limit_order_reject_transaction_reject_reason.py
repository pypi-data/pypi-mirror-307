...
LimitOrderRejectTransactionRejectReason = Literal[
...
LIMIT_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_limit_order_reject_transaction_reject_reason(
    value: str,
) -> LimitOrderRejectTransactionRejectReason:
    if value in LIMIT_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(LimitOrderRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {LIMIT_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
