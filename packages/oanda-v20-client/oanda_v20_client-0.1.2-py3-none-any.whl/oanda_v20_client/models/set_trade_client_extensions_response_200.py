...
if TYPE_CHECKING:
    from ..models.trade_client_extensions_modify_transaction import (
...
class SetTradeClientExtensionsResponse200:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.trade_client_extensions_modify_transaction, Unset):
            trade_client_extensions_modify_transaction = (
                self.trade_client_extensions_modify_transaction.to_dict()
            )
        ...
        if trade_client_extensions_modify_transaction is not UNSET:
            field_dict["tradeClientExtensionsModifyTransaction"] = (
                trade_client_extensions_modify_transaction
            )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _trade_client_extensions_modify_transaction = d.pop(
            "tradeClientExtensionsModifyTransaction", UNSET
        )
        trade_client_extensions_modify_transaction: Union[
            Unset, TradeClientExtensionsModifyTransaction
        ]
