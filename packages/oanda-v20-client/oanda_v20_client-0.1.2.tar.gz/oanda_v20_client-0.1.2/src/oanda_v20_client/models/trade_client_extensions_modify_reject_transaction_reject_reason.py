...
TradeClientExtensionsModifyRejectTransactionRejectReason = Literal[
...
TRADE_CLIENT_EXTENSIONS_MODIFY_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_trade_client_extensions_modify_reject_transaction_reject_reason(
    value: str,
) -> TradeClientExtensionsModifyRejectTransactionRejectReason:
    if value in TRADE_CLIENT_EXTENSIONS_MODIFY_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(TradeClientExtensionsModifyRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {TRADE_CLIENT_EXTENSIONS_MODIFY_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
