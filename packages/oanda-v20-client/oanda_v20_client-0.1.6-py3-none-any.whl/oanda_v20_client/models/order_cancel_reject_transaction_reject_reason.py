...
OrderCancelRejectTransactionRejectReason = Literal[
...
ORDER_CANCEL_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_order_cancel_reject_transaction_reject_reason(
    value: str,
) -> OrderCancelRejectTransactionRejectReason:
    if value in ORDER_CANCEL_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(OrderCancelRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {ORDER_CANCEL_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
