...
from ..models.trailing_stop_loss_order_reject_transaction_reason import (
...
from ..models.trailing_stop_loss_order_reject_transaction_type import (
...
class TrailingStopLossOrderRejectTransaction:
    ...
    trigger_condition: Union[
        Unset, TrailingStopLossOrderRejectTransactionTriggerCondition
    ] = UNSET
