...
OrderCancelTransactionReason = Literal[
    "ACCOUNT_LOCKED",
...
ORDER_CANCEL_TRANSACTION_REASON_VALUES: Set[OrderCancelTransactionReason] = {
    "ACCOUNT_LOCKED",
    "ACCOUNT_NEW_POSITIONS_LOCKED",
    "ACCOUNT_ORDER_CREATION_LOCKED",
    "ACCOUNT_ORDER_FILL_LOCKED",
...
def check_order_cancel_transaction_reason(value: str) -> OrderCancelTransactionReason:
    if value in ORDER_CANCEL_TRANSACTION_REASON_VALUES:
        return cast(OrderCancelTransactionReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {ORDER_CANCEL_TRANSACTION_REASON_VALUES!r}"
    )
