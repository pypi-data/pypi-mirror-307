...
TransactionRejectReason = Literal[
...
TRANSACTION_REJECT_REASON_VALUES: Set[TransactionRejectReason] = {
    "ACCOUNT_CONFIGURATION_LOCKED",
    "ACCOUNT_DEPOSIT_LOCKED",
    "ACCOUNT_LOCKED",
    "ACCOUNT_NOT_ACTIVE",
...
def check_transaction_reject_reason(value: str) -> TransactionRejectReason:
    if value in TRANSACTION_REJECT_REASON_VALUES:
        return cast(TransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {TRANSACTION_REJECT_REASON_VALUES!r}"
    )
