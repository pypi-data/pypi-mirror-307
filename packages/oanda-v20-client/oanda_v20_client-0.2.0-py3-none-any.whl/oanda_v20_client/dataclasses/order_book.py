...
class OrderBook:
    ...
    Attributes:
        instrument (Optional[str]): The order book's instrument
        time (Optional[str]): The time when the order book snapshot was created.
        price (Optional[str]): The price (midpoint) for the order book's instrument at the time of the order book
            snapshot
        ...
        buckets (Optional[List['OrderBookBucket']]): The partitioned order book, divided into buckets using a
