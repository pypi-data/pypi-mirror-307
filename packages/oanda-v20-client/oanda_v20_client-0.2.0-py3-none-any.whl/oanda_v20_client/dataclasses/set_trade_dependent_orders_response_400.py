...
class SetTradeDependentOrdersResponse400:
    """Attributes:
    take_profit_order_cancel_reject_transaction (Optional[OrderCancelRejectTransaction]): An
        OrderCancelRejectTransaction represents the rejection of the cancellation of an Order in the client's Account.
    take_profit_order_reject_transaction (Optional[TakeProfitOrderRejectTransaction]): A
        TakeProfitOrderRejectTransaction represents the rejection of the creation of a TakeProfit Order.
    stop_loss_order_cancel_reject_transaction (Optional[OrderCancelRejectTransaction]): An
        OrderCancelRejectTransaction represents the rejection of the cancellation of an Order in the client's Account.
    stop_loss_order_reject_transaction (Optional[StopLossOrderRejectTransaction]): A
        StopLossOrderRejectTransaction represents the rejection of the creation of a StopLoss Order.
    trailing_stop_loss_order_cancel_reject_transaction (Optional[OrderCancelRejectTransaction]): An
        OrderCancelRejectTransaction represents the rejection of the cancellation of an Order in the client's Account.
    trailing_stop_loss_order_reject_transaction (Optional[TrailingStopLossOrderRejectTransaction]): A
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _take_profit_order_cancel_reject_transaction is None:
        ...
        take_profit_order_reject_transaction: Optional[TakeProfitOrderRejectTransaction]
        if _take_profit_order_reject_transaction is None:
        ...
        if _stop_loss_order_cancel_reject_transaction is None:
        ...
        stop_loss_order_reject_transaction: Optional[StopLossOrderRejectTransaction]
        if _stop_loss_order_reject_transaction is None:
        ...
        if _trailing_stop_loss_order_cancel_reject_transaction is None:
        ...
        if _trailing_stop_loss_order_reject_transaction is None:
