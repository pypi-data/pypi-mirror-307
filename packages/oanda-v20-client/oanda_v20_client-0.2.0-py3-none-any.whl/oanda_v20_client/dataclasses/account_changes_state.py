...
class AccountChangesState:
    ...
    Order state.
        ...
        Attributes:
            ...
            orders (Optional[List['DynamicOrderState']]): The price-dependent state of each pending Order in the
                Account.
            trades (Optional[List['CalculatedTradeState']]): The price-dependent state for each open Trade in the
                Account.
            positions (Optional[List['CalculatedPositionState']]): The price-dependent state for each open Position in
                the Account."""
