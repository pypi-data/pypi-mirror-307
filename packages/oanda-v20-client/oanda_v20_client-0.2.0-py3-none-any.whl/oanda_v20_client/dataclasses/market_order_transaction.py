...
class MarketOrderTransaction:
    ...
    a Position or to particiate in in a Margin closeout.
        ...
        Attributes:
            ...
            type (Optional[MarketOrderTransactionType]): The Type of the Transaction. Always set to "MARKET_ORDER" in a
            ...
            time_in_force (Optional[MarketOrderTransactionTimeInForce]): The time-in-force requested for the Market
            ...
            position_fill (Optional[MarketOrderTransactionPositionFill]): Specification of how Positions in the Account
            ...
            reason (Optional[MarketOrderTransactionReason]): The reason that the Market Order was created
