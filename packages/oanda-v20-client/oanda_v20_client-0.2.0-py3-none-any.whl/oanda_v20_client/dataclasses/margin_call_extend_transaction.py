...
class MarginCallExtendTransaction:
    ...
    Attributes:
        ...
        type (Optional[MarginCallExtendTransactionType]): The Type of the Transaction. Always set to
            "MARGIN_CALL_EXTEND" for an MarginCallExtendTransaction.
        extension_number (Optional[int]): The number of the extensions to the Account's current margin call that
