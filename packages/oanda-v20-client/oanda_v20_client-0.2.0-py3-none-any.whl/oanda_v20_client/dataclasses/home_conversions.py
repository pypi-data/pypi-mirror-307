...
class HomeConversions:
    ...
    currency. The conversion factor depends on the scenario the conversion is required for.
        ...
        Attributes:
            currency (Optional[str]): The currency to be converted into the home currency.
            account_gain (Optional[str]): The factor used to convert any gains for an Account in the specified currency
            ...
            account_loss (Optional[str]): The string representation of a decimal number.
            position_value (Optional[str]): The factor used to convert a Position or Trade Value in the specified
