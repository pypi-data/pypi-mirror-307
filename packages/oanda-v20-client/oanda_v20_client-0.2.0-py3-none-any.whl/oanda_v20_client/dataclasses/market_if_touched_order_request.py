...
class MarketIfTouchedOrderRequest:
    ...
    Attributes:
        type (Optional[MarketIfTouchedOrderRequestType]): The type of the Order to Create. Must be set to
        ...
        time_in_force (Optional[MarketIfTouchedOrderRequestTimeInForce]): The time-in-force requested for the
        ...
        gtd_time (Optional[str]): The date/time when the MarketIfTouched Order will be cancelled if its timeInForce
            is "GTD".
        position_fill (Optional[MarketIfTouchedOrderRequestPositionFill]): Specification of how Positions in the
            Account are modified when the Order is filled.
        trigger_condition (Optional[MarketIfTouchedOrderRequestTriggerCondition]): Specification of which price
