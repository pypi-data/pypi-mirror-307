...
from .stop_loss_order_request_time_in_force import (
...
from .stop_loss_order_request_type import check_stop_loss_order_request_type
...
class StopLossOrderRequest:
    ...
    price and distance fields may be specified.
        ...
        Attributes:
            type (Optional[StopLossOrderRequestType]): The type of the Order to Create. Must be set to "STOP_LOSS" when
            ...
            distance (Optional[str]): Specifies the distance (in price units) from the Account's current price to use as
                ...
                is used.
            time_in_force (Optional[StopLossOrderRequestTimeInForce]): The time-in-force requested for the StopLoss
            ...
            gtd_time (Optional[str]): The date/time when the StopLoss Order will be cancelled if its timeInForce is
                "GTD".
            trigger_condition (Optional[StopLossOrderRequestTriggerCondition]): Specification of which price component
    ...
    type: Optional[StopLossOrderRequestType]
    trade_id: Optional[str]
    client_trade_id: Optional[str]
    price: Optional[str]
    distance: Optional[str]
    time_in_force: Optional[StopLossOrderRequestTimeInForce]
    gtd_time: Optional[str]
    trigger_condition: Optional[StopLossOrderRequestTriggerCondition]
