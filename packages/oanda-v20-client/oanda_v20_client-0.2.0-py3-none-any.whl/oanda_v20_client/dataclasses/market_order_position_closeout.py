...
class MarketOrderPositionCloseout:
    ...
    specific Position.
        ...
        Attributes:
            instrument (Optional[str]): The instrument of the Position being closed out.
            units (Optional[str]): Indication of how much of the Position to close. Either "ALL", or a DecimalNumber
