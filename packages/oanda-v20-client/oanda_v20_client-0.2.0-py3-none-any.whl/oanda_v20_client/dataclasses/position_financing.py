...
class PositionFinancing:
    ...
    Attributes:
        instrument (Optional[str]): The instrument of the Position that financing is being paid/collected for.
        financing (Optional[str]): The amount of financing paid/collected for the Position.
        open_trade_financings (Optional[List['OpenTradeFinancing']]): The financing paid/collecte for each open
