...
class ClientConfigureRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[ClientConfigureRejectTransactionType]): The Type of the Transaction. Always set to
            "CLIENT_CONFIGURE_REJECT" in a ClientConfigureRejectTransaction.
        alias (Optional[str]): The client-provided alias for the Account.
        margin_rate (Optional[str]): The margin rate override for the Account.
        reject_reason (Optional[ClientConfigureRejectTransactionRejectReason]): The reason that the Reject
