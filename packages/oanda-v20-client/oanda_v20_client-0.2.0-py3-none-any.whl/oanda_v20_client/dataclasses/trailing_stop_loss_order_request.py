...
class TrailingStopLossOrderRequest:
    ...
    Attributes:
        type (Optional[TrailingStopLossOrderRequestType]): The type of the Order to Create. Must be set to
        ...
        time_in_force (Optional[TrailingStopLossOrderRequestTimeInForce]): The time-in-force requested for the
        ...
        gtd_time (Optional[str]): The date/time when the StopLoss Order will be cancelled if its timeInForce is
            "GTD".
        trigger_condition (Optional[TrailingStopLossOrderRequestTriggerCondition]): Specification of which price
