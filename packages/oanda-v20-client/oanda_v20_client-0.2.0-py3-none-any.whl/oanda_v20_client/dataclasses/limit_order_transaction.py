...
from .limit_order_transaction_type import check_limit_order_transaction_type
...
class LimitOrderTransaction:
    ...
    Attributes:
        ...
        type (Optional[LimitOrderTransactionType]): The Type of the Transaction. Always set to "LIMIT_ORDER" in a
        ...
        time_in_force (Optional[LimitOrderTransactionTimeInForce]): The time-in-force requested for the Limit Order.
        gtd_time (Optional[str]): The date/time when the Limit Order will be cancelled if its timeInForce is "GTD".
        position_fill (Optional[LimitOrderTransactionPositionFill]): Specification of how Positions in the Account
            are modified when the Order is filled.
        trigger_condition (Optional[LimitOrderTransactionTriggerCondition]): Specification of which price component
        ...
        reason (Optional[LimitOrderTransactionReason]): The reason that the Limit Order was initiated
