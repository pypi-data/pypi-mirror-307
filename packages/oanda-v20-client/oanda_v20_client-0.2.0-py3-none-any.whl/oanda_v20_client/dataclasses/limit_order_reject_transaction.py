...
from .limit_order_reject_transaction_reason import (
...
from .limit_order_reject_transaction_type import (
...
class LimitOrderRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[LimitOrderRejectTransactionType]): The Type of the Transaction. Always set to
        ...
        time_in_force (Optional[LimitOrderRejectTransactionTimeInForce]): The time-in-force requested for the Limit
            Order.
        gtd_time (Optional[str]): The date/time when the Limit Order will be cancelled if its timeInForce is "GTD".
        position_fill (Optional[LimitOrderRejectTransactionPositionFill]): Specification of how Positions in the
            Account are modified when the Order is filled.
        trigger_condition (Optional[LimitOrderRejectTransactionTriggerCondition]): Specification of which price
        ...
        reason (Optional[LimitOrderRejectTransactionReason]): The reason that the Limit Order was initiated
        ...
        reject_reason (Optional[LimitOrderRejectTransactionRejectReason]): The reason that the Reject Transaction
            was created"""
    ...
    type: Optional[LimitOrderRejectTransactionType]
    instrument: Optional[str]
    units: Optional[str]
    price: Optional[str]
    time_in_force: Optional[LimitOrderRejectTransactionTimeInForce]
    gtd_time: Optional[str]
    position_fill: Optional[LimitOrderRejectTransactionPositionFill]
    trigger_condition: Optional[LimitOrderRejectTransactionTriggerCondition]
    reason: Optional[LimitOrderRejectTransactionReason]
    ...
    reject_reason: Optional[LimitOrderRejectTransactionRejectReason]
