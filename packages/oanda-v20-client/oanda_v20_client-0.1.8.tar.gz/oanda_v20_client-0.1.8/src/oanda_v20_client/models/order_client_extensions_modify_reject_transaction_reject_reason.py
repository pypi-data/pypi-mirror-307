...
OrderClientExtensionsModifyRejectTransactionRejectReason = Literal[
...
ORDER_CLIENT_EXTENSIONS_MODIFY_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_order_client_extensions_modify_reject_transaction_reject_reason(
    value: str,
) -> OrderClientExtensionsModifyRejectTransactionRejectReason:
    if value in ORDER_CLIENT_EXTENSIONS_MODIFY_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(OrderClientExtensionsModifyRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {ORDER_CLIENT_EXTENSIONS_MODIFY_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
