...
from .stop_order_transaction_position_fill import (
    check_stop_order_transaction_position_fill,
)
from .stop_order_transaction_reason import StopOrderTransactionReason
from .stop_order_transaction_reason import check_stop_order_transaction_reason
from .stop_order_transaction_time_in_force import StopOrderTransactionTimeInForce
from .stop_order_transaction_time_in_force import (
    check_stop_order_transaction_time_in_force,
)
from .stop_order_transaction_trigger_condition import (
    StopOrderTransactionTriggerCondition,
)
from .stop_order_transaction_trigger_condition import (
    check_stop_order_transaction_trigger_condition,
)
from .stop_order_transaction_type import StopOrderTransactionType
from .stop_order_transaction_type import check_stop_order_transaction_type
...
class StopOrderTransaction:
    ...
    Attributes:
        ...
        type (Optional[StopOrderTransactionType]): The Type of the Transaction. Always set to "STOP_ORDER" in a
        ...
        price_bound (Optional[str]): The worst market price that may be used to fill this Stop Order. If the market
            ...
            filled.
        time_in_force (Optional[StopOrderTransactionTimeInForce]): The time-in-force requested for the Stop Order.
        gtd_time (Optional[str]): The date/time when the Stop Order will be cancelled if its timeInForce is "GTD".
        position_fill (Optional[StopOrderTransactionPositionFill]): Specification of how Positions in the Account
            are modified when the Order is filled.
        trigger_condition (Optional[StopOrderTransactionTriggerCondition]): Specification of which price component
        ...
        reason (Optional[StopOrderTransactionReason]): The reason that the Stop Order was initiated
        ...
        trade_client_extensions (Optional[ClientExtensions]): A ClientExtensions object allows a client to attach a
            clientID, tag and comment to Orders and Trades in their Account.  Do not set, modify, or delete this field if
            your account is associated with MT4.
        replaces_order_id (Optional[str]): The ID of the Order that this Order replaces (only provided if this Order
            replaces an existing Order).
        cancelling_transaction_id (Optional[str]): The ID of the Transaction that cancels the replaced Order (only
    ...
    type: Optional[StopOrderTransactionType]
    instrument: Optional[str]
    units: Optional[str]
    price: Optional[str]
    price_bound: Optional[str]
    time_in_force: Optional[StopOrderTransactionTimeInForce]
    gtd_time: Optional[str]
    position_fill: Optional[StopOrderTransactionPositionFill]
    trigger_condition: Optional[StopOrderTransactionTriggerCondition]
    reason: Optional[StopOrderTransactionReason]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _type is None:
            ...
            type = check_stop_order_transaction_type(_type)
        ...
        if _time_in_force is None:
            ...
            time_in_force = check_stop_order_transaction_time_in_force(_time_in_force)
        ...
        if _position_fill is None:
            ...
            position_fill = check_stop_order_transaction_position_fill(_position_fill)
        _trigger_condition = d.pop("triggerCondition", None)
        trigger_condition: Optional[StopOrderTransactionTriggerCondition]
        if _trigger_condition is None:
            trigger_condition = None
        else:
            trigger_condition = check_stop_order_transaction_trigger_condition(
                _trigger_condition
            )
        ...
        if _reason is None:
            ...
            reason = check_stop_order_transaction_reason(_reason)
