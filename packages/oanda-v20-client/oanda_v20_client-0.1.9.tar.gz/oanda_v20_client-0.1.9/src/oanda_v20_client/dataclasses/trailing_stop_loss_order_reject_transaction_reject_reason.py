...
TrailingStopLossOrderRejectTransactionRejectReason = Literal[
...
TRAILING_STOP_LOSS_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_trailing_stop_loss_order_reject_transaction_reject_reason(
    value: str,
) -> TrailingStopLossOrderRejectTransactionRejectReason:
    if value in TRAILING_STOP_LOSS_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(TrailingStopLossOrderRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {TRAILING_STOP_LOSS_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
