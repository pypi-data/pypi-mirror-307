...
class TrailingStopLossOrderRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[TrailingStopLossOrderRejectTransactionType]): The Type of the Transaction. Always set to
        ...
        time_in_force (Optional[TrailingStopLossOrderRejectTransactionTimeInForce]): The time-in-force requested for
        ...
        gtd_time (Optional[str]): The date/time when the StopLoss Order will be cancelled if its timeInForce is
            "GTD".
        trigger_condition (Optional[TrailingStopLossOrderRejectTransactionTriggerCondition]): Specification of which
        ...
        reason (Optional[TrailingStopLossOrderRejectTransactionReason]): The reason that the Trailing Stop Loss
            Order was initiated
        ...
        reject_reason (Optional[TrailingStopLossOrderRejectTransactionRejectReason]): The reason that the Reject
