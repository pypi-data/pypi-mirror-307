...
class StopOrderRequest:
    ...
    Attributes:
        type (Optional[StopOrderRequestType]): The type of the Order to Create. Must be set to "STOP" when creating
            a Stop Order.
        ...
        price_bound (Optional[str]): The worst market price that may be used to fill this Stop Order. If the market
            ...
            filled.
        time_in_force (Optional[StopOrderRequestTimeInForce]): The time-in-force requested for the Stop Order.
        gtd_time (Optional[str]): The date/time when the Stop Order will be cancelled if its timeInForce is "GTD".
        position_fill (Optional[StopOrderRequestPositionFill]): Specification of how Positions in the Account are
            modified when the Order is filled.
        trigger_condition (Optional[StopOrderRequestTriggerCondition]): Specification of which price component
