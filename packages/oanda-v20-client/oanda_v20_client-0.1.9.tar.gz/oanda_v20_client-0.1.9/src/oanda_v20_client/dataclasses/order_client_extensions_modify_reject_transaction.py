...
class OrderClientExtensionsModifyRejectTransaction:
    ...
    Extensions.
        ...
        Attributes:
            ...
            type (Optional[OrderClientExtensionsModifyRejectTransactionType]): The Type of the Transaction. Always set
            ...
            reject_reason (Optional[OrderClientExtensionsModifyRejectTransactionRejectReason]): The reason that the
