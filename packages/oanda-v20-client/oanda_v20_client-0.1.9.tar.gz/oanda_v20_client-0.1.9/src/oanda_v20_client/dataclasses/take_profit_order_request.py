...
class TakeProfitOrderRequest:
    ...
    price and distance fields may be specified.
        ...
        Attributes:
            type (Optional[TakeProfitOrderRequestType]): The type of the Order to Create. Must be set to "TAKE_PROFIT"
            ...
            time_in_force (Optional[TakeProfitOrderRequestTimeInForce]): The time-in-force requested for the TakeProfit
            ...
            gtd_time (Optional[str]): The date/time when the TakeProfit Order will be cancelled if its timeInForce is
                "GTD".
            trigger_condition (Optional[TakeProfitOrderRequestTriggerCondition]): Specification of which price component
