...
from ...models.set_trade_dependent_orders_response_200 import (
    SetTradeDependentOrdersResponse200,
)
from ...models.set_trade_dependent_orders_response_400 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": "/accounts/{account_id}/trades/{trade_specifier}/orders".format(
