...
TransferFundsRejectTransactionRejectReason = Literal[
...
TRANSFER_FUNDS_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_transfer_funds_reject_transaction_reject_reason(
    value: str,
) -> TransferFundsRejectTransactionRejectReason:
    if value in TRANSFER_FUNDS_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(TransferFundsRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {TRANSFER_FUNDS_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
