...
class LimitOrder:
    ...
    or better than the threshold.
        ...
        Attributes:
            ...
            state (Optional[LimitOrderState]): The current state of the Order.
            ...
            type (Optional[LimitOrderType]): The type of the Order. Always set to "LIMIT" for Limit Orders.
            ...
            time_in_force (Optional[LimitOrderTimeInForce]): The time-in-force requested for the Limit Order.
            gtd_time (Optional[str]): The date/time when the Limit Order will be cancelled if its timeInForce is "GTD".
            position_fill (Optional[LimitOrderPositionFill]): Specification of how Positions in the Account are modified
                when the Order is filled.
            trigger_condition (Optional[LimitOrderTriggerCondition]): Specification of which price component should be
