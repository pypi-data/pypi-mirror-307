...
class MarketIfTouchedOrder:
    ...
    that is touches or crosses the threshold.
        ...
        Attributes:
            ...
            state (Optional[MarketIfTouchedOrderState]): The current state of the Order.
            ...
            type (Optional[MarketIfTouchedOrderType]): The type of the Order. Always set to "MARKET_IF_TOUCHED" for
            ...
            time_in_force (Optional[MarketIfTouchedOrderTimeInForce]): The time-in-force requested for the
            ...
            gtd_time (Optional[str]): The date/time when the MarketIfTouched Order will be cancelled if its timeInForce
                is "GTD".
            position_fill (Optional[MarketIfTouchedOrderPositionFill]): Specification of how Positions in the Account
                are modified when the Order is filled.
            trigger_condition (Optional[MarketIfTouchedOrderTriggerCondition]): Specification of which price component
            ...
            initial_market_price (Optional[str]): The Market price at the time when the MarketIfTouched Order was
                created.
