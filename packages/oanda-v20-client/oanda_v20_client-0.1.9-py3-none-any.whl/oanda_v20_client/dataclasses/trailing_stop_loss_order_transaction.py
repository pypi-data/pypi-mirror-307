...
class TrailingStopLossOrderTransaction:
    ...
    Attributes:
        ...
        type (Optional[TrailingStopLossOrderTransactionType]): The Type of the Transaction. Always set to
        ...
        client_trade_id (Optional[str]): The client ID of the Trade to be closed when the price threshold is
            breached.
        distance (Optional[str]): The price distance (in price units) specified for the TrailingStopLoss Order.
        time_in_force (Optional[TrailingStopLossOrderTransactionTimeInForce]): The time-in-force requested for the
        ...
        gtd_time (Optional[str]): The date/time when the StopLoss Order will be cancelled if its timeInForce is
            "GTD".
        trigger_condition (Optional[TrailingStopLossOrderTransactionTriggerCondition]): Specification of which price
        ...
        reason (Optional[TrailingStopLossOrderTransactionReason]): The reason that the Trailing Stop Loss Order was
            initiated
