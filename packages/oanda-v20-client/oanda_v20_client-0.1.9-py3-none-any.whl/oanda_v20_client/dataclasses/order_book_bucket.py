...
class OrderBookBucket:
    ...
    Attributes:
        ...
        long_count_percent (Optional[str]): The percentage of the total number of orders represented by the long
            orders found in this bucket.
        short_count_percent (Optional[str]): The percentage of the total number of orders represented by the short
            orders found in this bucket."""
