...
class StopOrderRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[StopOrderRejectTransactionType]): The Type of the Transaction. Always set to
        ...
        price_bound (Optional[str]): The worst market price that may be used to fill this Stop Order. If the market
            ...
            filled.
        time_in_force (Optional[StopOrderRejectTransactionTimeInForce]): The time-in-force requested for the Stop
            Order.
        gtd_time (Optional[str]): The date/time when the Stop Order will be cancelled if its timeInForce is "GTD".
        position_fill (Optional[StopOrderRejectTransactionPositionFill]): Specification of how Positions in the
            Account are modified when the Order is filled.
        trigger_condition (Optional[StopOrderRejectTransactionTriggerCondition]): Specification of which price
        ...
        reason (Optional[StopOrderRejectTransactionReason]): The reason that the Stop Order was initiated
        ...
        reject_reason (Optional[StopOrderRejectTransactionRejectReason]): The reason that the Reject Transaction was
            created"""
