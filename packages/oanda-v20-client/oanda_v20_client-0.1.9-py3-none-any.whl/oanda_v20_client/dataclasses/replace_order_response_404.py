...
class ReplaceOrderResponse404:
    """Attributes:
    order_cancel_reject_transaction (Optional[Transaction]): The base Transaction specification. Specifies
    ...
    order_cancel_reject_transaction: Optional["Transaction"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        order_cancel_reject_transaction: Optional[Transaction]
        if _order_cancel_reject_transaction is None:
            order_cancel_reject_transaction = None
        else:
            order_cancel_reject_transaction = Transaction.from_dict(
