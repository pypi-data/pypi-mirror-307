...
from .stop_loss_order_transaction_reason import check_stop_loss_order_transaction_reason
from .stop_loss_order_transaction_time_in_force import (
    StopLossOrderTransactionTimeInForce,
)
from .stop_loss_order_transaction_time_in_force import (
    check_stop_loss_order_transaction_time_in_force,
)
from .stop_loss_order_transaction_trigger_condition import (
    StopLossOrderTransactionTriggerCondition,
)
from .stop_loss_order_transaction_trigger_condition import (
    check_stop_loss_order_transaction_trigger_condition,
)
from .stop_loss_order_transaction_type import StopLossOrderTransactionType
from .stop_loss_order_transaction_type import check_stop_loss_order_transaction_type
...
class StopLossOrderTransaction:
    ...
    Attributes:
        ...
        type (Optional[StopLossOrderTransactionType]): The Type of the Transaction. Always set to "STOP_LOSS_ORDER"
        ...
        distance (Optional[str]): Specifies the distance (in price units) from the Account's current price to use as
            ...
            is used.
        time_in_force (Optional[StopLossOrderTransactionTimeInForce]): The time-in-force requested for the StopLoss
        ...
        gtd_time (Optional[str]): The date/time when the StopLoss Order will be cancelled if its timeInForce is
            "GTD".
        trigger_condition (Optional[StopLossOrderTransactionTriggerCondition]): Specification of which price
        ...
        guaranteed_execution_premium (Optional[str]): The fee that will be charged if the Stop Loss Order is
        ...
        reason (Optional[StopLossOrderTransactionReason]): The reason that the Stop Loss Order was initiated
    ...
    type: Optional[StopLossOrderTransactionType]
    trade_id: Optional[str]
    client_trade_id: Optional[str]
    price: Optional[str]
    distance: Optional[str]
    time_in_force: Optional[StopLossOrderTransactionTimeInForce]
    gtd_time: Optional[str]
    trigger_condition: Optional[StopLossOrderTransactionTriggerCondition]
    guaranteed: Optional[bool]
    guaranteed_execution_premium: Optional[str]
    reason: Optional[StopLossOrderTransactionReason]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _type is None:
            ...
            type = check_stop_loss_order_transaction_type(_type)
        ...
        if _time_in_force is None:
            ...
            time_in_force = check_stop_loss_order_transaction_time_in_force(
                _time_in_force
            )
        ...
        if _trigger_condition is None:
            ...
            trigger_condition = check_stop_loss_order_transaction_trigger_condition(
                _trigger_condition
            )
        ...
        if _reason is None:
            ...
            reason = check_stop_loss_order_transaction_reason(_reason)
