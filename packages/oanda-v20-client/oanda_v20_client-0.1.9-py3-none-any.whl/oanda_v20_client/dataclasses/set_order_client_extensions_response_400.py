...
class SetOrderClientExtensionsResponse400:
    """Attributes:
    order_client_extensions_modify_reject_transaction (Optional[OrderClientExtensionsModifyRejectTransaction]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _order_client_extensions_modify_reject_transaction is None:
