...
class CalculatedPositionState:
    ...
    Attributes:
        ...
        net_unrealized_pl (Optional[str]): The Position's net unrealized profit/loss
        long_unrealized_pl (Optional[str]): The unrealized profit/loss of the Position's long open Trades
        short_unrealized_pl (Optional[str]): The unrealized profit/loss of the Position's short open Trades
