...
class TransferFundsRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[TransferFundsRejectTransactionType]): The Type of the Transaction. Always set to
        ...
        funding_reason (Optional[TransferFundsRejectTransactionFundingReason]): The reason that an Account is being
            funded.
        comment (Optional[str]): An optional comment that may be attached to a fund transfer for audit purposes
        reject_reason (Optional[TransferFundsRejectTransactionRejectReason]): The reason that the Reject Transaction
            was created"""
