...
class TakeProfitOrderRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[TakeProfitOrderRejectTransactionType]): The Type of the Transaction. Always set to
        ...
        client_trade_id (Optional[str]): The client ID of the Trade to be closed when the price threshold is
            breached.
        price (Optional[str]): The price threshold specified for the TakeProfit Order. The associated Trade will be
            closed by a market price that is equal to or better than this threshold.
        time_in_force (Optional[TakeProfitOrderRejectTransactionTimeInForce]): The time-in-force requested for the
            TakeProfit Order. Restricted to "GTC", "GFD" and "GTD" for TakeProfit Orders.
        gtd_time (Optional[str]): The date/time when the TakeProfit Order will be cancelled if its timeInForce is
            "GTD".
        trigger_condition (Optional[TakeProfitOrderRejectTransactionTriggerCondition]): Specification of which price
        ...
        reason (Optional[TakeProfitOrderRejectTransactionReason]): The reason that the Take Profit Order was
            initiated
        ...
        reject_reason (Optional[TakeProfitOrderRejectTransactionRejectReason]): The reason that the Reject
    ...
    type: Optional[TakeProfitOrderRejectTransactionType]
    trade_id: Optional[str]
    client_trade_id: Optional[str]
    price: Optional[str]
    time_in_force: Optional[TakeProfitOrderRejectTransactionTimeInForce]
    gtd_time: Optional[str]
    trigger_condition: Optional[TakeProfitOrderRejectTransactionTriggerCondition]
    reason: Optional[TakeProfitOrderRejectTransactionReason]
    client_extensions: Optional["ClientExtensions"]
    order_fill_transaction_id: Optional[str]
    intended_replaces_order_id: Optional[str]
    reject_reason: Optional[TakeProfitOrderRejectTransactionRejectReason]
