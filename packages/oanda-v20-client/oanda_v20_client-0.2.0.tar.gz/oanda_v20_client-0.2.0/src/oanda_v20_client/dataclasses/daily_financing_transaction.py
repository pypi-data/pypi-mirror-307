...
class DailyFinancingTransaction:
    ...
    Attributes:
        ...
        type (Optional[DailyFinancingTransactionType]): The Type of the Transaction. Always set to "DAILY_FINANCING"
            for a DailyFinancingTransaction.
        financing (Optional[str]): The amount of financing paid/collected for the Account.
        account_balance (Optional[str]): The Account's balance after daily financing.
        account_financing_mode (Optional[DailyFinancingTransactionAccountFinancingMode]): The account financing mode
            at the time of the daily financing.
        position_financings (Optional[List['PositionFinancing']]): The financing paid/collected for each Position in
            the Account."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        account_financing_mode: Optional[DailyFinancingTransactionAccountFinancingMode]
        if _account_financing_mode is None:
