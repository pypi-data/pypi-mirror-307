...
from .margin_call_enter_transaction_type import check_margin_call_enter_transaction_type
...
class MarginCallEnterTransaction:
    ...
    Attributes:
        ...
        type (Optional[MarginCallEnterTransactionType]): The Type of the Transaction. Always set to
    ...
    type: Optional[MarginCallEnterTransactionType]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _type is None:
            ...
            type = check_margin_call_enter_transaction_type(_type)
