...
class MarketIfTouchedOrderTransaction:
    ...
    Attributes:
        ...
        type (Optional[MarketIfTouchedOrderTransactionType]): The Type of the Transaction. Always set to
            "MARKET_IF_TOUCHED_ORDER" in a MarketIfTouchedOrderTransaction.
        instrument (Optional[str]): The MarketIfTouched Order's Instrument.
        units (Optional[str]): The quantity requested to be filled by the MarketIfTouched Order. A posititive number
            of units results in a long Order, and a negative number of units results in a short Order.
        price (Optional[str]): The price threshold specified for the MarketIfTouched Order. The MarketIfTouched
        ...
        price_bound (Optional[str]): The worst market price that may be used to fill this MarketIfTouched Order.
        time_in_force (Optional[MarketIfTouchedOrderTransactionTimeInForce]): The time-in-force requested for the
            MarketIfTouched Order. Restricted to "GTC", "GFD" and "GTD" for MarketIfTouched Orders.
        gtd_time (Optional[str]): The date/time when the MarketIfTouched Order will be cancelled if its timeInForce
            is "GTD".
        position_fill (Optional[MarketIfTouchedOrderTransactionPositionFill]): Specification of how Positions in the
            Account are modified when the Order is filled.
        trigger_condition (Optional[MarketIfTouchedOrderTransactionTriggerCondition]): Specification of which price
        ...
        reason (Optional[MarketIfTouchedOrderTransactionReason]): The reason that the Market-if-touched Order was
            initiated
