...
from .market_order_reject_transaction_reason import (
...
from .market_order_reject_transaction_type import (
...
class MarketOrderRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[MarketOrderRejectTransactionType]): The Type of the Transaction. Always set to
            "MARKET_ORDER_REJECT" in a MarketOrderRejectTransaction.
        instrument (Optional[str]): The Market Order's Instrument.
        units (Optional[str]): The quantity requested to be filled by the Market Order. A posititive number of units
            results in a long Order, and a negative number of units results in a short Order.
        time_in_force (Optional[MarketOrderRejectTransactionTimeInForce]): The time-in-force requested for the
            Market Order. Restricted to FOK or IOC for a MarketOrder.
        price_bound (Optional[str]): The worst price that the client is willing to have the Market Order filled at.
        position_fill (Optional[MarketOrderRejectTransactionPositionFill]): Specification of how Positions in the
            Account are modified when the Order is filled.
        trade_close (Optional[MarketOrderTradeClose]): A MarketOrderTradeClose specifies the extensions to a Market
            Order that has been created specifically to close a Trade.
        long_position_closeout (Optional[MarketOrderPositionCloseout]): A MarketOrderPositionCloseout specifies the
            extensions to a Market Order when it has been created to closeout a specific Position.
        short_position_closeout (Optional[MarketOrderPositionCloseout]): A MarketOrderPositionCloseout specifies the
            extensions to a Market Order when it has been created to closeout a specific Position.
        margin_closeout (Optional[MarketOrderMarginCloseout]): Details for the Market Order extensions specific to a
            Market Order placed that is part of a Market Order Margin Closeout in a client's account
        delayed_trade_close (Optional[MarketOrderDelayedTradeClose]): Details for the Market Order extensions
        ...
        reason (Optional[MarketOrderRejectTransactionReason]): The reason that the Market Order was created
        ...
        trade_client_extensions (Optional[ClientExtensions]): A ClientExtensions object allows a client to attach a
            clientID, tag and comment to Orders and Trades in their Account.  Do not set, modify, or delete this field if
            your account is associated with MT4.
        reject_reason (Optional[MarketOrderRejectTransactionRejectReason]): The reason that the Reject Transaction
            was created"""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        short_position_closeout: Optional[MarketOrderPositionCloseout]
        if _short_position_closeout is None:
        ...
        delayed_trade_close: Optional[MarketOrderDelayedTradeClose]
        if _delayed_trade_close is None:
