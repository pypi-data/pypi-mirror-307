...
class InstrumentCommission:
    ...
    Attributes:
        commission (Optional[str]): The commission amount (in the Account's home currency) charged per unitsTraded
            of the instrument
        units_traded (Optional[str]): The number of units traded that the commission amount is based on.
        minimum_commission (Optional[str]): The minimum commission amount (in the Account's home currency) that is
