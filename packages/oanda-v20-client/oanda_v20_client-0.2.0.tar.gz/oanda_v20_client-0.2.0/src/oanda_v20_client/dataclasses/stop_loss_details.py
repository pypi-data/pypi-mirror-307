...
class StopLossDetails:
    ...
    directly through the Trade.
        ...
        Attributes:
            price (Optional[str]): The price that the Stop Loss Order will be triggered at. Only one of the price and
                distance fields may be specified.
            distance (Optional[str]): Specifies the distance (in price units) from the Trade's open price to use as the
                Stop Loss Order price. Only one of the distance and price fields may be specified.
            time_in_force (Optional[StopLossDetailsTimeInForce]): The time in force for the created Stop Loss Order.
                This may only be GTC, GTD or GFD.
            gtd_time (Optional[str]): The date when the Stop Loss Order will be cancelled on if timeInForce is GTD.
            ...
            guaranteed (Optional[bool]): Flag indicating that the price for the Stop Loss Order is guaranteed. The
