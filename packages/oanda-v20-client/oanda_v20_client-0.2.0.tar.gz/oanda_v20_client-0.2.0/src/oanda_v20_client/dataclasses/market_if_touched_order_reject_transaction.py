...
class MarketIfTouchedOrderRejectTransaction:
    ...
    Attributes:
        ...
        type (Optional[MarketIfTouchedOrderRejectTransactionType]): The Type of the Transaction. Always set to
        ...
        time_in_force (Optional[MarketIfTouchedOrderRejectTransactionTimeInForce]): The time-in-force requested for
        ...
        gtd_time (Optional[str]): The date/time when the MarketIfTouched Order will be cancelled if its timeInForce
            is "GTD".
        position_fill (Optional[MarketIfTouchedOrderRejectTransactionPositionFill]): Specification of how Positions
            in the Account are modified when the Order is filled.
        trigger_condition (Optional[MarketIfTouchedOrderRejectTransactionTriggerCondition]): Specification of which
        ...
        reason (Optional[MarketIfTouchedOrderRejectTransactionReason]): The reason that the Market-if-touched Order
            was initiated
        ...
        reject_reason (Optional[MarketIfTouchedOrderRejectTransactionRejectReason]): The reason that the Reject
