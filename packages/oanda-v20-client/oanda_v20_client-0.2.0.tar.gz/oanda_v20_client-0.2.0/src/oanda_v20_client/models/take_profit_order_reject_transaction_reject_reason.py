...
TakeProfitOrderRejectTransactionRejectReason = Literal[
...
TAKE_PROFIT_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES: Set[
...
def check_take_profit_order_reject_transaction_reject_reason(
    value: str,
) -> TakeProfitOrderRejectTransactionRejectReason:
    if value in TAKE_PROFIT_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES:
        return cast(TakeProfitOrderRejectTransactionRejectReason, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {TAKE_PROFIT_ORDER_REJECT_TRANSACTION_REJECT_REASON_VALUES!r}"
    )
