...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        move_image = action(get_str("moveImage"), self.move_image_to_active_dir,
                            "Ctrl+m")
        ...
        self.actions.beginner = (
            open_dir, move_image, open_next_image, open_prev_image, verify, save, save_format, None, create, copy,
            delete, None,
    ...
    def move_image_to_active_dir(self):
        ...
        self.update_file_menu()
        self.import_dir_images(self.cur_active_dir, maintain_current=current_image)
    ...
    def save_labels(self, ann_file_path):
        ...
        try:
            ...
            if self.label_file_format == LabelFileFormat.PASCAL_VOC:
                ...
                self.label_file.save_pascal_voc_format(ann_file_path.as_posix(), shapes, self.file_path.as_posix(),
                                                       self.image_data,
                ...
                self.label_file.save_yolo_format(ann_file_path.as_posix(), shapes, self.file_path.as_posix(),
                                                 self.image_data,
                                                 self.label_hist,
                                                 self.line_color.getRgb(), self.fill_color.getRgb())
            elif self.label_file_format == LabelFileFormat.CREATE_ML:
                ...
                self.label_file.save_create_ml_format(ann_file_path.as_posix(), shapes, self.file_path.as_posix(),
                                                      self.image_data,
