...
def decode_rows(row_number: int | None=None) -> Decoder_1[FsCell]:
    def _arrow278(builder: IGetters, row_number: Any=row_number) -> FsCell:
    ...
    return object(_arrow278)


def encode_cols(cell: FsCell) -> IEncodable:
    def _arrow280(__unit: None=None, cell: Any=cell) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("row", _arrow280()), ("value", encode(cell.Value))])
