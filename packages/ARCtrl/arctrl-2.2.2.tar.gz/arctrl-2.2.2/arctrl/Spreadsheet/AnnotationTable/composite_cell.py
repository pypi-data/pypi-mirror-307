...
def data_from_string_cells(format: int | None, selector_format: int | None, cell_values: Array[str]) -> CompositeCell:
    def _arrow1185(i: int, format: Any=format, selector_format: Any=selector_format, cell_values: Any=cell_values) -> str:
        return cell_values[i]

    format_1: str | None = map(_arrow1185, format)
    def _arrow1186(i_1: int, format: Any=format, selector_format: Any=selector_format, cell_values: Any=cell_values) -> str:
        return cell_values[i_1]

    selector_format_1: str | None = map(_arrow1186, selector_format)
