...
class ArcAssay(ArcTables):
            ...
            def predicate(s: ArcStudy) -> bool:
                ...
                class ObjectExpr888:
                    ...
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow887(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(this.Identifier, source, ObjectExpr888())
    ...
    def add_table(table: ArcTable, index: int | None=None) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow889(assay: ArcAssay) -> ArcAssay:
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcAssay], tuple[ArcAssay, ArcTable]]:
        def _arrow891(assay: ArcAssay) -> tuple[ArcAssay, ArcTable]:
            c: ArcAssay = assay.Copy()
    ...
    def get_table_at(index: int) -> Callable[[ArcAssay], ArcTable]:
        def _arrow893(assay: ArcAssay) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcAssay], ArcTable]:
        def _arrow894(assay: ArcAssay) -> ArcTable:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow911(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow912(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1, combined, ObjectExpr922()):
                            (combined.append(e_1))
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_2, combined_1, ObjectExpr923()):
                ...
                try: 
                    while enumerator_1_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_1, combined_1, ObjectExpr924()):
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_3, combined_2, ObjectExpr925()):
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr926()):
    ...
    def StructurallyEquals(self, other: ArcAssay) -> bool:
        ...
        def _arrow929(__unit: None=None) -> bool:
            ...
            def _arrow928(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow927(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow927, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow928))) if (length(a) == length(b)) else False
        ...
        def _arrow932(__unit: None=None) -> bool:
            ...
            def _arrow931(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow930(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow930, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow931))) if (length(a_1) == length(b_1)) else False
        ...
        def _arrow936(__unit: None=None) -> bool:
            ...
            def _arrow935(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow934(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow934, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow935))) if (length(a_2) == length(b_2)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.MeasurementType, other.MeasurementType), equals(this.TechnologyType, other.TechnologyType), equals(this.TechnologyPlatform, other.TechnologyPlatform), equals(this.DataMap, other.DataMap), _arrow929(), _arrow932(), _arrow936()]))
