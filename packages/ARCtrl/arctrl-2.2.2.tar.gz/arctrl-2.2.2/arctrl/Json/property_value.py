...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1777(), None)
            ...
            pattern_input_1 = (ObjectExpr1778(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow1780(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow1782(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1780, oa_1.Name), map(_arrow1782, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr1783(), None)
    ...
    def _arrow1787(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1790(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1792(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1794(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1796(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1798(value_17: str, pv: Any=pv) -> IEncodable:
        ...
        return ObjectExpr1797()

    def _arrow1800(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1801(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow1802(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow1804(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1808(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1787()), ("@type", ObjectExpr1788()), ("additionalType", _arrow1790()), try_include("alternateName", _arrow1792, pv.AlternateName()), try_include("measurementMethod", _arrow1794, pv.MeasurementMethod()), try_include("description", _arrow1796, pv.Description()), try_include("category", _arrow1798, pattern_input[0]), try_include("categoryCode", _arrow1800, pattern_input[1]), try_include("value", _arrow1801, pattern_input_1[0]), try_include("valueCode", _arrow1802, pattern_input_1[1]), try_include("unit", _arrow1804, pattern_input_2[0]), try_include("unitCode", _arrow1808, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow1824(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow1823(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow1823(), unit)

    return object(_arrow1824)
