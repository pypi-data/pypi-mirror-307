...
IContext_reflection = _expr1425

def _arrow1451(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1429()), ("Factor", ObjectExpr1431()), ("factorName", ObjectExpr1434()), ("annotationValue", ObjectExpr1437()), ("termSource", ObjectExpr1440()), ("termAccession", ObjectExpr1443()), ("comments", ObjectExpr1445())])
    ...
    return ObjectExpr1450()


context_jsonvalue: IEncodable = _arrow1451()
