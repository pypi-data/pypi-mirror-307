...
def _arrow1447(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1426()), ("Data", ObjectExpr1428()), ("type", ObjectExpr1430()), ("encodingFormat", ObjectExpr1432()), ("usageInfo", ObjectExpr1435()), ("name", ObjectExpr1438()), ("comments", ObjectExpr1441())])
    ...
    return ObjectExpr1446()


context_jsonvalue: IEncodable = _arrow1447()
