...
def _arrow1527(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1518()), ("bio", ObjectExpr1521()), ("Material", ObjectExpr1522()), ("type", ObjectExpr1523()), ("name", ObjectExpr1524()), ("characteristics", ObjectExpr1525())])
