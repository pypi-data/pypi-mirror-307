...
def _arrow2388(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2389(Item_1: Data) -> ProcessOutput:
...
ROCrate_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2388, ROCrate_decoder_1), map(_arrow2389, ROCrate_decoder_2), map(_arrow2390, ROCrate_decoder_3)]))
...
def _arrow2392(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)
...
ISAJson_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2392, ISAJson_decoder_1), map(_arrow2393, ISAJson_decoder_2), map(_arrow2394, ISAJson_decoder_3)]))
