...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> IEncodable:
    ...
    def _arrow2417(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2419(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2420(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(value_6)

    def _arrow2421(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(value_7)

    def _arrow2422(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2412()), ("@type", list_1_1(singleton(ObjectExpr2413()))), try_include("name", _arrow2415, oa.Name), try_include("executesProtocol", _arrow2416, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ROCrate_encoder_2, oa.ParameterValues), try_include("performer", _arrow2417, oa.Performer), try_include("date", _arrow2419, oa.Date), try_include_list_opt("inputs", _arrow2420, oa.Inputs), try_include_list_opt("outputs", _arrow2421, oa.Outputs), try_include_list_opt("comments", _arrow2422, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2433(get: IGetters) -> Process:
    ...
    def _arrow2426(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2427(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow2429(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("date", string)

    def _arrow2430(__unit: None=None) -> FSharpList[ProcessInput] | None:
        arg_13: Decoder_1[FSharpList[ProcessInput]] = list_1_2(ROCrate_decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("inputs", arg_13)

    def _arrow2431(__unit: None=None) -> FSharpList[ProcessOutput] | None:
        arg_15: Decoder_1[FSharpList[ProcessOutput]] = list_1_2(ROCrate_decoder_4)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("outputs", arg_15)

    def _arrow2432(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_5)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow2424(), _arrow2425(), _arrow2426(), _arrow2427(), _arrow2428(), _arrow2429(), None, None, _arrow2430(), _arrow2431(), _arrow2432())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2433)
