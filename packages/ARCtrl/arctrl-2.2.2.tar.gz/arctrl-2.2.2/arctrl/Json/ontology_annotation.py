...
def OntologyAnnotation_ROCrate_encoderPropertyValue(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1810(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = OntologyAnnotation_ROCrate_genID(oa)
    ...
    def _arrow1814(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1816(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1817(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1810()), ("@type", ObjectExpr1812()), try_include("category", _arrow1814, oa.Name), try_include("categoryCode", _arrow1816, oa.TermAccessionNumber), try_include_seq("comments", _arrow1817, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow1822(get: IGetters) -> OntologyAnnotation:
    ...
    return OntologyAnnotation.create(_arrow1819(), None, _arrow1820(), _arrow1821())


OntologyAnnotation_ROCrate_decoderPropertyValue: Decoder_1[OntologyAnnotation] = object(_arrow1822)
...
def OntologyAnnotation_ISAJson_encoder(id_map: Any | None, oa: OntologyAnnotation) -> IEncodable:
    def f(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1828(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1830(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1832(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1834(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1835(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return encoder(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1828, OntologyAnnotation_ROCrate_genID(oa_1)), try_include("annotationValue", _arrow1830, oa_1.Name), try_include("termSource", _arrow1832, oa_1.TermSourceREF), try_include("termAccession", _arrow1834, oa_1.TermAccessionNumber), try_include_seq("comments", _arrow1835, comments)]))
    ...
    if id_map is not None:
        def _arrow1837(o: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> str:
            return OntologyAnnotation_ROCrate_genID(o)

        return encode(_arrow1837, f, oa, id_map)
