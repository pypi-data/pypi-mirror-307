...
class FileSystemTree(Union):
    ...
    def add_file(path: str) -> Callable[[FileSystemTree], FileSystemTree]:
        def _arrow432(tree: FileSystemTree) -> FileSystemTree:
    ...
    def Union(self, other_fst: FileSystemTree) -> FileSystemTree:
        this: FileSystemTree = self
        def _arrow452(__unit: None=None) -> Array[str]:
        ...
        class ObjectExpr454:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow453(x: str, y: str) -> bool:
                    return x == y
        ...
        paths: Array[str] = Array_distinct(_arrow452(), ObjectExpr454())
