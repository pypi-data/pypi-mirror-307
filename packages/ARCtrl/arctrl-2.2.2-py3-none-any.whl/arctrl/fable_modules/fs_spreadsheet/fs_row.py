    ...
    def create_at(index: int, cells: FsCellsCollection) -> FsRow:
        def get_index_by(f: Callable[[Callable[[FsCell], int], IEnumerable_1[FsCell]], FsCell]) -> int:
            if length(FsCellsCollection__GetCellsInRow_Z524259A4(cells, index)) == 0:
                ...
                return FsAddress__get_ColumnNumber(f(_arrow172)(FsCellsCollection__GetCellsInRow_Z524259A4(cells, index)).Address)
        ...
        min_col_index: int = get_index_by(_arrow175) or 0
        ...
        max_col_index: int = get_index_by(_arrow178) or 0
