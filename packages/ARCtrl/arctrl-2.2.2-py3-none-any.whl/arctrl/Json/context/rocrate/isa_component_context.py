...
def _arrow1449(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1421()), ("Component", ObjectExpr1422()), ("category", ObjectExpr1423()), ("categoryCode", ObjectExpr1433()), ("value", ObjectExpr1436()), ("valueCode", ObjectExpr1439()), ("unit", ObjectExpr1442()), ("unitCode", ObjectExpr1444())])
...
context_jsonvalue: IEncodable = _arrow1449()
