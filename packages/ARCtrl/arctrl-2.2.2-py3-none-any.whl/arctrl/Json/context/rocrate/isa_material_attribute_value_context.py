...
def _arrow1520(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1505()), ("MaterialAttributeValue", ObjectExpr1507()), ("additionalType", ObjectExpr1508()), ("category", ObjectExpr1509()), ("categoryCode", ObjectExpr1512()), ("value", ObjectExpr1513()), ("valueCode", ObjectExpr1514()), ("unit", ObjectExpr1515()), ("unitCode", ObjectExpr1517())])
    ...
    return ObjectExpr1519()


context_jsonvalue: IEncodable = _arrow1520()
