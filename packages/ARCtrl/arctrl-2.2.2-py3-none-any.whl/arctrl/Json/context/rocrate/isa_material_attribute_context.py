...
def _arrow1511(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1500()), ("arc", ObjectExpr1501()), ("MaterialAttribute", ObjectExpr1502()), ("ArcMaterialAttribute", ObjectExpr1504()), ("characteristicType", ObjectExpr1506())])
    ...
    return ObjectExpr1510()


context_jsonvalue: IEncodable = _arrow1511()
