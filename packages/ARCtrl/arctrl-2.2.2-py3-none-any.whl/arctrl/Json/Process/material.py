...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2220(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2224(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2225(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2226(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2220()), ("@type", list_1_1(singleton(ObjectExpr2221()))), ("additionalType", ObjectExpr2222()), try_include("name", _arrow2224, oa.Name), try_include("type", _arrow2225, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2226, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2234(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2233(get: IGetters) -> Material:
            ...
            def _arrow2230(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2231(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2232(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2228(), _arrow2229(), _arrow2230(), _arrow2231(), _arrow2232())

        return object(_arrow2233)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2234()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2238(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2240(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2241(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2242(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2238, ROCrate_genID(oa)), try_include("name", _arrow2240, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2241, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2242, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2244(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2244, f, c, id_map)
...
def _arrow2251(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2250(get: IGetters) -> Material:
            ...
            def _arrow2247(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2248(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2249(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2245(), _arrow2246(), _arrow2247(), _arrow2248(), _arrow2249())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2250)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2251()
