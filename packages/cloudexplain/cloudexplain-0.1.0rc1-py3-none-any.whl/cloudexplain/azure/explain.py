...
class ExplainModelContext:
    def __init__(self, model, X, y, model_version=None, model_description=None):
        self.model = model
        self.X = X
        self.y = y
        self.model_version = model_version
        self.model_description = model_description
        self.container_client = get_data_container_client()
...
def explain(model, X, y, model_version: str = None, model_description: str = None):
    ...
    Returns:
        _type_: _description_
    """
    return ExplainModelContext(model, X, y, model_version=model_version, model_description=model_description)
