...
class EasySparkDeltaTable:
    ...
    def merge_from_list(self, keys: list[str], records: list[dict], schema: StructType = None,
        ...
        return self.merge_from_df(keys, df, add_missing_columns, add_missing_columns_to_current, to_keys)
    ...
    def merge_from_tuple(self, keys: list[str], records: list[tuple], schema: StructType = None,
        ...
        return self.merge_from_df(keys, df, add_missing_coloumns, add_missing_columns_to_current, to_keys)
