...
class VisAnnotations:
    ...
    def plot_distribution(self) -> None:
        ...
        fig.update_xaxes(title='Box size', showgrid=False, title_standoff=vw(2), title_font=AxisTitle.font)
    ...
    def plot_counts(self) -> None:
        ...
        fig.update_layout(**self._create_base_layout(width=vw(35), height=vh(33)))
