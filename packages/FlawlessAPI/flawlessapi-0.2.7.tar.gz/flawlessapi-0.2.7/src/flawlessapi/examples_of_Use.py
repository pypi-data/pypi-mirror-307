...
from flawlessapi.task_queue.task_queue import TaskPriority
from flawlessapi.requests import AsyncRequest
from flawlessapi.response import ApiResponse, error_response, success_response
from flawlessapi.router.core import FlawlessAPI
import uvicorn
from flawlessapi.middleware.cors import CORSMiddleware
...
async def get_user(request: AsyncRequest, id: int) -> UserResponse:
    ...
    return await success_response(data=user_data)
...
async def create_user(request: AsyncRequest, user: UserCreate) -> UserResponse:
    ...
    try:
        ...
        return await error_response(message=f"Invalid user data: {str(e)}")
