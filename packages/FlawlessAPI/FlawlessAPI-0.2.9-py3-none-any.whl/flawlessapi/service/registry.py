    ...
    async def register_service(self):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            try:
                ...
                self.logger.error(f"Service registration failed: {traceback.format_exc()}")
    ...
    async def deregister_service(self):
        ...
        async with aiohttp.ClientSession() as session:
            try:
                ...
                self.logger.error(f"Service deregistration failed: {traceback.format_exc()}")
    ...
    async def discover_service(self, service_name: str) -> Optional[str]:
        ...
        async with aiohttp.ClientSession() as session:
            try:
                ...
                self.logger.error(f"Service discovery failed: {traceback.format_exc()}")
                return None
    ...
    async def _heartbeat(self):
        ...
        while True:
            try:
                ...
                self.logger.error(f"Heartbeat error: {traceback.format_exc()}")
