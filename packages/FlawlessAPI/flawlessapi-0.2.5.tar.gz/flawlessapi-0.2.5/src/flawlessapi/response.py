...
class AsyncResponse:
    ...
    async def send_json_response(self, send, status_code: int, body_dict: Dict[str, Any]) -> None:
        ...
        try:
            ...
            await error_response(code=500, message=str(e))
