...
class SingleMarketCreationResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["market", "ref_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"market": Market.from_dict(obj["market"]) if obj.get("market") is not None else None, "ref_id": obj.get("ref_id")})
        return _obj
