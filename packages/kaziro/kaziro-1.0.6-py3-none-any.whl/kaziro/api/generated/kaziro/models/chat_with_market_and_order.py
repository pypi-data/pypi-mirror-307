...
class ChatWithMarketAndOrder(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "content", "date_created", "metadata", "market_id", "order_id", "is_global", "market", "order"]
