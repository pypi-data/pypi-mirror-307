...
class PositionResponse(BaseModel):
    ...
    positions: List[PositionExtended] = Field(description="List of historical or open positions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"positions": [PositionExtended.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None, "page": obj.get("page")})
        return _obj
