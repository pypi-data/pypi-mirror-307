...
def analyse_filaments(
    data: Union[np.ndarray, List, Tuple], image: Union[np.ndarray, List, Tuple] = None, thickness = 1
) -> tuple:
    """
...
def analyse_filaments_list(
    ...
    save_analysis(names_, analyse_filaments(data, images, thickness), px_=px_, save=path)
