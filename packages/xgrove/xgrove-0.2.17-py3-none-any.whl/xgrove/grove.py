    ...
    def calculateGrove(self):
        ...
        for nt in self.ntrees:
            ...
            for nt, grove in enumerate(groves, 1):  # nt ist die Anzahl der Bäume für diese Grove
                ...
                for baum in grove:
                    # Baumspezifische Regeln extrahieren (baum hat dieselbe Struktur wie rules_df)
                    rules = baum  # Baumspezifische Regeln

                    # Bereite temporäre Listen für diesen Baum vor
                    vars_temp = []
                    splits_temp = []
                    csplits_left_temp = []
                    pleft_temp = []
