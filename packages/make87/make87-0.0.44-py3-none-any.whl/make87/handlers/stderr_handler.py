...
from make87.topics import get_publisher_topic, TypedPublisherTopic, resolve_topic_name
...
def setup():
    ...
    try:
        topic = get_publisher_topic(name=resolve_topic_name("STDERR"), message_type=LogMessage)
