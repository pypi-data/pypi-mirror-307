...
def save_timerange_sql_as_universe(
    ...
    """
    Saves a time-ranged SQL query result as a universe. Multiple IDs can be mapped
...
def save_timeseries_sql_as_universe(
    ...
    """
    Saves a time-series SQL query result as a universe. Multiple IDs can be mapped
