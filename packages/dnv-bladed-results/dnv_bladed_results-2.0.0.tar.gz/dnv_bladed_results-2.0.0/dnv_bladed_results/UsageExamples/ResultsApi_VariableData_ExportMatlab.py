...
def run_script():
    ...
    - Exports data for all variables in an output group to a Matlab data file.
    ...
    export_all_variables_in_group(source_run_directory, source_run_name, "Blade 1 Loads: Principal axes", os.path.join(output_directory, "Blade_1_Loads.mat").replace("\\","/"))
