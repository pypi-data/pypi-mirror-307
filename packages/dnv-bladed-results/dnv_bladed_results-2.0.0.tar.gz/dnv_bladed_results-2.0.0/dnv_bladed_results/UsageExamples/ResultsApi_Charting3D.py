...
# This example requires the matplotlib library, available via pip.  It has been tested with matplotlib 3.9.1.
...
def read_bladed_results(variable_name, run_directory, run_name):
    ...
    primary_independent_variable = variable_2d.get_independent_variable(INDEPENDENT_VARIABLE_ID_PRIMARY)
    secondary_independent_variable = variable_2d.get_independent_variable(INDEPENDENT_VARIABLE_ID_SECONDARY)
