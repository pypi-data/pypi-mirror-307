...
def read_bladed_results(variable_name, run_directory, run_name):
    ...
    primary_independent_variable = var_2d.get_independent_variable(INDEPENDENT_VARIABLE_ID_PRIMARY)
    secondary_independent_variable = var_2d.get_independent_variable(INDEPENDENT_VARIABLE_ID_SECONDARY)
