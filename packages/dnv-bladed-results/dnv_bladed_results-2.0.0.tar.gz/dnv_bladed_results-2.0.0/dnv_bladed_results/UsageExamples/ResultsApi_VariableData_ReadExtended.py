...
def run_script():
    ...
    ResultsApi.CacheSettings.data_type_for_reading = DATA_TYPE_SPECIFIER_READ_AS_SERIALISED_TYPE
...
def get_data_for_2d_variable(run_directory, run_name, variable_name):
    ...
    try:
        ...
        if (secondary_independent_variable.get_axis_type() == AXIS_TYPE_LABELLED_STRING):
