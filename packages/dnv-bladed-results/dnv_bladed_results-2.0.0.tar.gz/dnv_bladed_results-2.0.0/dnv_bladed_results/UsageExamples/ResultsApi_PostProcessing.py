...
class DataStructureClass():
    ...
    class VariableClass():
        ...
        def __init__(self, variable: Variable | IndependentVariable):
            ...
            self.siunit = variable.get_siunit()
            self.name = variable.get_name()
            ...
            if (type(variable) == IndependentVariable):
                ...
                if  (variable.get_number_of_independent_variables() == 1):
                    self.values = variable.get_data()
                elif  (variable.get_number_of_independent_variables() == 2):
                    self.values = variable.get_data_for_all_independent_variable_values()
    ...
    def __init__(self, dependent_variable: Variable):
        ...
        # Assert its a ResultsAPI variable type
        if hasattr(dependent_variable, "get_number_of_independent_variables"):
            ...
            if(dependent_variable.get_number_of_independent_variables() == 1):
            ...
            elif(dependent_variable.get_number_of_independent_variables() == 2):

                # Assign independent variable data
                primary_independent_variable = dependent_variable.get_independent_variable(0)
                self.primary_independent_variable = self.VariableClass(primary_independent_variable)
                
                # Assign independent variable data
                secondary_independent_variable = dependent_variable.get_independent_variable(1)
...
def to_console(data: DataStructureClass):
    ...
    print("unit: " + data.dependent_variable.siunit)
    ...
    print("unit: " + data.primary_independent_variable.siunit)
    ...
    if data.dependent_variable.ndim == 2:
        ...
        print("unit: " + data.secondary_independent_variable.siunit)
...
def to_ascii(data: DataStructureClass, file_name: str):
    ...
    with open(file_name + '.txt', 'w') as file:
        ...
        file.write("\n" + data.primary_independent_variable.name + " [" + data.primary_independent_variable.siunit + "]")
        ...
        if data.dependent_variable.ndim == 2:
            file.write(str("\n" + data.secondary_independent_variable.name + " [" + data.secondary_independent_variable.siunit + "]"))
        for primary_independent_variable_value in data.primary_independent_variable.values:
            file.write("\t" + data.dependent_variable.name + " [" + data.dependent_variable.siunit + "]")
...
def to_data_frame(data: DataStructureClass) -> pd.DataFrame:
    ...
    if data.dependent_variable.ndim == 2:
        ...
        data_frame.index.name = data.secondary_independent_variable.name + " [" + data.secondary_independent_variable.siunit + "]"
        data_frame.columns.name = data.primary_independent_variable.name + " [" + data.primary_independent_variable.siunit + "]"
        ...
        data_frame = pd.DataFrame(data.dependent_variable.values, index = data.primary_independent_variable.values,\
                                   columns = [data.dependent_variable.name + " [" + data.dependent_variable.siunit + "]"])
        data_frame.index.name = data.primary_independent_variable.name + " [" + data.primary_independent_variable.siunit + "]"
...
def plot_section(data: DataStructureClass, data_frame: pd.DataFrame, section_number: int):
    ...
    ax.set_ylabel(data.dependent_variable.name + " [" + data.dependent_variable.siunit + "]")
