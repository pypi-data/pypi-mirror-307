...
class _ResultsApi_CacheSettings(object):
    ...
    def _set_buffered_read_enabled(buffered_read_enabled):
        r"""
        Determines whether to buffer output group data.
        ...
        return _ResultsAPI_Python._ResultsApi_CacheSettings__PROPERTYPREFIX_set_buffered_read_enabled(buffered_read_enabled)

    @staticmethod
    def _get_buffered_read_enabled():
        r"""
        Indicates whether to buffer output group data.

        Returns
        -------
        bool
            A boolean indicating whether to buffer output group data.
        """
    ...
    def _set_run_caching_enabled(run_caching_enabled):
        ...
        return _ResultsAPI_Python._ResultsApi_CacheSettings__PROPERTYPREFIX_set_run_caching_enabled(run_caching_enabled)
    ...
    def _get_run_caching_enabled():
        ...
        -------
        bool
            A boolean indicating whether to cache requested runs.
        """
    ...
    def _set_data_type_for_reading(data_type_specifier):
        ...
        return _ResultsAPI_Python._ResultsApi_CacheSettings__PROPERTYPREFIX_set_data_type_for_reading(data_type_specifier)
...
class _ResultsApi_SearchSettings(object):
    ...
    def _set_calculation_type_filter(calculation_type_filter):
        ...
        return _ResultsAPI_Python._ResultsApi_SearchSettings__PROPERTYPREFIX_set_calculation_type_filter(calculation_type_filter)
    ...
    def _set_include_unsupported_calculations(include_unsupported_calculations):
        ...
        return _ResultsAPI_Python._ResultsApi_SearchSettings__PROPERTYPREFIX_set_include_unsupported_calculations(include_unsupported_calculations)
    ...
    def _get_include_unsupported_calculations():
        ...
        -------
        bool
            A boolean indicating the unsupported calculation type setting.
        """
    ...
    def _set_completion_state_filter(completion_state_filter):
        ...
        return _ResultsAPI_Python._ResultsApi_SearchSettings__PROPERTYPREFIX_set_completion_state_filter(completion_state_filter)
    ...
    def _set_run_name_case_sensitivity(run_name_case_sensitivity):
        ...
        return _ResultsAPI_Python._ResultsApi_SearchSettings__PROPERTYPREFIX_set_run_name_case_sensitivity(run_name_case_sensitivity)
    ...
    def _set_return_first_variable_match(return_first_variable_match):
        ...
        Notes
        -----
        - Some variable instances are written to more than one output group in the run.
          Enabling this setting avoids the need for the user to pass a disambiguating group name to identify the specific variable instance to return.
        - When disabled, an exception is raised if a disambiguating output group name was not supplied that allowed a duplicated variable to be identified uniquely.
        - Care should be taken when enabling this setting. Some runs, for example rainflow, have output groups containing different variable instances with the same name.
        - Use `Run.get_variable_1d_from_specific_output_group` or `Run.get_variable_2d_from_specific_output_group` to limit the search scope to a specific output group.
        """

        return _ResultsAPI_Python._ResultsApi_SearchSettings__PROPERTYPREFIX_set_return_first_variable_match(return_first_variable_match)
    ...
    def _get_return_first_variable_match():
        ...
        -------
        bool
            A boolean indicating the first variable match setting.
        """
...
class IndependentVariable(object):
    ...
    def _get_siunit(self) -> str:
        ...
        return _ResultsAPI_Python.IndependentVariable__INDEPENDENTVARIABLEPREFIX_get_siunit(self)

    def has_numeric_values(self):
        r"""
        ...
        return _ResultsAPI_Python.IndependentVariable_has_numeric_values(self)
    ...
    # Unit string conversion to UTF-8 to support printing special characters
...
class Variable(object):
    ...
    def _get_siunit(self) -> str:
        ...
        return _ResultsAPI_Python.Variable__VARIABLEPREFIX_get_siunit(self)
...
class OutputGroup(IOutputSpecification):
    ...
    def get_number_of_variables(self):
        ...
        return _ResultsAPI_Python.OutputGroup_get_number_of_variables(self)
    ...
    def _set_tefile_creation_enabled(self, te_file_creation_enabled):
        ...
        return _ResultsAPI_Python.OutputGroup__PROPERTYPREFIX_set_tefile_creation_enabled(self, te_file_creation_enabled)
    ...
    def _set_header_file_stats_enabled(self, header_file_stats_enabled):
        ...
        return _ResultsAPI_Python.OutputGroup__PROPERTYPREFIX_set_header_file_stats_enabled(self, header_file_stats_enabled)
...
class Run(object):
    ...
    def _get_variable(self, variable_name: str) -> Variable:
        ...
        - Use `Run.get_variable_from_specific_output_group` to limit the search scope to a specific output group.
          This is necessary when a run contains two or more variables with the same name.
        """
    ...
    def _get_group_names_native_array(self) -> ArrayOfString:
        r"""
        Gets the names of all output groups belonging to the run.
        ...
        Notes
        -----
        - The name of the output group is indicated by the GENLAB field of the group header file.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
    ...
    def _get_variable_names_native_array(self, remove_duplicates: bool=False) -> ArrayOfString:
        r"""
        Gets the names of all variables belonging to the run.
        ...
        - Some runs may contain variables with the same name in different output groups. Removing duplicate variable names incurs a performance penalty.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
    ...
    def get_variable_1d(self, variable_name: str) -> Variable1D_Float32 | Variable1D_Float64 | Variable1D_Int32:
        ...
        - A one-dimensional variable object represents a dependent variable (the variable under observation)
          with respect to one independent variable, such as time.
        - Use `Run.get_variable_1d_from_specific_output_group` to limit the search scope to a specific output group.
          This is necessary when a run contains two or more variables with the same name.
        """
    ...
    def get_group_names(self) -> np.ndarray[str]:
        ...
        -----
        - The name of the output group is indicated by the GENLAB field of the group header file.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_group_names_native_array` to avoid this penalty.
        """

        return np.array(self._get_group_names_native_array(), copy=False)
    ...
    def get_variable_names(self, remove_duplicates: bool=False) -> np.ndarray[str]:
        ...
        return np.array(self._get_variable_names_native_array(remove_duplicates), copy=False)
...
class RunsIterator(object):
    ...
    def __init__(self, *args):
        ...
        **Function variant 1:**
        ...
        - Run name comparison is case-insensitive by default. Use `ResultsApi.SearchSettings` to change the
...
class OutputGroup1D_Float32(OutputGroup):
    ...
    def __init__(self, *args):
        ...
        *args : tuple
            ...
            - **arg3**
              (str) : The output group data source, indicated by the CONTENT field of the header file. Enter 'UserDefined' for the group to have a calculation type equal to `CALCULATION_TYPE_USER_DEFINED`. This allows filtering on groups with type `CALCULATION_TYPE_USER_DEFINED` when seeking runs, to distinguish them from runs created by Bladed.

            - **arg4**
              (str) : The output group config, indicated by the CONFIG field of the header file. Typically one of `TRANSIENT`, `STATIONARY`, `LIST`, or `TABLE`.
