...
class FrameConfig:
    ...
    def __init__(self, user_data, config):
        ...
        if frame_config is not None:
            ...
            self.ocr_use_onnx = user_data.get(
                "ocr_use_onnx",
                return_value(frame_config.get("ocr_use_onnx", True), True)
            )
            self.ocr_onnx_model_dir = user_data.get(
                "ocr_onnx_model_dir",
                return_value(frame_config.get("ocr_onnx_model_dir", os.path.join(os.getcwd(), "ocrmodel")),
                                              os.path.join(os.getcwd(), "ocrmodel"))
            )
