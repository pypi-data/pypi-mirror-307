...
@step("compare service request [{service}] with json file [{target_data_path}]")
@ele_wrap
@timeout
def request_compare(context, service=None, target_data_path=None):
    ...
    """
    g_Context.step.request_compare_from_path(context, service, target_data_path)
...
def request_query_str_compare(context, service=None, target_data_path=None):
    ...
    :param target_data_path: path of target data to be compared
    """
    g_Context.step.request_query_str_compare_from_path(
        context, service, target_data_path
    )
...
@ele_wrap
@timeout
def request_compare_value(
    context, service=None, target_json_path=None, expect_value=None
):
    """
    ...
    """
    g_Context.step.request_compare_value(
        context, service, target_json_path, expect_value
    )
