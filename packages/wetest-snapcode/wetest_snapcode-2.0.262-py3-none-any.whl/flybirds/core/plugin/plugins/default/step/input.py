...
def only_input(context, param1):
    try:
        ...
        selector_enter = param1_dict.get("enter", "False")
        selector_enter = eval(selector_enter)
        g_Context.element.str_input(selector_str, after_input_wait, selector_enter)
    except Exception:
...
def keyboard_clear(context):
    ...
    long_del = (
        "-s {} shell input keyevent --longpress 67 67 67 67 67 67 67 67 67 67 "
