...
base element class
"""
from flybirds_airtest.core.api import time, text, keyevent

import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_attr as poco_attr
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_click as poco_click
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_ele as poco_ele
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_findsnap as find_snap
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_position as poco_position
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_selector as poco_selector
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_swipe as poco_swipe
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_text as poco_text
import flybirds.core.plugin.plugins.default.ui_driver.poco.poco_verify as poco_verify
from flybirds.core.plugin.plugins.default.ui_driver.poco.poco_input import air_bdd_input
...
class BaseElement:
    ...
    def str_input(self, input_str, after_input_wait=None, enter=False):
        """
    ...
    def air_bdd_input(
        self, poco, select_dsl_str, optional, input_str, after_input_wait=None
    ):
        air_bdd_input(
            poco,
            select_dsl_str,
    ...
    def position_change(self, poco, select_str, optional, o_position):
        return poco_position.position_change(poco, select_str, optional, o_position)

    def position_not_change(self, poco, select_str, optional, dur_time, verify_count):
    ...
    def create_first_child(self, poco_object, select_dic={}):
        return poco_selector.create_first_child(poco_object, select_dic=select_dic)

    def create_first_offspring(self, poco_object, select_dic={}):
        return poco_selector.create_first_offspring(poco_object, select_dic=select_dic)

    def create_first_sibling(self, poco_object, select_dic={}):
        return poco_selector.create_first_sibling(poco_object, select_dic=select_dic)

    def select_child(self, poco_object, target_index, select_dic={}):
        return poco_selector.select_child(
    ...
    def select_sibling(self, poco_object, target_index, select_dic={}):
        return poco_selector.select_sibling(
            poco_object, target_index, select_dic=select_dic
        )
    ...
    def air_bdd_percent_point_swipe(self, poco, start_point, end_point, duration=None):
    ...
    def air_bdd_click_with_direction(
        ...
        poco_click.air_bdd_click_with_direction(
            poco,
            select_dsl_str,
            target_dsl_str,
            direction,
    ...
    def assert_ele(self, poco_instance, selector_str, optional, operator, target_value):
        poco_verify.assert_ele(
            poco_instance, selector_str, optional, operator, target_value
        )
