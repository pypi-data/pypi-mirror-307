...
from flybirds_airtest.utils.logwraper import Logwrap, AirtestLogger
from flybirds_airtest.core.error import NoDeviceError
...
def log(arg, timestamp=None, desc="", snapshot=False):
    ...
    """
    from flybirds_airtest.core.cv import try_log_screen
    if G.LOGGER:
        depth = 0
        if snapshot:
...
def using(path):
    ...
    Examples:
        ...
        If we want to reference foo/bar.air and baz.air in main.py, we can write::
            ...
            # main.py
            from flybirds_airtest.core.api import *
...
def import_device_cls(platform):
    ...
    if platform in G.CUSTOM_DEVICES:
        ...
        from flybirds_airtest.core.android.android import Android as cls
    elif platform == "windows":
        from flybirds_airtest.core.win.win import Windows as cls
    elif platform == "ios":
        from flybirds_airtest.core.ios import IOS as cls
    elif platform == "linux":
        from flybirds_airtest.core.linux.linux import Linux as cls
    else:
