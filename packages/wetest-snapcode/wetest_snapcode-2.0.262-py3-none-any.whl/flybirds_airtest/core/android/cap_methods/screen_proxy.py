...
from flybirds_airtest.core.error import AdbError, ScreenError
...
def register_screen():
    ...
    from flybirds_airtest.core.android.cap_methods.javacap import Javacap
    from flybirds_airtest.core.android.cap_methods.adbcap import AdbCap
