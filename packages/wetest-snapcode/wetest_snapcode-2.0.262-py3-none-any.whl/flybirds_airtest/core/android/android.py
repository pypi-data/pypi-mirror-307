...
from flybirds_airtest import aircv
from flybirds_airtest.core.device import Device
from flybirds_airtest.core.android.ime import YosemiteIme
from flybirds_airtest.core.android.constant import CAP_METHOD, TOUCH_METHOD, IME_METHOD, ORI_METHOD, \
    SDK_VERISON_ANDROID10
from flybirds_airtest.core.android.adb import ADB

from flybirds_airtest.core.android.rotation import RotationWatcher, XYTransformer
from flybirds_airtest.core.android.recorder import Recorder
from flybirds_airtest.core.android.touch_methods.touch_proxy import TouchProxy
from flybirds_airtest.core.error import AdbError, AdbShellError
from flybirds_airtest.core.android.cap_methods.screen_proxy import ScreenProxy

# Compatible with old code
from flybirds_airtest.core.android.cap_methods.minicap import Minicap  # noqa
from flybirds_airtest.core.android.cap_methods.javacap import Javacap  # noqa
from flybirds_airtest.core.android.touch_methods.minitouch import Minitouch  # noqa
from flybirds_airtest.core.android.touch_methods.maxtouch import Maxtouch  # noqa

from flybirds_airtest.core.settings import Settings as ST
from flybirds_airtest.aircv.screen_recorder import ScreenRecorder, resize_by_max, get_max_size
from flybirds_airtest.utils.logger import get_logger
...
class Android(Device):
    ...
    def screen_proxy(self, cap_method):
        ...
        Examples:
            ...
            >>> from flybirds_airtest.core.android.cap_methods.minicap import Minicap
    ...
    def start_recording(self, max_time=1800, output=None, fps=10, mode="yosemite",
        ...
        Examples:
            ...
            >>> from flybirds_airtest.core.api import connect_device, sleep
