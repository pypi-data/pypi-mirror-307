...
import sys
import subprocess
from flybirds_airtest.utils.compat import decode_path
...
YOSEMITE_APK = os.path.join(STATICPATH, "apks", "wetestime.apk")
YOSEMITE_PACKAGE = 'com.tencent.wetest.softkeyboard'
YOSEMITE_IME_SERVICE = 'com.tencent.wetest.softkeyboard/.SoftKeyboard'
