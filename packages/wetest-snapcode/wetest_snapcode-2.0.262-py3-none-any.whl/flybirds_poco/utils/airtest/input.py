...
from flybirds_airtest.core.api import touch, swipe
from flybirds_airtest.core.helper import device_platform, logwrap
...
class AirtestInput(InputInterface):
    ...
    def applyMotionEvents(self, events):
        ...
        from flybirds_airtest.core.android.touch_methods.base_touch import DownEvent, MoveEvent, UpEvent, SleepEvent
