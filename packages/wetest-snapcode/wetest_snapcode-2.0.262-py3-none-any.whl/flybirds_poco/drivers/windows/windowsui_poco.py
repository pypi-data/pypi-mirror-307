...
from flybirds_poco.utils.device import VirtualDevice
from flybirds_poco.drivers.std import DEFAULT_ADDR, DEFAULT_PORT
from flybirds_poco.utils.simplerpc.utils import sync_wrapper
from flybirds_poco.exceptions import InvalidOperationException
...
class WindowsPoco(StdPoco):
    ...
    Examples:
        If your programme is running, you could initialize poco instance by using following snippet::
            from flybirds_poco.drivers.windows import WindowsPoco
    ...
    def __init__(self, selector=None, addr=DEFAULT_ADDR, **options):
        ...
        if addr[0] == "localhost" or addr[0] == "127.0.0.1":
            from flybirds_poco.drivers.windows.sdk.WindowsUI import PocoSDKWindows
