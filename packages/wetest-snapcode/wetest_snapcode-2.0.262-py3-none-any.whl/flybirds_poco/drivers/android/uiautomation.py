...
from flybirds_airtest.core.error import AdbShellError, AirtestError
...
from flybirds_poco.sdk.Attributor import Attributor
from flybirds_poco.sdk.interfaces.screen import ScreenInterface
from flybirds_poco.utils.hrpc.hierarchy import RemotePocoHierarchy
from flybirds_poco.utils.airtest.input import AirtestInput
from flybirds_poco.utils import six
from flybirds_poco.drivers.android.utils.installation import install, uninstall
...
class AndroidUiautomationPoco(Poco):
    ...
    def on_pre_action(self, action, ui, args):
        if self.screenshot_each_action:
            # airteset log用
            from flybirds_airtest.core.api import snapshot
            msg = repr(ui)
