...
from flybirds_poco.agent import PocoAgent
from flybirds_poco.drivers.std.attributor import StdAttributor
from flybirds_poco.drivers.std.dumper import StdDumper
from flybirds_poco.drivers.std.screen import StdScreen
from flybirds_poco.drivers.std.inputs import StdInput
from flybirds_poco.freezeui.hierarchy import FrozenUIHierarchy
from flybirds_poco.utils.airtest import AirtestInput
from flybirds_poco.utils.simplerpc.rpcclient import RpcClient
from flybirds_poco.utils.simplerpc.transport.tcp.main import TcpClient
from flybirds_poco.utils.simplerpc.utils import sync_wrapper

from flybirds_airtest.core.api import connect_device, device as current_device
from flybirds_airtest.core.helper import device_platform
import socket
...
class StdPoco(Poco):
    ...
    Examples:
        The simplest way to connect to a cocos2dx-lua game::
            ...
            from flybirds_poco.drivers.std import StdPoco
            from flybirds_airtest.core.api import connect_device
