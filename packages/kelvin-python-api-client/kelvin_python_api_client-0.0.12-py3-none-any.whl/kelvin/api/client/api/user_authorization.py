    ...
    def create_group(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.GroupCreate, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def create_role(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            "requests.RoleCreate",
            False,
            {"201": responses.RoleCreate, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def create_role_policy(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.RolePolicyCreate, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
