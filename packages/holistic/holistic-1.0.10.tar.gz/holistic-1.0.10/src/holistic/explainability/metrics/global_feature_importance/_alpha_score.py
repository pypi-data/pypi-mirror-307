...
if TYPE_CHECKING:
    from holistic.typing._typing import ArrayLike

from holistic.utils._commons import get_number_of_feature_above_threshold_importance
...
def alpha_score(feature_importance: ArrayLike, alpha: float = 0.8):
    ...
    Examples
    --------
    >>> from holistic.explainability.commons import Importance
