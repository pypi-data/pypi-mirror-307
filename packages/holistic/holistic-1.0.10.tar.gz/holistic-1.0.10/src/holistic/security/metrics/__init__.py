"""
The :mod:holistic.privacy.metrics module includes attacks and privacy metrics
"""
...
import pandas as pd
from holistic.security.metrics._anonymization import k_anonymity, l_diversity
from holistic.security.metrics._attribute_attack import AttributeAttackScore, attribute_attack_score
from holistic.security.metrics._data_minimization import (
    DataMinimizationAccuracyRatio,
    DataMinimizationMSERatio,
    data_minimization_score,
)
from holistic.security.metrics._privacy_risk_score import privacy_risk_score
from holistic.security.metrics._shapr import ShaprScore, shapr_score
