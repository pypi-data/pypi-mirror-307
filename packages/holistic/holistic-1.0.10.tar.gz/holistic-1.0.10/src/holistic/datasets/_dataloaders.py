...
def get_data_home(data_home=None):
    """
    Return the path of the holistic data directory.
    By default the data directory is set to a folder named 'holistic_data' in the
    user home folder.
    Alternatively, it can be set by the 'holistic_DATA' environment
    ...
    data_home : str, default=None
        The path to holistic data directory. If `None`, the default path
        is `~/holistic_data`.
    Returns
    -------
    data_home: str
        The path to holistic data directory.
    """
    if data_home is None:
        data_home = environ.get("HOLISTIC_AI_DATA", join("~", "holistic_data"))
