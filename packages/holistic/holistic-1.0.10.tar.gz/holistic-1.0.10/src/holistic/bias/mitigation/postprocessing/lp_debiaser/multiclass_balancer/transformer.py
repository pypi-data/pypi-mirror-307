...
import numpy as np
from holistic.bias.mitigation.postprocessing.lp_debiaser.multiclass_balancer.algorithm import (
...
class LPDebiaserMulticlass(BMPost):
    ...
    def _get_catalogs(self):
        from holistic.bias.mitigation.postprocessing.lp_debiaser.multiclass_balancer.constraints import (
            EqualizedOdds,
