"""
The :mod:`holistic.bias.mitigation` module includes preprocessing, inprocessing and postprocessing bias mitigation algorithms.
"""

# inprocessing algorithm classes
from holistic.bias.mitigation.inprocessing import (
...
from holistic.bias.mitigation.postprocessing import (
    MCMF,
...
from holistic.bias.mitigation.preprocessing import (
    CorrelationRemover,
...
if networkx_spec is not None:
    from holistic.bias.mitigation.postprocessing import DisparateImpactRemoverRS
    from holistic.bias.mitigation.preprocessing import DisparateImpactRemover
