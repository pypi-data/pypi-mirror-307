...
import numpy as np
from holistic.bias.mitigation.inprocessing.meta_fair_classifier.algorithm import MetaFairClassifierAlgorithm
from holistic.bias.mitigation.inprocessing.meta_fair_classifier.algorithm_utils import MFLogger
from holistic.bias.mitigation.inprocessing.meta_fair_classifier.constraints import FalseDiscovery, StatisticalRate
...
class MetaFairClassifier(BMImp):
    ...
    Examples
    --------
    >>> from holistic.bias.mitigation.inprocessing import MetaFairClassifier
