...
import numpy as np
from holistic.bias.mitigation.postprocessing.lp_debiaser.binary_balancer.algorithm import BinaryBalancerAlgorithm
...
class LPDebiaserBinary(BMPost):
    ...
    def _get_catalogs(self):
        from holistic.bias.mitigation.postprocessing.lp_debiaser.binary_balancer.constraints import (
            EqualizedOdds,
