...
You can find an example of using the propensity-scored recommendations method in the following `tutorial <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/recommender_systems/examples/example_lastfm.html#Inprocessing:-Debiasing-Learning-Method>`_.
