...
Basic Usage
~~~~~~~~~~~~~~
You can find an example of using the Reject Option based Classification (ROC) module in the following `demo <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/binary_classification/demos/postprocessing.html#5.-Reject-Option>`_.
