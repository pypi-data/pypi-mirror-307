...
You can find an example of using the Fairlet Decomposition method in the following `demo <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/clustering/demos/inprocessing.html#4.-Fairlet>`_.
