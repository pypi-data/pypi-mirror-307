...
You can find an example of using the Calibrated Equalized Odds method in the following `demo <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/binary_classification/demos/postprocessing.html#1-.-Calibrated-Equalized-Odds>`_.
