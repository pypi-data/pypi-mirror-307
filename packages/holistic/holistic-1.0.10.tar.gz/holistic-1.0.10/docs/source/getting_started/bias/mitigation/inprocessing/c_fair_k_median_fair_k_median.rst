...
You can find an example of using the Fair k-Median method in the following `demo <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/clustering/demos/inprocessing.html#3.-Fair-K-Median>`_.
