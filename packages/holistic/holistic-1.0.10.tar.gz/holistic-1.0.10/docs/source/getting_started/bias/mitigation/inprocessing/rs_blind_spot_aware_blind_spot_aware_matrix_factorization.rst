...
You can find an example of using the Blind Spot Aware Matrix Factorization method in the following `tutorial <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/recommender_systems/examples/example_lastfm.html#Inprocessing:-Blind-spot-aware-method>`_.
