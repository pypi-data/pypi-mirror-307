...
You can find an example of using the Equality of Opportunity method in the following `demo <https://holistic.readthedocs.io/en/latest/gallery/tutorials/bias/mitigating_bias/binary_classification/demos/postprocessing.html#2.-Equalized-Odds>`_.
