...
from holistic.inspection._utils import group_index_samples_by_learning_task
from holistic.utils._definitions import ConditionalImportances, Importances, ModelProxy
...
class SurrogateFeatureImportanceCalculator:
    ...
    def compute_importances(self, X: pd.DataFrame, proxy: ModelProxy) -> Importances:
        ...
        Returns:
            holistic.utils.feature_importance.SurrogateFeatureImportance: The surrogate feature importance.
        """
