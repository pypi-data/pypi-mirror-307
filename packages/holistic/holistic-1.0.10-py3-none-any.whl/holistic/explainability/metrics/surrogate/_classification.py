...
import numpy as np
import pandas as pd
from holistic.explainability.metrics.global_feature_importance._importance_spread import FeatureImportanceSpread
from holistic.explainability.metrics.global_feature_importance._surrogate import (
    surrogate_accuracy_score,
)
from holistic.explainability.metrics.surrogate._stability import (
    FeatureImportancesStability,
    FeaturesStability,
)
from holistic.explainability.metrics.tree._tree import (
    TreeDepthVariance,
...
from holistic.typing import ArrayLike
from holistic.utils.surrogate_models import BinaryClassificationSurrogate, MultiClassificationSurrogate
...
def surrogate_accuracy_degradation(y: ArrayLike, y_pred: ArrayLike, y_surrogate: ArrayLike):
    ...
    --------
    >>> import numpy as np
    >>> from holistic.explainability.metrics.surrogate import (
