import numpy as np
from holistic.utils.surrogate_models import get_features, get_number_of_rules
...
def weighted_average_depth(tree):
    ...
    >>> from holistic.explainability.metrics import weighted_average_depth
...
def tree_number_of_rules(surrogate):
    ...
    >>> from sklearn.datasets import load_iris
    >>> from sklearn.tree import DecisionTreeClassifier
    >>> from holistic.explainability.metrics import tree_number_of_rules
    >>> X, y = load_iris(return_X_y=True)
    >>> clf = DecisionTreeClassifier()
    >>> clf.fit(X, y)
...
def tree_number_of_features(surrogate):
    ...
    >>> from sklearn.datasets import load_iris
    >>> from sklearn.tree import DecisionTreeClassifier
    >>> from holistic.explainability.metrics import tree_number_of_features
    >>> X, y = load_iris(return_X_y=True)
    >>> clf = DecisionTreeClassifier()
    >>> clf.fit(X, y)
