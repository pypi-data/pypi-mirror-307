...
from holistic.pipeline._pipeline_helper import PipelineHelper
from holistic.utils.obj_rep.object_repr import PipelineReprObj
...
class Pipeline(PipelineReprObj, SKLPipeline, PipelineHelper):
    ...
    Description
    -----------
    holistic pipeline wrap the sklearn pipeline to support unconventional transformers.
