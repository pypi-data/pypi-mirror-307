"""
The :mod:`holistic.bias.metrics` module includes classification, regression, multiclass, recommender and clustering bias metrics
"""
...
# Multiclass
# Recommender
from holistic.bias.metrics._classification import (
    abroca,
    accuracy_diff,
    average_odds_diff,
...
from holistic.bias.metrics._clustering import (
    cluster_balance,
...
from holistic.bias.metrics._multiclass import (
    accuracy_matrix,
    confusion_matrix,
    confusion_tensor,
    frequency_matrix,
...
from holistic.bias.metrics._recommender import (
    aggregate_diversity,
    avg_f1_ratio,
    avg_precision_ratio,
    avg_recall_ratio,
...
# Regression
from holistic.bias.metrics._regression import (
    avg_score_diff,
    avg_score_ratio,
    correlation_diff,
