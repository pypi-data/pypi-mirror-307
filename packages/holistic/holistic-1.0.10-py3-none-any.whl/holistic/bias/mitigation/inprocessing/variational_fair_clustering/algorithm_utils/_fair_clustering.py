...
import numpy as np
from holistic.bias.mitigation.inprocessing.variational_fair_clustering.algorithm_utils._bound_update import (
    BoundUpdate,
    normalize_2,
)
from holistic.bias.mitigation.inprocessing.variational_fair_clustering.algorithm_utils._logger import MFLogger
from holistic.bias.mitigation.inprocessing.variational_fair_clustering.algorithm_utils._method_utils import (
    _init_centroids,
    compute_fairness_energy,
    ecdist,
    km_le,
)
from holistic.bias.mitigation.inprocessing.variational_fair_clustering.algorithm_utils._methods import (
    KmeansUtils,
    KmedianUtils,
    NCutUtils,
)
from holistic.bias.mitigation.inprocessing.variational_fair_clustering.algorithm_utils._utils import (
