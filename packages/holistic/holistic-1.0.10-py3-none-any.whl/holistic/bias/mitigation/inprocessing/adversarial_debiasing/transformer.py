...
import numpy as np
import pandas as pd
from holistic.bias.mitigation.inprocessing.adversarial_debiasing.models import (
    ADModel,
    AdversarialModel,
    ClassifierModel,
    create_train_state,
...
from holistic.datasets import DataLoader, Dataset
...
class AdversarialDebiasing(BMImp):
    ...
    Examples
    --------
    >>> from holistic.bias.mitigation.inprocessing import AdversarialDebiasing
