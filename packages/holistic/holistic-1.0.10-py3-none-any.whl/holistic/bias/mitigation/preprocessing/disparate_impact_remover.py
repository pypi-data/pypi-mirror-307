import numpy as np
from holistic.bias.mitigation.commons.disparate_impact_remover._numerical_repairer import (
    NumericalRepairer,
)
from holistic.utils.transformers.bias import BMPreprocessing as BMPre
...
class DisparateImpactRemover(BMPre):
    ...
    Examples
    --------
    >>> from holistic.bias.mitigation import DisparateImpactRemover
