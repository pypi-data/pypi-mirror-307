...
class DivNumberAnimator(BaseDiv):
    ...
    cancel_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description=(
            "Actions to be performed if the animator is canceled. For "
            "example, when a commandwith the type `animator_stop` is "
            "received."
        ),
    )
    ...
    end_actions: typing.Optional[typing.Sequence[div_action.DivAction]] = Field(
        description="Actions to be performed after the animator finishes.",
    )
