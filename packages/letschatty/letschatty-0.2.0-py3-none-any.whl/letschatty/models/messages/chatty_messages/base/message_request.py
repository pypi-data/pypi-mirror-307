...
class MessageRequest(BaseModel):
    ...
    @classmethod
    def from_response(cls, data: Dict[str, Any], context: ChattyContext, subtype: MessageSubtype) -> MessageRequest:
        message_request = cls(**data)
        message_request.context = context
        message_request.subtype = subtype
        return message_request

class MessagesRequestFromAgent(BaseModel):
    agent_email: str
    chat_id: str
