...
class Darn(BaseRegistry):
    ...
    async def list_darn(self):
        try:
            ...
            # Create a list of dictionaries with the required fields and add a separator
            table_data = [
                {
            ...
            table_data_with_separators = [entry for darn in table_data for entry in (darn, "--------------------")]

            return table_data_with_separators
        except Exception as e:
