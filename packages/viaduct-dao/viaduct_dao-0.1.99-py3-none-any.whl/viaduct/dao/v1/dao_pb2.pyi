...
class QueryRequest(_message.Message):
    __slots__ = ("query", "daoql", "limit", "order_direction", "debug_options")
    ...
    def __init__(self, query: _Optional[_Union[Query, _Mapping]] = ..., daoql: _Optional[str] = ..., limit: _Optional[int] = ..., order_direction: _Optional[_Union[OrderDirection, str]] = ..., debug_options: _Optional[_Union[QueryDebugOptions, _Mapping]] = ...) -> None: ...
...
class Query(_message.Message):
    __slots__ = ("filter", "from_assets", "from_events", "columns", "aggregations", "group_by")
    ...
    def __init__(self, filter: _Optional[_Union[Node, _Mapping]] = ..., from_assets: _Optional[_Union[QueryFromAssets, _Mapping]] = ..., from_events: _Optional[_Union[QueryFromEvents, _Mapping]] = ..., columns: _Optional[_Iterable[_Union[QueryColumn, _Mapping]]] = ..., aggregations: _Optional[_Iterable[_Union[QueryAggregation, _Mapping]]] = ..., group_by: _Optional[_Iterable[_Union[IdentifierNode, _Mapping]]] = ...) -> None: ...
