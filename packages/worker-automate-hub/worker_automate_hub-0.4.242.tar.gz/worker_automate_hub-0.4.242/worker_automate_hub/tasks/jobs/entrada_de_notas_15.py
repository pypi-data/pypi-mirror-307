...
async def entrada_de_notas_15(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    ...
    try:
        ...
        combo_box_tipo_documento.click_input()
        pyautogui.hotkey("enter")
        console.print(
            "Clique no select box, Tipo de documento realizado com sucesso, selecionando o tipo de documento...\n"
        )

        await worker_sleep(4)

        # Seleciona o valor desejado no ComboBox usando o método nativo 'select'
        combo_box_tipo_documento.select("NOTA FISCAL DE ENTRADA ELETRONICA - DANFE")
        console.print(
