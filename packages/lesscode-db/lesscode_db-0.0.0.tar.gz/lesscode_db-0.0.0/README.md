...
from lesscode_db.db_options import db_options
from lesscode_db.ds_helper import DsHelper
...
async def async_clickhouse_test():
    client = DsHelper("clickhouse").pool
    sql = "SELECT 1"
    result = await client.query(query=sql)
