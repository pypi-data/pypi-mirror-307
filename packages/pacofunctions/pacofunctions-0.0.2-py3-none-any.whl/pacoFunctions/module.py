...
def is_rodizio(address: dict) -> bool:
    rodizio_polygon = gpd.read_file(r"P:\My Drive\Scripts\Paco Rush\.venv\Scripts\Routing\Rodizio\shapesMiniAnel.shp")

    location = Point(address["longitude"], address["latitude"])
    polygon = Polygon(rodizio_polygon['geometry'][0])
