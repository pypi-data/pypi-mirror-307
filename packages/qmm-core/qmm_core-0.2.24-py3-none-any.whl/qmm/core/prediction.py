...
def table_of_predictions(M, t1=0.8, t2=1, index=None, columns=None) -> pd.DataFrame:
...
def compare_predictions(M1, M2) -> pd.DataFrame:
...
def create_plot(data, **kwargs) -> Tuple[plt.Figure, plt.Axes]:
    plt.rcParams.update(
        {
            "xtick.top": True,
            "xtick.bottom": False,
