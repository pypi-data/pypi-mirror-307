...
from scicat-sdk-pydantic.models.update_where_policy_dto import UpdateWherePolicyDto  # noqa: E501
    ...
    def make_instance(self, include_optional) -> UpdateWherePolicyDto:
        ...
        if include_optional:
            return UpdateWherePolicyDto(
                owner_group_list = '',
                data = scicat-sdk-pydantic.models.update_policy_dto.UpdatePolicyDto(
                    owner_group = '', 
                    access_groups = [
                        ''
                        ], 
