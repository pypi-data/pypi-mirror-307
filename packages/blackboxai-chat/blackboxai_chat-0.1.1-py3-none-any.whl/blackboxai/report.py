...
from blackboxai.urls import github_issues
from blackboxai.versioncheck import VERSION_CHECK_FNAME
...
def report_github_issue(issue_text, title=None, confirm=True):
    ...
    :return: None
    """
    version_info = f"BLACKBOXAI version: {__version__}\n"
    ...
    if confirm:
        ...
        print()
        print("Please consider reporting this bug to help improve blackboxai!")
