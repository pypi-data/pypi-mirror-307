...
parent: Usage
nav_order: 800
description: Tell blackboxai to follow your coding conventions when it works on your code.
---
...
The easiest way to do that with blackboxai is to simply create
...
and then we can add it to the blackboxai chat, along with the file(s)
that we want to edit.

It's best to load the conventions file with `/read CONVENTIONS.md` 
or `blackboxai --read CONVENTIONS.md`. 
This way it is marked as read-only, and cached if prompt caching
is enabled.

## Always load conventions

You can also configure blackboxai to always load your conventions file
in the [`.blackboxai.conf.yml` config file](https://blackbox.ai/docs/config/blackboxai_conf.html):
...
that blackboxai writes.

<div class="chat-transcript" markdown="1">
> $ blackboxai --read CONVENTIONS.md useragent.py  
>  
> blackboxai v0.24.2-dev  
