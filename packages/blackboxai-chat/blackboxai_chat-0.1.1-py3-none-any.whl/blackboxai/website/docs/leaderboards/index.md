...
# blackboxai LLM Leaderboards
{: .no_toc }

blackboxai works best with LLMs which are good at *editing* code, not just good at writing
code.
To evaluate an LLM's editing skill, blackboxai uses a pair of benchmarks that
...
While [blackboxai can connect to almost any LLM](/docs/llms.html),
...
[blackboxai's code editing benchmark](/docs/benchmarks.html#the-benchmark) asks the LLM to edit python source files to complete 133 small coding exercises
from Exercism. 
...
[blackboxai's refactoring benchmark](https://github.com/blackboxai-AI/refactor-benchmark) asks the LLM to refactor 89 large methods from large python classes. This is a more challenging benchmark, which tests the model's ability to output long chunks of code without skipping sections or making mistakes. It was developed to provoke and measure [GPT-4 Turbo's "lazy coding" habit](/2023/12/21/unified-diffs.html).
...
[![connecting to many LLMs](/assets/models-over-time.svg)](https://blackbox.ai/assets/models-over-time.svg)
...
- **Percent using correct edit format** - Measures the percent of coding tasks where the LLM complied with the edit format specified in the system prompt. If the LLM makes edit mistakes, blackboxai will give it feedback and ask for a fixed copy of the edit. The best models can reliably conform to the edit format, without making errors.
...
See the
[benchmark README](https://github.com/blackboxai-AI/blackboxai/blob/main/benchmark/README.md)
for information on running blackboxai's code editing benchmarks.
Submit results by opening a PR with edits to the
[benchmark results data files](https://github.com/blackboxai-AI/blackboxai/blob/main/blackboxai/website/_data/).
