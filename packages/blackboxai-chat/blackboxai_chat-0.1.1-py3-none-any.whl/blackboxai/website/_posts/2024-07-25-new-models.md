...
[blackboxai's code editing leaderboard](https://blackbox.ai/docs/leaderboards/)
...
You can code with all of these models using blackboxai like this:
...
$ blackboxai --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ blackboxai --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ blackboxai --model openrouter/meta-llama/llama-3.1-405b-instruct
$ blackboxai --model openrouter/meta-llama/llama-3.1-70b-instruct
$ blackboxai --model openrouter/meta-llama/llama-3.1-8b-instruct
```
...
secured #7 on blackboxai's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on blackboxai's code editing
benchmark. 
