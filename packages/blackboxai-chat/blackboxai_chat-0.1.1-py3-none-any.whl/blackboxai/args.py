...
from blackboxai import __version__
from blackboxai.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        ...
        auto_env_var_prefix="BLACKBOXAI_",
    )
    ...
    group.add_argument(
        ...
        help="Specify a file with blackboxai model settings for unknown models",
    )
    group.add_argument(
        "--model-metadata-file",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".blackboxai.input.history") if git_root else ".blackboxai.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".blackboxai.chat.history.md") if git_root else ".blackboxai.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .blackboxai.llm.history)",
    )
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .blackboxai* to .gitignore (default: True)",
    )
    default_blackboxaiignore_file = (
        os.path.join(git_root, ".blackboxaiignore") if git_root else ".blackboxaiignore"
    )
    group.add_argument(
        "--blackboxaiignore",
        metavar="blackboxaiIGNORE",
        default=default_blackboxaiignore_file,
        help="Specify the blackboxai ignore file (default: .blackboxaiignore in git root)",
    )
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute blackboxai code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute blackboxai commits in the git committer name (default: True)",
    )
    group.add_argument(
        "--attribute-commit-message-author",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'blackboxai: ' if blackboxai authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'blackboxai: ' (default: False)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new blackboxai versions on launch",
        default=True,
    )
    group.add_argument(
        "--install-main-branch",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade blackboxai to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--apply",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .blackboxai.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    group.add_argument(
        ...
        "--browser",
        action=argparse.BooleanOptionalAction,
        help="Run blackboxai in your browser (default: False)",
        default=False,
    )
    group.add_argument(
