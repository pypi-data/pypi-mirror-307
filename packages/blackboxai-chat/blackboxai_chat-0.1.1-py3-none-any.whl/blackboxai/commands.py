...
from blackboxai import models, prompts, voice
from blackboxai.format_settings import format_settings
from blackboxai.help import Help, install_help_extra
from blackboxai.llm import litellm
from blackboxai.repo import ANY_GIT_ERROR
from blackboxai.run_cmd import run_cmd
from blackboxai.scrape import Scraper, install_playwright
from blackboxai.utils import is_image_file
...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by blackboxai"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.blackboxai_commit_hashes:
            self.io.tool_error("The last commit was not made by blackboxai in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so blackboxai can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to blackboxaiignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use blackboxai.")

    def cmd_help(self, args):
        "Ask questions about blackboxai"
        ...
        user_msg += """
# Announcement lines from when this session of blackboxai was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from blackboxai.report import report_github_issue
