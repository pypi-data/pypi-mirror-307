...
def main():
    ...
    from blackboxai import __version__ as current_version
    ...
    with open("blackboxai/__init__.py", "r") as f:
        content = f.read()
    updated_content = re.sub(r'__version__ = ".+?"', f'__version__ = "{new_version}"', content)

    print("Updating blackboxai/__init__.py with new version:")
    print(updated_content)
    if not dry_run:
        with open("blackboxai/__init__.py", "w") as f:
            f.write(updated_content)

    git_commands = [
        ["git", "add", "blackboxai/__init__.py"],
    ...
    print()
    print("Updating blackboxai/__init__.py with new dev version:")
    ...
    # Remove blackboxai/__version__.py if it exists
    version_file = "blackboxai/__version__.py"
