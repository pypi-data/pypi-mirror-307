...
SUPPORTED_EXTENSIONS = [
    '.js', '.jsx', '.ts', '.tsx', '.mjs', '.py',
    '.rs', '.go', '.java', '.cpp', '.cc', '.cxx',
    '.c', '.h', '.hpp', '.cs', '.rb', '.ruby', '.vue', '.php',
    '.md', '.sh', '.yml', '.yaml', '.json', '.swift', '.slurm', '.r',
    '.bash', '.bats', '.command', '.zsh', '.scala', '.sbt', '.lua', '.m',
    '.sql', '.sparql', '.scss', '.proto', '.perl', '.pl', '.hs', '.jl', '.kt',
    '.makefile', '.cmake', '.css', '.html', '.htm', '.dockerfile', 
]
...
def is_in_supported_files(file_name):
    """
    Check if the given file name is in the supported file extensions.
