...
[![benchmark results](/assets/benchmarks-0125.svg)](https://blackbox.ai/assets/benchmarks-0125.svg)
...
blackboxai's existing
[lazy coding benchmark](https://blackbox.ai/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://blackbox.ai/docs/unified-diffs.html) code editing format.
- Using blackboxai's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://blackbox.ai/docs/benchmarks-1106.html).
- [blackboxai's lazy coding benchmark](https://blackbox.ai/docs/unified-diffs.html).
