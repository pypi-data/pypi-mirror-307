...
> Figure 1: blackboxai coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why blackboxai uses a plain text format for LLMs to specify code edits (below),
...
Previous [blackboxai benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[blackboxai "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
blackboxai's "whole" edit format, where the
...
#### Notes on the blackboxai leaderboard

*The results presented here are not directly comparable to results
from the main
[blackboxai LLM leaderboard](https://blackbox.ai/docs/leaderboards/).
