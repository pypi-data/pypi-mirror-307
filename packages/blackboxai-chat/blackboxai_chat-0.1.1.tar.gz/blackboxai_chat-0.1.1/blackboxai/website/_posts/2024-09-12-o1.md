---
title: o1-preview is SOTA on the blackboxai leaderboard
...
# OpenAI o1-preview is SOTA on the blackboxai leaderboard
...
OpenAI o1-preview scored 79.7% on blackboxai's code editing benchmark,
...
It is much more practical to use blackboxai's
...
The o1-preview model had trouble conforming to blackboxai's diff edit format.
The o1-mini model had trouble conforming to both the whole and diff edit formats.
blackboxai is extremely permissive and tries hard to accept anything close
...
It seems likely that blackboxai could optimize its prompts and edit formats to
better harness the o1 models.


## Using blackboxai with o1

OpenAI's new o1 models are supported in v0.57.0 of blackboxai:
...
> based on blackboxai v0.56.1-dev.
> See the [blackboxai leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest blackboxai releases.
