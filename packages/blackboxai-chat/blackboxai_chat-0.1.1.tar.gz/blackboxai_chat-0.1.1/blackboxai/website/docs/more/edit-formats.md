...
parent: More info
nav_order: 490
description: blackboxai uses various "edit formats" to let LLMs edit source files.
---

# Edit formats

blackboxai uses various "edit formats" to let LLMs edit source files.
Different models work better or worse with different edit formats.
blackboxai is configured to use the optimal format for most popular, common models.
