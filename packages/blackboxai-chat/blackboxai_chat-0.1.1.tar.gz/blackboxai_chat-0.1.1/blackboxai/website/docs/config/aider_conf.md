...
nav_order: 15
description: How to configure blackboxai with a yaml config file.
---

# YAML config file

Most of blackboxai's options can be set in an `.blackboxai.conf.yml` file.
blackboxai will look for a this file in these locations and
...
can also
[download from GitHub](https://github.com/blackboxai-AI/blackboxai/blob/main/blackboxai/website/assets/sample.blackboxai.conf.yml).

<!--[[[cog
from blackboxai.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("blackboxai/website/assets/sample.blackboxai.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .blackboxai.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .blackboxai.model.metadata.json
...
#input-history-file: .blackboxai.input.history

## Specify the chat history file (default: .blackboxai.chat.history.md)
#chat-history-file: .blackboxai.chat.history.md
