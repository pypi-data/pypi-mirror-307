...
from blackboxai import __version__, urls, utils
from blackboxai.dump import dump  # noqa: F401

blackboxai_user_agent = f"blackboxai/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["blackboxai-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_playwright(self, url):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                user_agent = user_agent.replace("headless", "")
                user_agent += " " + blackboxai_user_agent
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({blackboxai_user_agent})"}
        try:
            with httpx.Client(
