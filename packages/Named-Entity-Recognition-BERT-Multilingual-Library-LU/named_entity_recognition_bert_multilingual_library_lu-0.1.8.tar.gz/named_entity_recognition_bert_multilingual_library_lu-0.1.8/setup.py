...
setup(
    ...
    url='https://github.com/yourusername/Named_Entity_Recognition_BERT_Multilingual_Library_LU',
    project_urls={
    ...
    packages=find_packages(include=['Named_Entity_Recognition_BERT_Multilingual_Library_LU', 'Named_Entity_Recognition_BERT_Multilingual_Library_LU.*']),
    install_requires=[
        'torch>=1.8.0',            # PyTorch as the main backend
        'transformers>=4.10.0',    # transformers library, without TensorFlow
        'datasets>=2.1.0',
        'evaluate>=0.2.2',
        'numpy>=1.19.5',
        'seqeval>=1.2.2',
    ...
    entry_points={
        'console_scripts': [
            'ner-multilingual=Named_Entity_Recognition_BERT_Multilingual_Library_LU.cli:main',
        ],
    },
