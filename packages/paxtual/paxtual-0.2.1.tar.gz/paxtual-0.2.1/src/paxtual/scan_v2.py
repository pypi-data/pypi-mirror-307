...
class Scan_serials(ModalScreen):
    ...
    BINDINGS = [
        ("escape", "app.pop_screen", "Go Back"),  # Bind 'escape' key to go back to the previous screen
        ("0000", "", "Del item"),  # Bind '0000' input to finish serial number entry
        ("BKSPC", "", "Del item")   # Bind 'BKSPC' input to delete the last entered serial number
    ]
