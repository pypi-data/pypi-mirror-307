...
def get_defaults_dict(module, cls_name, f_name):
    ...
    defaults_path = os.path.join(defaults_folder, "default_evaluation.json")
...
from .models import unet, unetpad, get_architecture, get_size
from .post import TH_post, MAP_post, WTS_post
from .utils import (
    list_gpus,
    parse_cuda,
    loadnet,
