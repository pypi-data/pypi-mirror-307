...
class KubernetesSparkSession:
    def __init__(
        ...
        self.kubernetes_spark_image_pull_policy = image_pull_policy or "IfNotPresent"

        self.google_service_account_path = google_service_account_path or get_env_or_raise("KUBERNETES_GOOGLE_SERVICE_ACCOUNT_PATH")
        ...
        self.jars = jars or []
        self.jars.append("https://storage.googleapis.com/hadoop-lib/gcs/gcs-connector-hadoop3-latest.jar")
    ...
    def _initialize_default_config(self):
        ...
        self.config["spark.eventLog.gcMetrics.youngGenerationGarbageCollectors"] = "G1YoungGeneration"
        self.config["spark.eventLog.gcMetrics.oldGenerationGarbageCollectors"] = "G1OldGeneration"
