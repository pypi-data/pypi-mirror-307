...
class AsyncRequest:
	...
	async def update(self, update_data: dict, id_key: str = None) -> None:
		"""
	...
	async def increment_field(self, field: str, amount: int, id_key: str = None) -> None:
		"""
	...
	async def update_field(self, path: str, amount: int) -> None:
		"""
	...
	async def update_string_field(self, path: str, new_value: str) -> None:
		"""
