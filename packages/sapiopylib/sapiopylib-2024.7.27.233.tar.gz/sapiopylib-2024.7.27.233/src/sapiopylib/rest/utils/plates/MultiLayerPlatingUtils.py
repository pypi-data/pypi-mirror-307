...
class MultiLayerPlatingManager:
    ...
    def get_records_for_consumable_type(self, layer: MultiLayerPlateLayer) -> List[DataRecord]:
        ...
        custom_report: CustomReport = CustomReport(False, None, custom_report_criteria)
        result_table = self.custom_report_manager.run_custom_report(custom_report).result_table
