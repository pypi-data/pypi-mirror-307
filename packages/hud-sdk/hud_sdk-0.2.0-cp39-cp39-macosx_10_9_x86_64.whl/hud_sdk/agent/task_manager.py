import asyncio
import time
from typing import Any, Callable, Set  # noqa: F401
...
class TaskManager:
    ...
    async def _create_periodic_task(
        self, function: Callable[..., Any], interval: float, *args: Any, **kwargs: Any
    ) -> None:
    ...
    def stop_running_tasks(self) -> None:
        _create_task(asyncio.sleep, 2).add_done_callback(
