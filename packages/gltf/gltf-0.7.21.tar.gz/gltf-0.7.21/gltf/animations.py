...
class Animation(object):
    ...
    def __init__(self, animation=None, gltf=None, channels=None, samplers=None, name=None):
        if animation:
            ...
            self.extras = animation.get('extras')
        else:
...
class Skin(object):
    ...
    def __init__(self, skin=None, gltf=None, inverse_bind_matrices=None,
        ...
        if skin:
            ...
            if 'inverseBindMatrices' in skin:
                ...
                self.inverse_bind_matrices.byte_stride = None
            if 'skeleton' in skin:
                self.skeleton = gltf.nodes[skin['skeleton']]
            self.name = skin.get('name')
            self.extras = skin.get('extras')
        else:
    ...
    def __eq__(self, other):
        if not isinstance(other, type(self)):
            return False
        return (self.skeleton, self.inverse_bind_matrices, self.joints, self.extras) == \
               (other.skeleton, other.inverse_bind_matrices, other.joints, other.extras)
