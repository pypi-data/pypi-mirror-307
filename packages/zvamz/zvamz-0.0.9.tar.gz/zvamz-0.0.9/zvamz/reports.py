...
def storageFeeReport(filePath:str):
    storageFeeDf = pd.read_csv(filePath, encoding_errors='replace')
...
def overAgeFeeReport(filepath:str):
    overAgeDf = pd.read_csv(filepath, encoding_errors='replace')
...
def returnProcessFeeReport(filepath:str):
    returnFeeDf = pd.read_csv(filepath, encoding_errors='replace')
