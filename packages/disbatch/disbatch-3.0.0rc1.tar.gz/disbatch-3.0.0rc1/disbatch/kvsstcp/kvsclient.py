...
if '__main__' == __name__:
    ...
    argp = argparse.ArgumentParser(
        description='Command-line client to key-value storage server.'
    )
    argp.add_argument(
        '-R',
        '--retry',
        ...
        type=int,
        metavar='COUNT',
        help='Number of times to retry on connect failure [0]',
    )
    argp.add_argument(
        '-P',
        '--pickle',
        dest='encoding',
        action='store_true',
        help='(Un-)Pickle values to/from python expressions',
    )
    argp.add_argument(
        '-A',
        '--no-pickle',
        dest='encoding',
        action='store_false',
        help="Don't (un-)pickle values (default)",
    )
    argp.add_argument(
        '-E',
        '--encoding',
    ...
    argp.add_argument(
        ...
        metavar='SECS',
        nargs='?',
        help='Timeout waiting for get/view',
    )
    argp.add_argument(
        '-d', '--dump', action=OpAction, nargs=0, help='Dump the current state'
    )
    argp.add_argument(
        '-g',
        '--get',
        ...
        nargs=1,
        metavar='KEY',
        help='Retrieve and remove a value',
    )
    argp.add_argument(
        '-v', '--view', action=OpAction, nargs=1, metavar='KEY', help='Retrieve a value'
    )
    argp.add_argument(
        '-p',
        '--put',
    ...
    argp.add_argument(
        '-S', '--shutdown', action=OpAction, nargs=0, help='Tell the server to shutdown'
    )
    argp.add_argument(
        '-s',
        '--sleep',
