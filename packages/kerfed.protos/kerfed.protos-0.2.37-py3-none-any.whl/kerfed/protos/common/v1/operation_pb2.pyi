...
class Operation(google.protobuf.message.Message):
    ...
    """if we are tracking these in an ERP system"""
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "kind", b"kind", "note", b"note", "operation_id", b"operation_id", "price", b"price", "shop_id", b"shop_id", "stock", b"stock"]) -> None: ...
