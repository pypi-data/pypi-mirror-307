...
class WindowTitleProcessFilter(ProcessFilter):
    ...
    def __init__(self, operator: Literal["eq", "ne"], value: str):
        ...
        if operator not in ["eq", "ne"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for WINDOWTITLE filter. Valid operators {['eq', 'ne']}")
        #
        #
        #
        #
...
class UsernameProcessFilter(ProcessFilter):
    ...
    def __init__(self, operator: Literal["eq", "ne"], username: str, domain: str = ""):
        ...
        #
        if operator not in ["eq", "ne"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for USERNAME filter. Valid operators {['eq', 'ne']}")
...
class UserContext:
    ...
    #
    #
    def __init__(self, username: str, domain: str = "", password: str = None):
        """
...
class StatusProcessFilter(ProcessFilter):
    ...
    def __init__(
            self,
            operator: Literal["eq", "ne"], value: Literal["RUNNING", "NOT RESPONDING", "UNKNOWN"]
    ):
        """
        ...
        """
        if operator not in ["eq", "ne"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for STATUS filter. Valid operators {['eq', 'ne']}")

        if value not in ["RUNNING", "NOT RESPONDING", "UNKNOWN"]:
            raise WrongCommandLineParameter(f"Invalid '{value}' value for STATUS filter. Valid values {['RUNNING', 'NOT RESPONDING', 'UNKNOWN']}")
...
class SessionProcessFilter(ProcessFilter):
    ...
    def __init__(
        ...
        if operator not in ["eq", "ne", "gt", "lt", "ge", "le"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for SESSION filter. Valid operators {['eq', 'ne', 'gt', 'lt', 'ge', 'le']}")
...
class PIDProcessFilter(ProcessFilter):
    ...
    def __init__(
        ...
        """
        if operator not in ["eq", "ne", "gt", "lt", "ge", "le"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for IMAGENAME filter. Valid operators {['eq', 'ne', 'gt', 'lt', 'ge', 'le']}")
...
class ModulesProcessFilter(ProcessFilter):
    ...
    def __init__(self, operator: Literal["eq", "ne"], value: str):
        ...
        """
        if operator not in ["eq", "ne"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for MODULES filter. Valid operators {['eq', 'ne']}")
        #
        #
        #
        #
...
class MemoryUsageProcessFilter(ProcessFilter):
    ...
    def __init__(
        ...
        """
        if operator not in ["eq", "ne", "gt", "lt", "ge", "le"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for MEMUSAGE filter. Valid operators {['eq', 'ne', 'gt', 'lt', 'ge', 'le']}")
...
class ImageNameProcessFilter(ProcessFilter):
    ...
    def __init__(self, operator: Literal["eq", "ne"], value: str):
        ...
        """
        if operator not in ["eq", "ne"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for IMAGENAME filter. Valid operators {['eq', 'ne']}")
...
class CPUTimeProcessFilter(ProcessFilter):
    ...
    def __init__(
        ...
        """
        if operator not in ["eq", "ne", "gt", "lt", "ge", "le"]:
            raise WrongCommandLineParameter(f"Invalid '{operator}' operator for CPUTIME filter. Valid operators {['eq', 'ne', 'gt', 'lt', 'ge', 'le']}")
