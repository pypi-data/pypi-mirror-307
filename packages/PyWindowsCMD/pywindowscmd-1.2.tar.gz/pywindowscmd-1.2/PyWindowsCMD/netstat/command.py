...
#
#
def build_netstat_routing_table_command():
    """
...
#
#
def build_netstat_per_protocol_statistics_command(
        protocol: Literal[
            "TCP",
            "UDP",
            "TCPv6",
    ...
    Args:
        protocol (Literal["TCP", "UDP", "TCPv6", "UDPv6", "IP", "IPv6", "ICMP", "ICMPv6"]): The protocol to display statistics for. If None, displays statistics for all protocols. Defaults to None.
...
#
#
def build_netstat_ethernet_statistics_command():
    """
