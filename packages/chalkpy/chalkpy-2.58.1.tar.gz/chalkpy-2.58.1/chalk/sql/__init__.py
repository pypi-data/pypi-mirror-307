...
def DynamoDBSource(
    *,
    ...
    aws_client_id_override
        Optionally override the credentials using an AWS client id, must be provided with a client secret override
    aws_client_secret_override
        Optionally override the credentials using an AWS client secret, must be provided with a client id override
    ...
    >>> import os
    >>> source = DynamoDBSource(
    ...     aws_client_id_override=os.getenv("DYNAMODB_AWS_CLIENT_ID_OVERRIDE"),
    ...     aws_client_secret_override=os.getenv("DYNAMODB_AWS_CLIENT_SECRET_OVERRIDE"),
    ...     aws_role_arn_override=os.getenv("DYNAMODB_AWS_ROLE_ARN_OVERRIDE"),
    ...     aws_region_override=os.getenv("DYNAMODB_AWS_REGION_OVERRIDE"),
    ... )
    """
    ...
