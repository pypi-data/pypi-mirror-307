...
class ChalkClient:
    ...
    def check(
        ...
        This function should be used in integration tests. Requires pytest: pytest.fail will be executed on an error.
        ...
        cache_hits
            ...
            ```
        feature_errors
            The `errors` map from the feature name to a list of errors for that feature, e.g.
            ```
        ...
        float_rel_tolerance
            The relative tolerenance to allow for float equality: default is 1e-6.
        float_abs_tolerance
            The absolute tolerenance to allow for float equality: default is 1e-12.
        prefix
            Whether to show the prefix for feature names in the table: default
            is true.
