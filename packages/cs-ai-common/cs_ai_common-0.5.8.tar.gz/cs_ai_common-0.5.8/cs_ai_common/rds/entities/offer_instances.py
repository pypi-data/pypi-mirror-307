...
from cs_ai_common.rds.entities.external_site_instance import ExternalSiteInstance
...
class OfferInstance(Base):
    ...
    external_site_instances = relationship(ExternalSiteInstance, secondary=OfferSiteInstance, back_populates='offer_instances')