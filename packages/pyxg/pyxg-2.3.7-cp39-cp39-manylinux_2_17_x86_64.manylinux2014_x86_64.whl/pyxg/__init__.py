...
if os_name == "Windows":
    if sys.version_info.major == 3:
        if minor == 4:
            from pyxg._pyxgdb34 import _connect as _connect
            from pyxg._pyxgdb34 import version as version

        elif minor == 6:
            from pyxg._pyxgdb36 import _connect as _connect
            from pyxg._pyxgdb36 import version as version

        elif minor == 7:
            from pyxg._pyxgdb37 import _connect as _connect
            from pyxg._pyxgdb37 import version as version

        elif minor == 8:
            from pyxg._pyxgdb38 import _connect as _connect
            from pyxg._pyxgdb38 import version as version
        
        elif minor == 9:
            from pyxg._pyxgdb39 import _connect as _connect
            from pyxg._pyxgdb39 import version as version
            
        elif minor == 10:
            from pyxg._pyxgdb310 import _connect as _connect
            from pyxg._pyxgdb310 import version as version
            
        elif minor == 11:
            from pyxg._pyxgdb311 import _connect as _connect
            from pyxg._pyxgdb311 import version as version

        else:
            print("ERROR:当前python版本不支持，请联系虚谷数据库客服人员")
    elif sys.version_info.major == 2:
        if minor == 7:
            from pyxg._pyxgdb import _connect as _connect
            from pyxg._pyxgdb import version as version
