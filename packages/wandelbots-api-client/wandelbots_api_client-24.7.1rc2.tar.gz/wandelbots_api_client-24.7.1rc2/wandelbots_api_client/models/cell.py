...
class Cell(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(strict=True)] = Field(description="A unique name for the cell used as a unique identifier for addressing the cell in all API calls. Since the cell identifier is used as Kubernetes namespace, the following rules apply: * Contain only lowercase alphanumeric characters or '-', * Start with an alphanumeric character, * End with an alphanumeric character, * A maximum length of 63 characters, * The identifiers \"kube-system\", \"default\", and \"wandelbots\" are reserved and cannot be used. ")
