...
class Section:
    def __init__(self, laminates, W, foam=None, H=None):
...
class WebcoreBridgeSection(Section):
    def __init__(self, laminates, W, hf, wf, theta, ctc, foam=None, H=None):
        super().__init__(laminates, foam, W, H)
        for pos in ["top", "bottom", "edge", "flange", "web"]:
    ...
    def create_members(self, element_size=None):  # To generate FE elements, set elements to True
        ...
        if elements:
            members += [
                PolygonMember("edgeright", self.laminates['side'], [pC, pG, pF, pD2], shear_factor=c,
                              divs=[None, hdiv, None, hdiv], orientation=VERTICAL),
                PolygonMember("edgeleft", self.laminates['side'], [pD2m, pFm, pGm, pCm], shear_factor=c,
                              divs=[None, hdiv, None, hdiv], orientation=VERTICAL),
                PolygonMember("edgertop", self.laminates['side'], [pH, pG, pC], divs=None, orientation=VERTICAL),
                PolygonMember("edgeltop", self.laminates['side'], [pCm, pGm, pHm], divs=None, orientation=VERTICAL),
                PolygonMember("edgerbtm", self.laminates['side'], [pD2, pF, pE, pD], divs=None, orientation=VERTICAL),
                PolygonMember("edgelbtm", self.laminates['side'], [pDm, pEm, pFm, pD2m], divs=None,
                              orientation=VERTICAL),
            ]
        else:
            members += [
                PolygonMember("edgeright", self.laminates['side'], [pG, pF, pE, pD, pC, pH], shear_factor=c,
                              orientation=VERTICAL),
                PolygonMember("edgeleft", self.laminates['side'], [pHm, pCm, pDm, pEm, pFm, pGm], shear_factor=c,
                              orientation=VERTICAL)
            ]
