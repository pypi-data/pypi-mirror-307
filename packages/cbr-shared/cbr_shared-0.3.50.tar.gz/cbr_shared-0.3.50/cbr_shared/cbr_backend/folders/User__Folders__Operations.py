...
class User__Folders__Operations(Type_Safe):
    ...
    def add_file(self, folder: Model__User__Folder, file_id: Random_Guid=None, file_name: Safe_Id=None) -> Model__User__Folder__File:
        if folder is None:
            raise ValueError(f"in User__Folders__Operations.add_file folder cannot be None")
        ...
        if file_id in self.folders_structure.files:
            raise ValueError(f"in User__Folders__Operations.add_file there was already a file mapping with id: {file_id} ")
    ...
    def add_file__to_folder_id(self, folder_id: Random_Guid, file_id: Random_Guid = None, file_name: Safe_Id = None) -> Model__User__Folder__File:
        ...
        return self.add_file(folder=folder, file_id=file_id, file_name=file_name)

    def add_folder(self, parent_folder: Model__User__Folder, folder_name) -> Model__User__Folder:
        if parent_folder is None:
            raise ValueError(f"in User__Folders__Operations.add_folder folder cannot be None")
    ...
    def add_folder__to_folder_id(self, parent_folder_id=None, folder_name=None):
        ...
        return self.add_folder(parent_folder=parent_folder,folder_name=folder_name)
