...
from . import g
from .backend_shared import Baseyoutubepafy, BaseStream, remux, get_status_string, get_size_done
...
class Ytdlyoutubepafy(Baseyoutubepafy):
    def __init__(self, *args, **kwargs):
        ...
        super(Ytdlyoutubepafy, self).__init__(*args, **kwargs)
    ...
    def _fetch_basic(self):
        ...
        with youtube_dl.YoutubeDL(self._ydl_opts) as ydl:
            ...
            # Turn into an IOError since that is what youtubepafy previously raised
...
class YtdlStream(BaseStream):
    def __init__(self, info, parent):
        ...
        # Ensure that abr is not None before performing multiplication
