import re
from .youtubepafy import call_gdata
...
def get_channel(channel_url, basic=False, gdata=False,
    ...
    The returned youtubepafy and Playlist objects are initialised using the arguments
    to get_channel() in the manner documented for youtubepafy.new()
