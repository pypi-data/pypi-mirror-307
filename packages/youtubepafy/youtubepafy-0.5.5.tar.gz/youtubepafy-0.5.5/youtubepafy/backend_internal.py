...
from .backend_shared import Baseyoutubepafy, BaseStream
from .youtubepafy import fetch_decode, dbg, get_categoryname
from . import g
import os
import hashlib
import tempfile
...
class Internyoutubepafy(Baseyoutubepafy):
    def __init__(self, *args, **kwargs):
        ...
        super(Internyoutubepafy, self).__init__(*args, **kwargs)
...
def fetch_cached(url, callback, encoding=None, dbg_ref="", file_prefix=""):
    ...
    tmpdir = os.path.join(tempfile.gettempdir(), "youtubepafy")
