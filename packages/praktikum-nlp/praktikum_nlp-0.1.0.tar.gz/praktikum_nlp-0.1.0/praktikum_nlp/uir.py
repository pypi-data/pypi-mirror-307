...
def ollamaUI():
    ...
    <script>
        ...
        function removeFileBubble(element) {
            ...
            google.colab.kernel.invokeFunction('notebook.chat_response_handler', [null, 'clear'], {});
        }
        ...
        function sendMessage() {
            ...
            input.value = '';
            google.colab.kernel.invokeFunction('notebook.chat_response_handler', [userMessage, 'message'], {});
        }
        ...
        function uploadFile(input) {
            ...
            reader.onload = function(e) {
                ...
                google.colab.kernel.invokeFunction('notebook.chat_response_handler', [fileContent, 'upload'], {});
