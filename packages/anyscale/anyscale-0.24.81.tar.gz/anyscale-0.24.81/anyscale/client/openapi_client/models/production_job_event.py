...
class ProductionJobEvent(object):
    ...
    def __init__(self, id=None, created_at=None, event_type=None, error_type=None, level=None, message=None, origin=None, ha_job_id=None, cluster_id=None, local_vars_configuration=None):  # noqa: E501
