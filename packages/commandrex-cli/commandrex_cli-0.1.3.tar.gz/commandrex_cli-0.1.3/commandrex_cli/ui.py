...
• "What's my IP address"
    ...
    def get_user_input(self, prompt_text: str = "[cyan]CommandRex[/cyan] 🦖 > ") -> str:
        """
    ...
    def display_translation(self, translation: TranslationResponse) -> bool:
        ...
        return Confirm.ask("\nDo you want to execute this command?", default=False, console=self.console)
    ...
    def display_result(self, result: CommandResult):
        ...
        if result.success:
            if result.output.strip():
                self.console.print("\n[success]Command executed successfully![/success]")
                self.console.print(result.output)
            else:
                self.console.print("\n[success]Command executed successfully! (No output)[/success]")
        else:
